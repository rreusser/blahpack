...
function cholesky( uplo, N, bp ) {
	const info = dpptrf( uplo, N, bp, 1, 0 );
...
test( 'dspgst: itype1_upper_3', function t() {
	...
	const tc = itype1_upper_3;
	const bp = new Float64Array( [ 4.0, 2.0, 5.0, 1.0, 1.0, 3.0 ] );
	cholesky( 'upper', 3, bp );
	const ap = new Float64Array( [ 4.0, 2.0, 5.0, 1.0, 3.0, 6.0 ] );
	const info = dspgst( 1, 'upper', 3, ap, 1, 0, bp, 1, 0 );
...
test( 'dspgst: itype1_lower_3', function t() {
	...
	const tc = itype1_lower_3;
	const bp = new Float64Array( [ 4.0, 2.0, 1.0, 5.0, 1.0, 3.0 ] );
	cholesky( 'lower', 3, bp );
	const ap = new Float64Array( [ 4.0, 2.0, 1.0, 5.0, 3.0, 6.0 ] );
	const info = dspgst( 1, 'lower', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype2_upper_3', function t() {
	...
	const tc = itype2_upper_3;
	const bp = new Float64Array( [ 4.0, 2.0, 5.0, 1.0, 1.0, 3.0 ] );
	cholesky( 'upper', 3, bp );
	const ap = new Float64Array( [ 4.0, 2.0, 5.0, 1.0, 3.0, 6.0 ] );
	const info = dspgst( 2, 'upper', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype2_lower_3', function t() {
	...
	const tc = itype2_lower_3;
	const bp = new Float64Array( [ 4.0, 2.0, 1.0, 5.0, 1.0, 3.0 ] );
	cholesky( 'lower', 3, bp );
	const ap = new Float64Array( [ 4.0, 2.0, 1.0, 5.0, 3.0, 6.0 ] );
	const info = dspgst( 2, 'lower', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype3_upper_3', function t() {
	...
	const tc = itype3_upper_3;
	const bp = new Float64Array( [ 4.0, 2.0, 5.0, 1.0, 1.0, 3.0 ] );
	cholesky( 'upper', 3, bp );
	const ap = new Float64Array( [ 4.0, 2.0, 5.0, 1.0, 3.0, 6.0 ] );
	const info = dspgst( 3, 'upper', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype3_lower_3', function t() {
	...
	const tc = itype3_lower_3;
	const bp = new Float64Array( [ 4.0, 2.0, 1.0, 5.0, 1.0, 3.0 ] );
	cholesky( 'lower', 3, bp );
	const ap = new Float64Array( [ 4.0, 2.0, 1.0, 5.0, 3.0, 6.0 ] );
	const info = dspgst( 3, 'lower', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype1_upper_4', function t() {
	...
	const tc = itype1_upper_4;
	const bp = new Float64Array( [ 9.0, 3.0, 5.0, 1.0, 2.0, 4.0, 0.0, 1.0, 1.0, 3.0 ] );
	cholesky( 'upper', 4, bp );
	const ap = new Float64Array( [ 10.0, 4.0, 8.0, 2.0, 3.0, 7.0, 1.0, 2.0, 4.0, 6.0 ] );
	const info = dspgst( 1, 'upper', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype1_lower_4', function t() {
	...
	const tc = itype1_lower_4;
	const bp = new Float64Array( [ 9.0, 3.0, 1.0, 0.0, 5.0, 2.0, 1.0, 4.0, 1.0, 3.0 ] );
	cholesky( 'lower', 4, bp );
	const ap = new Float64Array( [ 10.0, 4.0, 2.0, 1.0, 8.0, 3.0, 2.0, 7.0, 4.0, 6.0 ] );
	const info = dspgst( 1, 'lower', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype2_upper_4', function t() {
	...
	const tc = itype2_upper_4;
	const bp = new Float64Array( [ 9.0, 3.0, 5.0, 1.0, 2.0, 4.0, 0.0, 1.0, 1.0, 3.0 ] );
	cholesky( 'upper', 4, bp );
	const ap = new Float64Array( [ 10.0, 4.0, 8.0, 2.0, 3.0, 7.0, 1.0, 2.0, 4.0, 6.0 ] );
	const info = dspgst( 2, 'upper', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype2_lower_4', function t() {
	...
	const tc = itype2_lower_4;
	const bp = new Float64Array( [ 9.0, 3.0, 1.0, 0.0, 5.0, 2.0, 1.0, 4.0, 1.0, 3.0 ] );
	cholesky( 'lower', 4, bp );
	const ap = new Float64Array( [ 10.0, 4.0, 2.0, 1.0, 8.0, 3.0, 2.0, 7.0, 4.0, 6.0 ] );
	const info = dspgst( 2, 'lower', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype3_upper_4', function t() {
	...
	const tc = itype3_upper_4;
	const bp = new Float64Array( [ 9.0, 3.0, 5.0, 1.0, 2.0, 4.0, 0.0, 1.0, 1.0, 3.0 ] );
	cholesky( 'upper', 4, bp );
	const ap = new Float64Array( [ 10.0, 4.0, 8.0, 2.0, 3.0, 7.0, 1.0, 2.0, 4.0, 6.0 ] );
	const info = dspgst( 3, 'upper', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: itype3_lower_4', function t() {
	...
	const tc = itype3_lower_4;
	const bp = new Float64Array( [ 9.0, 3.0, 1.0, 0.0, 5.0, 2.0, 1.0, 4.0, 1.0, 3.0 ] );
	cholesky( 'lower', 4, bp );
	const ap = new Float64Array( [ 10.0, 4.0, 2.0, 1.0, 8.0, 3.0, 2.0, 7.0, 4.0, 6.0 ] );
	const info = dspgst( 3, 'lower', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: n_zero', function t() {
	...
	const bp = new Float64Array( [ 1.0 ] );
	const info = dspgst( 1, 'upper', 0, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, 0 );
});

test( 'dspgst: n_one_itype1_upper', function t() {

	const tc = n_one_itype1_upper;
	const ap = new Float64Array( [ 9.0 ] );
	const bp = new Float64Array( [ 3.0 ] );
	const info = dspgst( 1, 'upper', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: n_one_itype1_lower', function t() {
	...
	const tc = n_one_itype1_lower;
	const ap = new Float64Array( [ 16.0 ] );
	const bp = new Float64Array( [ 4.0 ] );
	const info = dspgst( 1, 'lower', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: n_one_itype2', function t() {
	...
	const tc = n_one_itype2;
	const ap = new Float64Array( [ 5.0 ] );
	const bp = new Float64Array( [ 2.0 ] );
	const info = dspgst( 2, 'upper', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
...
test( 'dspgst: n_one_itype3', function t() {
	...
	const tc = n_one_itype3;
	const ap = new Float64Array( [ 5.0 ] );
	const bp = new Float64Array( [ 2.0 ] );
	const info = dspgst( 3, 'lower', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( ap, tc.AP, 1e-14, 'AP' );
});
