...
const lines = readFileSync( path.join( fixtureDir, 'dla_gbamv.jsonl' ), 'utf8' ).trim().split( '\n' );
...
test( 'dla_gbamv: notrans_kl1_ku1', function t() {
	const tc = findCase( 'notrans_kl1_ku1' );
	const AB = tridiagAB();
...
test( 'dla_gbamv: trans_kl1_ku1', function t() {
	const tc = findCase( 'trans_kl1_ku1' );
	const AB = tridiagAB();
	const x = new Float64Array( [ 1.0, -2.0, 3.0, -4.0 ] );
	const y = new Float64Array( 4 );
...
test( 'dla_gbamv: notrans_kl2_ku0', function t() {
	const tc = findCase( 'notrans_kl2_ku0' );
	const AB = lowerAB();
	const x = new Float64Array( [ 1.0, -1.0, 2.0, -2.0 ] );
	const y = new Float64Array( 4 );
...
test( 'dla_gbamv: trans_kl2_ku0', function t() {
	const tc = findCase( 'trans_kl2_ku0' );
	const AB = lowerAB();
	const x = new Float64Array( [ 1.0, -1.0, 2.0, -2.0 ] );
	const y = new Float64Array( 4 );
...
test( 'dla_gbamv: notrans_kl0_ku2', function t() {
	const tc = findCase( 'notrans_kl0_ku2' );
	const AB = upperAB();
	const x = new Float64Array( [ 1.0, -1.0, 2.0, -2.0 ] );
	const y = new Float64Array( 4 );
...
test( 'dla_gbamv: trans_kl0_ku2', function t() {
	const tc = findCase( 'trans_kl0_ku2' );
	const AB = upperAB();
	const x = new Float64Array( [ 1.0, -1.0, 2.0, -2.0 ] );
	const y = new Float64Array( 4 );
...
test( 'dla_gbamv: alpha_zero_beta_one', function t() {
	...
	const AB = tridiagAB();
	const x = new Float64Array( [ 1.0, -2.0, 3.0, -4.0 ] );
	const y = new Float64Array( [ 7.0, 8.0, 9.0, 10.0 ] );
...
test( 'dla_gbamv: trans_incx2_beta_zero', function t() {
	const expected = [ 7.0, 28.0, 46.0, 28.0 ];
	const AB = tridiagAB();
	const x = new Float64Array( [ 1.0, 0.0, -2.0, 0.0, 3.0, 0.0, -4.0 ] );
	const y = new Float64Array( 4 );
