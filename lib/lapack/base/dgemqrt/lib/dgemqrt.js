...
*/
function dgemqrt( order, side, trans, M, N, K, nb, V, LDV, T, LDT, C, LDC, WORK ) {
	let sv1, sv2, st1, st2, sc1, sc2;
	...
	if ( WORK === null || WORK === void 0 ) {
		const minWork = ( side === 'left' ) ? Math.max( 1, N ) * nb : Math.max( 1, M ) * nb;
		WORK = new Float64Array( minWork );
	}
	return base( side, trans, M, N, K, nb, V, sv1, sv2, 0, T, st1, st2, 0, C, sc1, sc2, 0, WORK, 1, 0 );
}
