...
*/
function zggsvp3( order, jobu, jobv, jobq, M, p, N, A, LDA, B, LDB, tola, tolb, K, l, U, LDU, V, LDV, Q, LDQ, IWORK, strideIWork, offsetIWork, RWORK, strideRWork, TAU, strideTAU, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	let sa1, sa2, sb1, sb2, su1, su2, sv1, sv2, sq1, sq2;
	...
	if ( WORK === null || WORK === void 0 ) {
		WORK = new Complex128Array( max( 1, M, N, p ) );
		strideWork = 1;
	}
	return base( jobu, jobv, jobq, M, p, N, A, sa1, sa2, 0, B, sb1, sb2, 0, tola, tolb, K, l, U, su1, su2, 0, V, sv1, sv2, 0, Q, sq1, sq2, 0, IWORK, strideIWork, offsetIWork, RWORK, strideRWork, 0, TAU, strideTAU, 0, WORK, strideWork, 0 ); // eslint-disable-line max-len
}
