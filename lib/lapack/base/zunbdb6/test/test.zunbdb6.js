...
import zunbdb6 from './../lib/zunbdb6.js';
...
test( 'zunbdb6 (column-major): basic complex projection', function t() {
	...
	const Q1 = new Complex128Array( [ 1.0, 0.0, 0.0, 0.0 ] );
	const Q2 = new Complex128Array( [ 0.0, 0.0, 0.0, 0.0 ] );
	const X1 = new Complex128Array( [ 3.0, 4.0, 4.0, 5.0 ] );
	const X2 = new Complex128Array( [ 5.0, 6.0, 6.0, 7.0 ] );
	const WORK = new Complex128Array( 1 );

	const info = zunbdb6( 'column-major', 2, 2, 1, X1, 1, X2, 1, Q1, 2, Q2, 2, WORK, 1 );
...
test( 'zunbdb6 (row-major): basic complex projection', function t() {
	...
	const info = zunbdb6( 'row-major', 2, 2, 1, X1, 1, X2, 1, Q1, 1, Q2, 1, WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
});
