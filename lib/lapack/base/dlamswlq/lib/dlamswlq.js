...
*/
function dlamswlq( order, side, trans, M, N, K, mb, nb, A, LDA, T, LDT, C, LDC, WORK ) {
	...
	if ( WORK === null || WORK === void 0 ) {
		const minWork = ( side === 'left' ) ? Math.max( 1, nb ) * mb : Math.max( 1, M ) * mb;
		WORK = new Float64Array( minWork );
	}
	return base( side, trans, M, N, K, mb, nb, A, sa1, sa2, 0, T, st1, st2, 0, C, sc1, sc2, 0, WORK, 1, 0 );
}


// EXPORTS //

export default dlamswlq;
