...
function dgees( jobvs, sort, select, N, A, strideA1, strideA2, offsetA, sdim, WR, strideWR, offsetWR, WI, strideWI, offsetWI, VS, strideVS1, strideVS2, offsetVS, WORK, strideWork, offsetWork, BWORK, strideBWork, offsetBWork ) {
	...
	iwrk = itau;
	ieval = dhseqr( 'schur', ( wantvs ) ? 'update' : 'none', N, ilo, ihi, A, strideA1, strideA2, offsetA, WR, strideWR, offsetWR, WI, strideWI, offsetWI, VS, strideVS1, strideVS2, offsetVS, WORK, strideWork, offsetWork + iwrk * strideWork );
	if ( ieval > 0 ) {
		info = ieval;
	}
