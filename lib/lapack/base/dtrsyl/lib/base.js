...
const VEC = new Float64Array( 4 );  // 2x2 column-major
const X = new Float64Array( 4 );    // 2x2 column-major
const SCALOC_ARR = new Float64Array( 1 );
const XNORM_ARR = new Float64Array( 1 );
...
function dtrsyl( trana, tranb, isgn, M, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, C, strideC1, strideC2, offsetC, scale ) {
	let scaloc, lnext, knext, info, suml, sumr, da11, a11, res, db, k1, k2, l1;
	let l2, k, l, j;
	...
	const smin = Math.max(smlnum, EPS * dlange( 'max', M, M, A, strideA1, strideA2, offsetA, DUM, 1, 0 ), EPS * dlange( 'max', N, N, B, strideB1, strideB2, offsetB, DUM, 1, 0 ));
