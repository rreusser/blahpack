...
test( 'dhseqr: eigenvalues_only_6x6', function t() {
	...
	info = dhseqr( 'eigenvalues', 'none', N, 1, N, H, 1, N, 0, WR, 1, 0, WI, 1, 0, Z, 1, N, 0, WORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'dhseqr: schur_with_z_init_4x4', function t() {
	...
	Z = new Float64Array( N * N );
	WORK = new Float64Array( N );
	info = dhseqr( 'schur', 'initialize', N, 1, N, H, 1, N, 0, WR, 1, 0, WI, 1, 0, Z, 1, N, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
...
test( 'dhseqr: schur_with_z_update_4x4', function t() {
	...
	WORK = new Float64Array( N );
	info = dhseqr( 'schur', 'update', N, 1, N, H, 1, N, 0, WR, 1, 0, WI, 1, 0, Z, 1, N, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( toArray( WR ), tc.wr, 1e-12, 'wr' );
	assertArrayClose( toArray( WI ), tc.wi, 1e-12, 'wi' );
	assertArrayClose( matrixToArray( H, N ), tc.h, 1e-12, 'h' );
...
test( 'dhseqr: schur_no_z_4x4', function t() {
	...
	Z = new Float64Array( N * N );
	WORK = new Float64Array( N );
	info = dhseqr( 'schur', 'none', N, 1, N, H, 1, N, 0, WR, 1, 0, WI, 1, 0, Z, 1, N, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( toArray( WR ), tc.wr, 1e-12, 'wr' );
	assertArrayClose( toArray( WI ), tc.wi, 1e-12, 'wi' );
	assertArrayClose( matrixToArray( H, N ), tc.h, 1e-12, 'h' );
...
test( 'dhseqr: n0', function t() {
	...
	info = dhseqr( 'schur', 'initialize', 0, 1, 0, H, 1, 1, 0, WR, 1, 0, WI, 1, 0, Z, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'dhseqr: n1', function t() {
	...
	Z = new Float64Array( 1 );
	WORK = new Float64Array( N );
	info = dhseqr( 'schur', 'initialize', N, 1, N, H, 1, 1, 0, WR, 1, 0, WI, 1, 0, Z, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
...
test( 'dhseqr: ilo_eq_ihi', function t() {
	...
	Z = new Float64Array( N * N );
	WORK = new Float64Array( N );
	info = dhseqr( 'schur', 'none', N, 2, 2, H, 1, N, 0, WR, 1, 0, WI, 1, 0, Z, 1, N, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
...
test( 'dhseqr: partial_range_6x6', function t() {
	...
	Z = new Float64Array( N * N );
	WORK = new Float64Array( N );
	info = dhseqr( 'schur', 'initialize', N, 2, 5, H, 1, N, 0, WR, 1, 0, WI, 1, 0, Z, 1, N, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( toArray( WR ), tc.wr, 1e-12, 'wr' );
	assertArrayClose( toArray( WI ), tc.wi, 1e-12, 'wi' );
	assertArrayClose( matrixToArray( H, N ), tc.h, 1e-12, 'h' );
