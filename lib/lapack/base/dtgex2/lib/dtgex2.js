...
*/
function dtgex2( order, wantq, wantz, N, A, LDA, B, LDB, Q, LDQ, Z, LDZ, j1, n1, n2, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	...
	if ( WORK === null || WORK === void 0 ) {
		const minWork = Math.max( 1, N * (n2 + n1), (n2 + n1) * (n2 + n1) * 2 );
		WORK = new Float64Array( minWork );
		strideWork = 1;
	}
	return base( wantq, wantz, N, A, sa1, sa2, 0, B, sb1, sb2, 0, Q, sq1, sq2, 0, Z, sz1, sz2, 0, j1, n1, n2, WORK, strideWork, 0 ); // eslint-disable-line max-len
}
