...
import zunml2 from './../lib/ndarray.js';
...
test( 'zunml2: left, no transpose (Q*I)', function t() {
	...
	const info = zunml2( 'left', 'no-transpose', 5, 5, 3, lq.A, 1, lq.LDA, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 );
...
test( 'zunml2: left, conjugate transpose (Q^H*I)', function t() {
	...
	const C = eye5in6();
	const WORK = new Complex128Array( 200 );
	const info = zunml2( 'left', 'conjugate-transpose', 5, 5, 3, lq.A, 1, lq.LDA, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( extractRaw( C, tc.c.length ), tc.c, 1e-12, 'c' );
});
...
test( 'zunml2: right, no transpose (I*Q)', function t() {
	...
	const C = eye5in6();
	const WORK = new Complex128Array( 200 );
	const info = zunml2( 'right', 'no-transpose', 5, 5, 3, lq.A, 1, lq.LDA, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( extractRaw( C, tc.c.length ), tc.c, 1e-12, 'c' );
});
...
test( 'zunml2: M=0 quick return', function t() {
	...
	const info = zunml2( 'left', 'no-transpose', 0, 5, 0, lq.A, 1, lq.LDA, 0, lq.TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0 );
	assert.equal( info, 0 );
});
...
test( 'zunml2: N=0 quick return', function t() {
	...
	const C = new Complex128Array( 1 );
	const WORK = new Complex128Array( 1 );
	const info = zunml2( 'left', 'no-transpose', 5, 0, 0, lq.A, 1, lq.LDA, 0, lq.TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0 );
	assert.equal( info, 0 );
});
...
test( 'zunml2: K=0 quick return', function t() {
	...
	const C = new Complex128Array( 1 );
	const WORK = new Complex128Array( 1 );
	const info = zunml2( 'left', 'no-transpose', 5, 5, 0, lq.A, 1, lq.LDA, 0, lq.TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0 );
	assert.equal( info, 0 );
});
...
test( 'zunml2: right, conjugate transpose on rectangular C', function t() {
	...
	const WORK = new Complex128Array( 200 );
	const info = zunml2( 'right', 'conjugate-transpose', 3, 5, 3, lq.A, 1, lq.LDA, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( extractRaw( C, tc.c.length ), tc.c, 1e-12, 'c' );
});
