...
test( 'dtrsen: N V select scalar swap', function t() {
	...
	info = dtrsen( 'none', 'update', SELECT, 1, 0, N, T, 1, N, 0, Q, 1, N, 0, WR, 1, 0, WI, 1, 0, M, s, sep, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assert.equal( M[ 0 ], 1 );
...
test( 'dtrsen: E compute S', function t() {
	...
	WORK = new Float64Array( 100 );
	IWORK = new Int32Array( 100 );
	info = dtrsen( 'eigenvalues', 'update', SELECT, 1, 0, N, T, 1, N, 0, Q, 1, N, 0, WR, 1, 0, WI, 1, 0, M, s, sep, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assert.equal( M[ 0 ], tc.M );
...
test( 'dtrsen: V compute SEP', function t() {
	...
	WORK = new Float64Array( 100 );
	IWORK = new Int32Array( 100 );
	info = dtrsen( 'subspace', 'update', SELECT, 1, 0, N, T, 1, N, 0, Q, 1, N, 0, WR, 1, 0, WI, 1, 0, M, s, sep, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assert.equal( M[ 0 ], tc.M );
...
test( 'dtrsen: B compute both', function t() {
	...
	WORK = new Float64Array( 100 );
	IWORK = new Int32Array( 100 );
	info = dtrsen( 'both', 'update', SELECT, 1, 0, N, T, 1, N, 0, Q, 1, N, 0, WR, 1, 0, WI, 1, 0, M, s, sep, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assert.equal( M[ 0 ], tc.M );
	assertClose( s[ 0 ], tc.S, 1e-13, 'S' );
	assertClose( sep[ 0 ], tc.SEP, 1e-13, 'SEP' );
...
test( 'dtrsen: N=0', function t() {
	...
	WORK = new Float64Array( 100 );
	IWORK = new Int32Array( 100 );
	info = dtrsen( 'none', 'update', SELECT, 1, 0, 0, T, 1, 0, 0, Q, 1, 0, 0, WR, 1, 0, WI, 1, 0, M, s, sep, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assert.equal( M[ 0 ], tc.M );
});
