...
import dlaic1 from './../lib/ndarray.js';


// FIXTURES //

const fixtureDir = join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures' );
const lines = trim( readFileSync( join( fixtureDir, 'dlaic1.jsonl' ), 'utf8' ) ).split( '\n' );
const fixture = [];
let i;
...
test( 'dlaic1: job1_j3_basic', function t() {
	...
	const tc = findCase( 'job1_j3_basic' );
	const x = new Float64Array( [ 0.6, 0.8, 0.0 ] );
...
test( 'dlaic1: job1_j5', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_j5' );
	const x = new Float64Array( [ 0.2, 0.4, 0.5, 0.3, 0.1 ] );
	const w = new Float64Array( [ 1.5, 0.5, 2.0, 1.0, 0.8 ] );
...
test( 'dlaic1: job1_j1', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_j1' );
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 0.5 ] );
...
test( 'dlaic1: job1_sest0_zero (all zeros)', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_sest0_zero' );
...
test( 'dlaic1: job1_gamma_tiny', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_gamma_tiny' );
	const x = new Float64Array( [ 1.0, 0.0 ] );
	const w = new Float64Array( [ 0.5, 0.3 ] );
...
test( 'dlaic1: job1_alpha_tiny', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_alpha_tiny' );
	const x = new Float64Array( [ 1e-20, 0.0 ] );
	const w = new Float64Array( [ 1.0, 0.0 ] );
...
test( 'dlaic1: job1_sest_tiny', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_sest_tiny' );
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 1e10 ] );
...
test( 'dlaic1: job2_j3_basic', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_j3_basic' );
	const x = new Float64Array( [ 0.6, 0.8, 0.0 ] );
	const w = new Float64Array( [ 1.0, 2.0, 3.0 ] );
...
test( 'dlaic1: job2_sest0_zero (all zeros)', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_sest0_zero' );
	const x = new Float64Array( [ 0.0 ] );
	const w = new Float64Array( [ 0.0 ] );
...
test( 'dlaic1: job2_gamma_tiny', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_gamma_tiny' );
	const x = new Float64Array( [ 1.0, 0.0 ] );
	const w = new Float64Array( [ 0.5, 0.3 ] );
...
test( 'dlaic1: job2_alpha_tiny', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_alpha_tiny' );
	const x = new Float64Array( [ 1e-20, 0.0 ] );
	const w = new Float64Array( [ 1.0, 0.0 ] );
...
test( 'dlaic1: job2_sest_tiny', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_sest_tiny' );
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 1e10 ] );
...
test( 'dlaic1: job1_alpha_tiny_s1gts2 (absgam > absest)', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_alpha_tiny_s1gts2' );
	const x = new Float64Array( [ 1e-20 ] );
...
test( 'dlaic1: job1_sest_tiny_gam_large', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_sest_tiny_gam_large' );
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 2.0 ] );
...
test( 'dlaic1: job1_normal_b_neg', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_normal_b_neg' );
	const x = new Float64Array( [ 1.0 ] );
...
test( 'dlaic1: job2_alpha_tiny_s1gts2 (absgam > absest)', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_alpha_tiny_s1gts2' );
	const x = new Float64Array( [ 1e-20 ] );
	const w = new Float64Array( [ 1.0 ] );
...
test( 'dlaic1: job2_sest_tiny_gam_large', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_sest_tiny_gam_large' );
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 2.0 ] );
...
test( 'dlaic1: job2_normal_test_neg', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_normal_test_neg' );
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 0.1 ] );
...
test( 'dlaic1: job2_normal_test_neg_b_neg', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_normal_test_neg_b_neg' );
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 0.1 ] );
...
test( 'dlaic1: supports non-unit stride for x and w', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job1_j3_basic' );
	const x = new Float64Array( [ 0.6, 999.0, 0.8, 999.0, 0.0 ] );
	const w = new Float64Array( [ 1.0, 999.0, 2.0, 999.0, 3.0 ] );
...
test( 'dlaic1: supports offset for x and w', function t() {
	const out = new Float64Array( 3 );
	const tc = findCase( 'job2_j3_basic' );
	const x = new Float64Array( [ 999.0, 999.0, 0.6, 0.8, 0.0 ] );
	const w = new Float64Array( [ 999.0, 1.0, 2.0, 3.0 ] );
...
test( 'dlaic1: returns the output array', function t() {
	...
	const x = new Float64Array( [ 1.0 ] );
	const w = new Float64Array( [ 0.5 ] );
	const result = dlaic1( 'largest-singular-value', 1, x, 1, 0, 2.0, w, 1, 0, 0.3, out );
