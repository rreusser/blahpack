...
import zlahefRook from './../lib/ndarray.js';


// FIXTURES //

const FIXTURE_DIR = path.join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures' );
const LINES = readFileSync( path.join( FIXTURE_DIR, 'zlahef_rook.jsonl' ), 'utf8' ).trim().split( '\n' ); // eslint-disable-line node/no-sync, max-len
...
test( 'zlahef_rook: lower_6x6_nb3', function t() {
	...
	const W = new Complex128Array( 6 * 3 );
	const result = zlahefRook( 'lower', 6, 3, A, 1, 6, 0, IPIV, 1, 0, W, 1, 6, 0 );
...
test( 'zlahef_rook: upper_6x6_nb3', function t() {
	...
	const IPIV = new Int32Array( 6 );
	const W = new Complex128Array( 6 * 3 );
	const result = zlahefRook( 'upper', 6, 3, A, 1, 6, 0, IPIV, 1, 0, W, 1, 6, 0 );
...
test( 'zlahef_rook: lower_4x4_full_nb8', function t() {
	...
	const W = new Complex128Array( 4 * 8 );
	const result = zlahefRook( 'lower', 4, 8, A, 1, 4, 0, IPIV, 1, 0, W, 1, 4, 0 );
...
test( 'zlahef_rook: upper_4x4_full_nb8', function t() {
	...
	const IPIV = new Int32Array( 4 );
	const W = new Complex128Array( 4 * 8 );
	const result = zlahefRook( 'upper', 4, 8, A, 1, 4, 0, IPIV, 1, 0, W, 1, 4, 0 );
...
test( 'zlahef_rook: lower_5x5_chase_full', function t() {
	...
	const W = new Complex128Array( 5 * 8 );
	const result = zlahefRook( 'lower', 5, 8, A, 1, 5, 0, IPIV, 1, 0, W, 1, 5, 0 );
...
test( 'zlahef_rook: upper_5x5_chase_full', function t() {
	...
	const IPIV = new Int32Array( 5 );
	const W = new Complex128Array( 5 * 8 );
	const result = zlahefRook( 'upper', 5, 8, A, 1, 5, 0, IPIV, 1, 0, W, 1, 5, 0 );
...
test( 'zlahef_rook: lower_5x5_chase_nb3', function t() {
	...
	const IPIV = new Int32Array( 5 );
	const W = new Complex128Array( 5 * 3 );
	const result = zlahefRook( 'lower', 5, 3, A, 1, 5, 0, IPIV, 1, 0, W, 1, 5, 0 );
...
test( 'zlahef_rook: upper_5x5_chase_nb3', function t() {
	...
	const IPIV = new Int32Array( 5 );
	const W = new Complex128Array( 5 * 3 );
	const result = zlahefRook( 'upper', 5, 3, A, 1, 5, 0, IPIV, 1, 0, W, 1, 5, 0 );
...
test( 'zlahef_rook: N=1 lower, simple case', function t() {
	...
	const result = zlahefRook( 'lower', 1, 1, A, 1, 1, 0, IPIV, 1, 0, W, 1, 1, 0 );
	assert.equal( result.info, 0, 'info' );
...
test( 'zlahef_rook: N=1 upper, simple case', function t() {
	...
	const IPIV = new Int32Array( 1 );
	const W = new Complex128Array( 1 );
	const result = zlahefRook( 'upper', 1, 1, A, 1, 1, 0, IPIV, 1, 0, W, 1, 1, 0 );
	assert.equal( result.info, 0, 'info' );
	assert.equal( result.kb, 1, 'kb' );
});
...
test( 'zlahef_rook: zero diagonal sets info > 0 (lower)', function t() {
	...
	const result = zlahefRook( 'lower', 2, 2, A, 1, 2, 0, IPIV, 1, 0, W, 1, 2, 0 );
...
test( 'zlahef_rook: zero diagonal sets info > 0 (upper)', function t() {
	...
	const IPIV = new Int32Array( 2 );
	const W = new Complex128Array( 4 );
	const result = zlahefRook( 'upper', 2, 2, A, 1, 2, 0, IPIV, 1, 0, W, 1, 2, 0 );
...
test( 'zlahef_rook: very small diagonal triggers element-wise division (lower)', function t() {
	const tiny = 1e-300;
	const A = new Complex128Array([ tiny, 0, 1, 0, 0, 0, 2, 0 ]);
	const IPIV = new Int32Array( 2 );
	const W = new Complex128Array( 4 );
	const result = zlahefRook( 'lower', 2, 8, A, 1, 2, 0, IPIV, 1, 0, W, 1, 2, 0 );
...
test( 'zlahef_rook: nb >= n returns kb = n', function t() {
	...
	const W = new Complex128Array( 3 * 8 );
	const result = zlahefRook( 'lower', 3, 8, A, 1, 3, 0, IPIV, 1, 0, W, 1, 3, 0 );
	assert.equal( result.info, 0, 'info' );
