...
test( 'dcopy: N=0 returns y unchanged', function t() {
	...
	const y = new Float64Array( [ 99, 99, 99 ] );
	const out = dcopy( 0, x, 1, 0, y, 1, 0 );
...
test( 'dcopy: non-unit stride (strideX=2, strideY=3)', function t() {
	...
	const y = new Float64Array( [ 0, 0, 0, 0, 0, 0, 0 ] );
	dcopy( 3, x, 2, 0, y, 3, 0 );
...
test( 'dcopy: offsetX and offsetY', function t() {
	...
	const y = new Float64Array( [ 99, 99, 0, 0, 0 ] );
	dcopy( 3, x, 1, 1, y, 1, 2 );
