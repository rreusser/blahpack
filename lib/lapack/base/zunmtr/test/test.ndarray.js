...
test( 'zunmtr: M=0 quick return', function t() {
	const info = zunmtr( 'left', 'upper', 'no-transpose', 0, 1,
		new Complex128Array( 1 ), 1, 1, 0,
		new Complex128Array( 1 ), 1, 0,
		new Complex128Array( 1 ), 1, 1, 0,
		new Complex128Array( 128 ), 1, 0
	);
	assert.strictEqual( info, 0 );
});

test( 'zunmtr: N=0 quick return', function t() {
	const info = zunmtr( 'left', 'upper', 'no-transpose', 1, 0,
		new Complex128Array( 1 ), 1, 1, 0,
		new Complex128Array( 1 ), 1, 0,
		new Complex128Array( 1 ), 1, 1, 0,
		new Complex128Array( 128 ), 1, 0
...
test( 'zunmtr: nq=1 quick return', function t() {
	...
	const C = new Complex128Array( [ 5, 3 ] );
	const Cv = reinterpret( C, 0 );
	const info = zunmtr( 'left', 'upper', 'no-transpose', 1, 1,
		new Complex128Array( 1 ), 1, 1, 0,
		new Complex128Array( 1 ), 1, 0,
		C, 1, 1, 0,
		new Complex128Array( 128 ), 1, 0
...
test( 'zunmtr: left, upper, no-transpose, 3x1', function t() {
	...
	const A = new Complex128Array( 3 * 3 ); // 3x3
	const TAU = new Complex128Array( [ 0, 0, 0, 0 ] ); // 2 taus (NQ-1=2)
	const C = new Complex128Array( [ 10, 1, 20, 2, 30, 3 ] ); // 3x1: [10+i, 20+2i, 30+3i]
	const WORK = new Complex128Array( 256 );
	const Cv = reinterpret( C, 0 );

	const info = zunmtr( 'left', 'upper', 'no-transpose', 3, 1,
		A, 1, 3, 0,
		TAU, 1, 0,
		C, 1, 1, 0,
		WORK, 1, 0
...
test( 'zunmtr: left, upper, no-transpose, 3x1, non-trivial reflector', function t() {
	...
	const A = new Complex128Array( 3 * 3 ); // 3x3, column-major
	const Av = reinterpret( A, 0 );
	const TAU = new Complex128Array( [ 0, 0, 2, 0 ] ); // tau0=0, tau1=2
	const C = new Complex128Array( [ 10, 0, 20, 0, 30, 0 ] );
	const WORK = new Complex128Array( 256 );
	const Cv = reinterpret( C, 0 );
...
test( 'zunmtr: left, lower, no-transpose, 3x1', function t() {
	...
	const info = zunmtr( 'left', 'lower', 'no-transpose', 3, 1,
		A, 1, 3, 0,
		TAU, 1, 0,
		C, 1, 1, 0,
		WORK, 1, 0
...
test( 'zunmtr: left, upper, conjugate-transpose, 3x1', function t() {
	...
	const A = new Complex128Array( 3 * 3 );
	const Av = reinterpret( A, 0 );
	const TAU = new Complex128Array( [ 0, 0, 2, 0 ] );
	const C = new Complex128Array( [ 10, 0, 20, 0, 30, 0 ] );
	const WORK = new Complex128Array( 256 );
	const Cv = reinterpret( C, 0 );
	...
	const info = zunmtr( 'left', 'upper', 'conjugate-transpose', 3, 1,
		A, 1, 3, 0,
		TAU, 1, 0,
		C, 1, 1, 0,
		WORK, 1, 0
...
test( 'zunmtr: right, upper, no-transpose, 1x3', function t() {
	...
	const A = new Complex128Array( 3 * 3 );
	const TAU = new Complex128Array( [ 0, 0, 0, 0 ] );
	const C = new Complex128Array( [ 10, 0, 20, 0, 30, 0 ] ); // 1x3 col-major
	const WORK = new Complex128Array( 256 );
	const Cv = reinterpret( C, 0 );

	const info = zunmtr( 'right', 'upper', 'no-transpose', 1, 3,
		A, 1, 3, 0,
		TAU, 1, 0,
		C, 1, 1, 0,
		WORK, 1, 0
...
test( 'zunmtr: right, lower, no-transpose, 1x3', function t() {
	...
	const info = zunmtr( 'right', 'lower', 'no-transpose', 1, 3,
		A, 1, 3, 0,
		TAU, 1, 0,
		C, 1, 1, 0,
		WORK, 1, 0
