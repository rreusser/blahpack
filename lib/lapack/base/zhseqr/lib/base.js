...
function zhseqr( job, compz, N, ilo, ihi, H, strideH1, strideH2, offsetH, w, strideW, offsetW, Z, strideZ1, strideZ2, offsetZ, WORK, strideWork, offsetWork, lwork ) {
	...
	if ( N > Math.max( NTINY, NMIN ) ) {
		...
		info = zlaqr0( wantt, wantz, N, ilo, ihi, H, strideH1, strideH2, offsetH, w, strideW, offsetW, ilo, ihi, Z, strideZ1, strideZ2, offsetZ, WORKL, 1, 0 );
	} else {
		...
		if ( info > 0 ) {
			...
			if ( N >= NL ) {
				WORKL = new Complex128Array( Math.max( 1, N ) );
				info = zlaqr0( wantt, wantz, N, ilo, kbot, H, strideH1, strideH2, offsetH, w, strideW, offsetW, ilo, ihi, Z, strideZ1, strideZ2, offsetZ, WORKL, 1, 0 );
			} else {
