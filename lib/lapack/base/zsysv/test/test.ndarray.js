...
test( 'zsysv: upper_4x4 - solves complex symmetric system with upper storage', function t() {
	...
	info = zsysv( 'upper', 4, 1, A, 1, 4, 0, IPIV, 1, 0, B, 1, 4, 0, new Complex128Array( 4 ), 1, 0 );
...
test( 'zsysv: lower_4x4 - solves complex symmetric system with lower storage', function t() {
	...
	info = zsysv( 'lower', 4, 1, A, 1, 4, 0, IPIV, 1, 0, B, 1, 4, 0, new Complex128Array( 4 ), 1, 0 );
...
test( 'zsysv: multi_rhs - multiple right-hand sides', function t() {
	...
	info = zsysv( 'upper', 2, 2, A, 1, 2, 0, IPIV, 1, 0, B, 1, 2, 0, new Complex128Array( 2 ), 1, 0 );
...
test( 'zsysv: singular - returns info > 0 for singular matrix', function t() {
	...
	info = zsysv( 'upper', 2, 1, A, 1, 2, 0, IPIV, 1, 0, B, 1, 2, 0, new Complex128Array( 2 ), 1, 0 );
...
test( 'zsysv: n1 - N=1 edge case', function t() {
	...
	info = zsysv( 'upper', 1, 1, A, 1, 1, 0, IPIV, 1, 0, B, 1, 1, 0, new Complex128Array( 1 ), 1, 0 );
...
test( 'zsysv: n_zero - N=0 quick return', function t() {
	...
	info = zsysv( 'upper', 0, 1, A, 1, 1, 0, IPIV, 1, 0, B, 1, 1, 0, new Complex128Array( 1 ), 1, 0 );
...
test( 'zsysv: nrhs_zero - NRHS=0 quick return', function t() {
	...
	info = zsysv( 'upper', 1, 0, A, 1, 1, 0, IPIV, 1, 0, B, 1, 1, 0, new Complex128Array( 1 ), 1, 0 );
	assert.equal( info, 0, 'info' );
});
...
test( 'zsysv: n1_lower - N=1 with lower storage', function t() {
	...
	info = zsysv( 'lower', 1, 1, A, 1, 1, 0, IPIV, 1, 0, B, 1, 1, 0, new Complex128Array( 1 ), 1, 0 );
...
test( 'zsysv: 3x3_upper - 3x3 complex symmetric upper', function t() {
	...
	info = zsysv( 'upper', 3, 1, A, 1, 3, 0, IPIV, 1, 0, B, 1, 3, 0, new Complex128Array( 3 ), 1, 0 );
...
test( 'zsysv: 3x3_lower - 3x3 complex symmetric lower', function t() {
	...
	info = zsysv( 'lower', 3, 1, A, 1, 3, 0, IPIV, 1, 0, B, 1, 3, 0, new Complex128Array( 3 ), 1, 0 );
