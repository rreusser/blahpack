...
import dorbdb3 from './../lib/dorbdb3.js';
...
test( 'dorbdb3 (column-major): runs to completion on Q=0 quick-return', function t() {
	const a = args();
	const info = dorbdb3( 'column-major', 2, 2, 0, a.X11, 2, a.X21, 1, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
});

test( 'dorbdb3 (row-major): runs to completion on Q=0 quick-return', function t() {
	const a = args();
	const info = dorbdb3( 'row-major', 2, 2, 0, a.X11, 1, a.X21, 1, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
});
