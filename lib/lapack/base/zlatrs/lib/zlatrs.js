...
/**
* Solves a complex triangular system of equations with scaling to prevent overflow.
*
...
* @param {Complex128Array} A - triangular matrix
...
* @throws {TypeError} fifth argument must be a valid normin value
* @throws {RangeError} if a numerical argument does not satisfy constraints
* @returns {integer} info status code
*/
function zlatrs( order, uplo, trans, diag, normin, N, A, LDA, x, strideX, scale, CNORM, strideCNORM ) {
	let sa1, sa2;
	...
	const oc = stride2offset( N, strideCNORM );
