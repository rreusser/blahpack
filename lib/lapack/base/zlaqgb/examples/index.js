...
const AB = new Complex128Array( [ 1.0, 0.5, 2.0, -1.0, 3.0, 1.0, 4.0, 2.0 ] );
const r = new Float64Array( [ 0.5, 2.0 ] );
const c = new Float64Array( [ 1.0, 1.0 ] );

const equed = zlaqgb.ndarray( 2, 2, 1, 0, AB, 1, 2, 0, r, 1, 0, c, 1, 0, 0.01, 1.0, 5.0 ); // eslint-disable-line max-len
