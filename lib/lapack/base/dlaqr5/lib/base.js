...
import dlaqr1 from '../../dlaqr1/lib/base.js';
...
function dlaqr5( wantt, wantz, kacc22, N, ktop, kbot, nshfts, SR, strideSR, offsetSR, SI, strideSI, offsetSI, H, strideH1, strideH2, offsetH, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ, V, strideV1, strideV2, offsetV, U, strideU1, strideU2, offsetU, nv, WV, strideWV1, strideWV2, offsetWV, nh, WH, strideWH1, strideWH2, offsetWH ) { // eslint-disable-line max-len
	const alphaArr = new Float64Array( 1 );
	let refsum;
	const tauArr = new Float64Array( 1 );
	let ndcol, krcol, bmp22, incol, swap, beta, jtop, jbot, jcol, jlen, jrow;
	let mbot, mtop, tst1, tst2;
	const KTOP = ktop + 1;
	const KBOT = kbot + 1;
	const ILOZ = iloz + 1;
	const IHIZ = ihiz + 1;
	const sWV1 = strideWV1;
	const sWV2 = strideWV2;
	const sWH1 = strideWH1;
	const sWH2 = strideWH2;
	let h11, h12, h21, h22, scl, kms, m22;
	const sH1 = strideH1;
	const sH2 = strideH2;
	const sZ1 = strideZ1;
	const sZ2 = strideZ2;
