...
import zhegst from '../../zhegst/lib/base.js';
import zheevx from '../../zheevx/lib/base.js';
...
*/
function zhegvx( itype, jobz, range, uplo, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, vl, vu, il, iu, abstol, out, w, strideW, offsetW, Z, strideZ1, strideZ2, offsetZ, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork, IWORK, strideIWork, offsetIWork, IFAIL, strideIFAIL, offsetIFAIL ) {
	let trans, info, M;
	...
	info = zheevx( jobz, range, uplo, N, A, sa1, sa2, offsetA, vl, vu, il, iu, abstol, out, w, strideW, offsetW, Z, sz1, sz2, offsetZ, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork, IWORK, strideIWork, offsetIWork, IFAIL, strideIFAIL, offsetIFAIL );
