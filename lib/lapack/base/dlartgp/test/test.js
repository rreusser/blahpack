...
import dlartgp from './../lib/index.js';
...
test( 'ndarray method writes to provided Float64Array', function t() {
	...
	const result = dlartgp.ndarray( 3.0, 4.0, out );
