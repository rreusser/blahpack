...
function dorglq( M, N, K, A, strideA1, strideA2, offsetA, TAU, strideTAU, offsetTAU, WORK, strideWork, offsetWork ) {
	...
	var NB = 32; // hardcoded block size in base.js; the blocked path (K > NB) stores dlarft/dlarfb scratch in WORK with leading dim M, consuming M*NB
	var minWork = ( K > NB ) ? Math.max( 1, M * NB ) : Math.max( 1, M );
