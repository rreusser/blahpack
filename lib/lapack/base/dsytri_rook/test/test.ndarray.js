...
function runFixture( uplo, N, tc ) {
	...
	const info = dsytriRook( uplo, N, A, 1, N, 0, ipiv, 1, 0, work, 1, 0 );
...
test( 'dsytri_rook: n_zero', function t() {
	...
	const info = dsytriRook( 'upper', 0, A, 1, 1, 0, ipiv, 1, 0, work, 1, 0 );
...
test( 'dsytri_rook: singular matrix returns positive info', function t() {
	...
	const info = dsytriRook( 'upper', 2, A, 1, 2, 0, ipiv, 1, 0, work, 1, 0 );
...
test( 'dsytri_rook: singular lower returns positive info', function t() {
	...
	const ipiv = new Int32Array( [ 0, 1 ] );
	const work = new Float64Array( 2 );
	const info = dsytriRook( 'lower', 2, A, 1, 2, 0, ipiv, 1, 0, work, 1, 0 );
