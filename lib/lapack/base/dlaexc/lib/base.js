...
import dlarfx from '../../dlarfx/lib/base.js';
import dlartg from '../../dlartg/lib/base.js';
import dlasy2 from '../../dlasy2/lib/base.js';
...
function dlaexc( wantq, N, T, strideT1, strideT2, offsetT, Q, strideQ1, strideQ2, offsetQ, j1, n1, n2, WORK, strideWork, offsetWork ) {
	let thresh, lanv2r, rtgOut, dnorm, scale, xnorm, temp, tau1, tau2, tau, t11;
	let t22, t33, cs, sn, nd, j3, j4, u1, u2, k, D, X, u;
	...
	if ( n1 === 1 && n2 === 1 ) {
		...
		// Fixed-size algorithm-internal scratch (NOT caller workspace): D holds
		// the order-<=4 diagonal block (4x4 column-major, leading dim LDD=4 => 16
		// elements) and X the order-<=2 Sylvester solution (2x2 column-major,
		// leading dim LDX=2 => 4 elements). Sizes are constant, independent of N.
		...
		dlasy2( false, false, -1, n1, n2, D, 1, LDD, 0, D, 1, LDD, n1 * 1 + n1 * LDD, D, 1, LDD, n1 * LDD, scale, X, 1, LDX, 0, xnorm );
