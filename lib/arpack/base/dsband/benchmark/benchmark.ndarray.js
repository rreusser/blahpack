	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			...
			info = dsband.ndarray( true, 'all', select, 1, 0, d, 1, 0, V, 1, N, 0, 0.0, N, AB, 1, lda, 0, MB, 1, lda, 0, RFAC, 1, lda, 0, kl, ku, 'LM', 'generalized', nev, 0.0, resid, 1, 0, ncv, V, 1, N, 0, iparam, 1, 0, workd, 1, 0, workl, 1, 0, lworkl, iwork, 1, 0, 1 );
			if ( info !== 0 || isnan( d[ 0 ] ) ) {
