...
*/
function zunm22( side, trans, M, N, n1, n2, Q, strideQ1, strideQ2, offsetQ, C, strideC1, strideC2, offsetC, WORK, strideWork, offsetWork ) {
	let ldwork, len, sw2, nq, nw, i;
	...
	const nb = Math.max( 1, Math.floor( Math.min( lwork, lwkopt ) / nq ) );
