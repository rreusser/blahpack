...
const A_data = [ 1, 0.5, 2, -1, 3, 1, 4, 2, 5, 0, 6, -0.5 ];
const B_data = [ 0.5, 1, 1.5, -0.5, 2.5, 0, 3, 1.5, 4, -1, 5, 0.5 ];
...
test( 'zsyr2k: alpha=0 scales C by beta', function t() {
	...
	const beta = new Complex128( 2.0, 0.0 );
	const tc = alpha_zero;
	const A = makeA();
	const B = makeB();
	const C = new Complex128Array([
...
test( 'zsyr2k: N=0 quick return', function t() {
	...
	const C = new Complex128Array( [ 99.0, 0.0 ] );
	const A = makeA();
	const B = makeB();
	const alpha = new Complex128( 1.0, 0.0 );
	const beta = new Complex128( 0.0, 0.0 );
	const result = zsyr2k( 'upper', 'no-transpose', 0, 2, alpha, A, 1, 1, 0, B, 1, 1, 0, beta, C, 1, 1, 0 ); // eslint-disable-line max-len
	assert.ok( result === C );
...
test( 'zsyr2k: alpha=0, beta=1 (no-op)', function t() {
	...
	const result = zsyr2k( 'lower', 'no-transpose', 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.ok( result === C );
	assertArrayClose( toArray( reinterpret( C, 0 ) ), tc.C, 1e-14, 'C' );
});
...
test( 'zsyr2k: lower with nonzero beta', function t() {
	const alpha = new Complex128( 1.0, 0.0 );
	const beta = new Complex128( 0.5, 0.0 );
...
test( 'zsyr2k: K=0 with alpha!=0 and beta=1 is quick return', function t() {
	...
	const C = new Complex128Array( [ 42.0, 13.0, 7.0, 8.0, 9.0, 10.0, 11.0, 12.0 ] );
	const A = makeA();
	const B = makeB();
	const alpha = new Complex128( 1.0, 0.0 );
	const beta = new Complex128( 1.0, 0.0 );
	const result = zsyr2k( 'upper', 'no-transpose', 2, 0, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.ok( result === C );
	const Cv = reinterpret( C, 0 );
...
test( 'zsyr2k: K=0 with beta!=1 scales C', function t() {
	...
	const C = new Complex128Array( [ 2.0, 4.0, 1.0, 2.0, 3.0, 6.0, 8.0, 10.0 ] );
	const A = makeA();
	const B = makeB();
	const alpha = new Complex128( 1.0, 0.0 );
	const beta = new Complex128( 0.5, 0.0 );
...
test( 'zsyr2k: complex beta with alpha=0 (upper)', function t() {
	...
	const C = new Complex128Array( [ 2.0, 3.0, 0.0, 0.0, 4.0, 5.0, 6.0, 7.0 ] );
	const A = makeA();
	const B = makeB();
	const alpha = new Complex128( 0.0, 0.0 );
	const beta = new Complex128( 1.0, 1.0 );
	zsyr2k( 'upper', 'no-transpose', 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	const Cv = reinterpret( C, 0 );
	assertClose( Cv[ 0 ], -1.0, 1e-14, 'C[0,0] re' );
...
test( 'zsyr2k: complex beta with alpha=0 (lower)', function t() {
	...
	const C = new Complex128Array( [ 4.0, 2.0, 6.0, 8.0, 0.0, 0.0, 10.0, 12.0 ] );
	const A = makeA();
	const B = makeB();
	const alpha = new Complex128( 0.0, 0.0 );
	const beta = new Complex128( 0.5, -0.5 );
...
test( 'zsyr2k: upper, transpose with nonzero beta', function t() {
	...
	const A = makeA();
	const B = makeB();
	const C = new Complex128Array( [ 10.0, 20.0, 0.0, 0.0, 30.0, 40.0, 50.0, 60.0 ] );
	const alpha = new Complex128( 1.0, 0.0 );
	const beta = new Complex128( 0.5, 0.0 );
	zsyr2k( 'upper', 'transpose', 2, 3, alpha, A, 1, 3, 0, B, 1, 3, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	const Cv = reinterpret( C, 0 );
...
test( 'zsyr2k: lower, transpose with nonzero beta', function t() {
	...
	const A = makeA();
	const B = makeB();
	const C = new Complex128Array( [ 10.0, 20.0, 30.0, 40.0, 0.0, 0.0, 50.0, 60.0 ] );
	const alpha = new Complex128( 1.0, 0.0 );
	const beta = new Complex128( 0.5, 0.0 );
	zsyr2k( 'lower', 'transpose', 2, 3, alpha, A, 1, 3, 0, B, 1, 3, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	const Cv = reinterpret( C, 0 );
...
test( 'zsyr2k: returns C', function t() {
	...
	const alpha = new Complex128( 1.0, 0.0 );
	const beta = new Complex128( 0.0, 0.0 );
	const result = zsyr2k( 'upper', 'no-transpose', 3, 2, alpha, A, 1, 3, 0, B, 1, 3, 0, beta, C, 1, 3, 0 ); // eslint-disable-line max-len
	assert.ok( result === C );
});
