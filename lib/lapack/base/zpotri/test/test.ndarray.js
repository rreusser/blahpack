...
test( 'zpotri: upper 3x3', function t() {
	...
	const Aorig = Array.from( reinterpret( A, 0 ) );

	let info = zpotrf( 'upper', 3, A, 1, 3, 0 );
	assert.equal( info, 0 );
...
test( 'zpotri: lower 3x3', function t() {
	...
	let info = zpotrf( 'lower', 3, A, 1, 3, 0 );
	assert.equal( info, 0 );
...
test( 'zpotri: N=1', function t() {
	...
	let info = zpotrf( 'upper', 1, A, 1, 1, 0 );
	assert.equal( info, 0 );
...
test( 'zpotri: N=0 quick return', function t() {
	...
	const info = zpotri( 'upper', 0, A, 1, 1, 0 );
	assert.equal( info, tc.info );
});
...
test( 'zpotri: upper 4x4', function t() {
	...
	let info = zpotrf( 'upper', 4, A, 1, 4, 0 );
	assert.equal( info, 0 );
...
test( 'zpotri: lower 4x4', function t() {
	...
	let info = zpotrf( 'lower', 4, A, 1, 4, 0 );
	assert.equal( info, 0 );
...
test( 'zpotri: singular matrix returns info > 0', function t() {
	...
	const info = zpotri( 'upper', 3, A, 1, 3, 0 );
