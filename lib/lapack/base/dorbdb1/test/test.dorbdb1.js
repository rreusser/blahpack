...
import dorbdb1 from './../lib/dorbdb1.js';
...
test( 'dorbdb1 has expected arity', function t() {
	assert.strictEqual( dorbdb1.length, 19, 'has expected arity' );
});

test( 'dorbdb1 throws TypeError for invalid order', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'invalid', 8, 4, 2, a.X11, 8, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, TypeError );
});
...
test( 'dorbdb1 throws RangeError for negative M', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'column-major', -1, 4, 2, a.X11, 8, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError when P < Q (constraint Q <= P)', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'column-major', 8, 1, 2, a.X11, 8, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError when M-P < Q (constraint Q <= M-P)', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'column-major', 8, 7, 2, a.X11, 8, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError when Q < 0', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'column-major', 8, 4, -1, a.X11, 8, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError when M-Q < Q (constraint Q <= M-Q)', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'column-major', 4, 4, 4, a.X11, 8, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError for LDX11 too small (column-major)', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'column-major', 8, 4, 2, a.X11, 1, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError for LDX21 too small (column-major)', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'column-major', 8, 4, 2, a.X11, 8, a.X21, 1, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError for LDX11 too small (row-major)', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'row-major', 8, 4, 2, a.X11, 1, a.X21, 8, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});
...
test( 'dorbdb1 throws RangeError for LDX21 too small (row-major)', function t() {
	const a = args();
	assert.throws( function throws() {
		dorbdb1( 'row-major', 8, 4, 2, a.X11, 8, a.X21, 1, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	}, RangeError );
});

test( 'dorbdb1 (column-major): runs to completion on Q=0 quick-return', function t() {
	const a = args();
	const info = dorbdb1( 'column-major', 4, 2, 0, a.X11, 4, a.X21, 4, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	assert.strictEqual( info, 0, 'info' );
});

test( 'dorbdb1 (row-major): runs to completion on Q=0 quick-return', function t() {
	const a = args();
	const info = dorbdb1( 'row-major', 4, 2, 0, a.X11, 1, a.X21, 1, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK );
	assert.strictEqual( info, 0, 'info' );
});
