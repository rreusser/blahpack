...
import zhetri2 from './../lib/ndarray.js';


// FIXTURES //

const fixtureDir = path.join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures' ); // eslint-disable-line max-len
const rawLines = readFileSync( path.join( fixtureDir, 'zhetri2.jsonl' ), 'utf8' ).trim().split( '\n' ); // eslint-disable-line max-len
...
function runFixture( uplo, N, lwork, caseName ) {
	...
	const info = zhetri2( uplo, N, A, 1, FIXTURE_LDA, 0, ipiv, 1, 0, work, 1, 0 );
...
test( 'zhetri2: N=1 lower (trivial)', function t() {
	...
	const info = zhetri2( 'lower', 1, arr, 1, FIXTURE_LDA, 0, ipiv, 1, 0, work, 1, 0 );
...
test( 'zhetri2: N=0 quick return', function t() {
	...
	const work = new Complex128Array( 1 );
	const info = zhetri2( 'lower', 0, A, 1, 1, 0, ipiv, 1, 0, work, 1, 0 );
...
test( 'zhetri2: singular D returns positive info', function t() {
	...
	const info = zhetri2( 'lower', 2, arr, 1, 2, 0, ipiv, 1, 0, work, 1, 0 );
