...
function dgges( jobvsl, jobvsr, sort, selctg, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, ALPHAR, strideALPHAR, offsetALPHAR, ALPHAI, strideALPHAI, offsetALPHAI, BETA, strideBETA, offsetBETA, VSL, strideVSL1, strideVSL2, offsetVSL, VSR, strideVSR1, strideVSR2, offsetVSR, WORK, strideWork, offsetWork, BWORK, strideBwork, offsetBwork ) {
	...
	oLscale = offsetWork;
	oRscale = offsetWork + ( N * strideWork );
	oWrk = offsetWork + ( 2 * N * strideWork );
	...
	anrm = dlange( 'max', N, N, A, strideA1, strideA2, offsetA, WORK, strideWork, offsetWork );
	ilascl = false;
	anrmto = 0.0;
	...
	bnrm = dlange( 'max', N, N, B, strideB1, strideB2, offsetB, WORK, strideWork, offsetWork );
	ilbscl = false;
	bnrmto = 0.0;
	...
	bal = dggbal( 'permute', N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, WORK, strideWork, oLscale, WORK, strideWork, oRscale, WORK, strideWork, oWrk );
	ilo = bal.ilo; // 1-based
	ihi = bal.ihi; // 1-based
	...
	if ( wantst ) {
		...
		ierr = dtgsen( 0, ilvsl, ilvsr, SELECT, strideBwork, offsetBwork, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, ALPHAR, strideALPHAR, offsetALPHAR, ALPHAI, strideALPHAI, offsetALPHAI, BETA, strideBETA, offsetBETA, VSL, strideVSL1, strideVSL2, offsetVSL, VSR, strideVSR1, strideVSR2, offsetVSR, M, PL, PR, DIF, 1, 0, WORK, strideWork, oWrk, WORK.length - oWrk, IWORK, 1, 0, 1 );
		if ( ierr === 1 ) {
			info = N + 3;
		}
	}
