...
const SFMIN1 = dlamch( 'safe-minimum' ) / dlamch( 'precision' );
const SFMAX1 = ONE / SFMIN1;
const SFMIN2 = SFMIN1 * SCLFAC;
const SFMAX2 = ONE / SFMIN2;
...
function zgebal( job, N, A, strideA1, strideA2, offsetA, SCALE, strideSCALE, offsetSCALE ) {
	let canswap, noconv, ica, ira, ca, ra, re, im, c, f, g, r, s, i, j, k, l, p;
