...
*/
function dlatrz( order, M, N, l, A, LDA, TAU, strideTAU, WORK ) { // eslint-disable-line max-len, max-params
	let sa1, sa2;
	...
	if ( WORK === null || WORK === void 0 ) {
		const minWork = Math.max( 1, M );
		WORK = new Float64Array( minWork );
	}
	return base( M, N, l, A, sa1, sa2, 0, TAU, strideTAU, 0, WORK, 1, 0 ); // eslint-disable-line max-len
}
