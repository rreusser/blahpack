...
function callZggrqf( M, P, N, aFlat, bFlat ) {
	...
	info = zggrqf( M, P, N, A, 1, M, 0, TAUA, 1, 0, B, 1, P, 0, TAUB, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	return {
		'info': info,
...
test( 'zggrqf: m_zero (quick return)', function t() {
	...
	info = zggrqf( 0, 3, 3, A, 1, 0, 0, TAUA, 1, 0, B, 1, 3, 0, TAUB, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
