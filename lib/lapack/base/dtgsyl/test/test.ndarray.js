...
test( 'dtgsyl.ndarray: notrans 2x2 IJOB=0', function t() {
	...
	var info = dtgsyl( 'no-transpose', 0, M, N, A, 1, M, 0, B, 1, N, 0, C, 1, M, 0, D, 1, M, 0, E, 1, N, 0, F, 1, M, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dtgsyl.ndarray: trans 2x2 IJOB=0', function t() {
	...
	var WORK = new Float64Array( 400 );
	var IWORK = new Int32Array( M + N + 6 );
	var info = dtgsyl( 'transpose', 0, M, N, A, 1, M, 0, B, 1, N, 0, C, 1, M, 0, D, 1, M, 0, E, 1, N, 0, F, 1, M, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, tc.info, 'info' );
	assertClose( scale[ 0 ], tc.scale, TOL, 'scale' );
	assertArrayClose( extractMatrix( C, M, M, N ), tc.C, TOL, 'C' );
	assertArrayClose( extractMatrix( F, M, M, N ), tc.F, TOL, 'F' );
...
test( 'dtgsyl.ndarray: notrans 2x2 IJOB=1 (Frobenius DIF estimate)', function t() {
	...
	var WORK = new Float64Array( 400 );
	var IWORK = new Int32Array( M + N + 6 );
	var info = dtgsyl( 'no-transpose', 1, M, N, A, 1, M, 0, B, 1, N, 0, C, 1, M, 0, D, 1, M, 0, E, 1, N, 0, F, 1, M, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, tc.info, 'info' );
	assertClose( scale[ 0 ], tc.scale, TOL, 'scale' );
...
test( 'dtgsyl.ndarray: notrans 2x2 IJOB=2 (1-norm DIF estimate)', function t() {
	...
	var WORK = new Float64Array( 400 );
	var IWORK = new Int32Array( M + N + 6 );
	var info = dtgsyl( 'no-transpose', 2, M, N, A, 1, M, 0, B, 1, N, 0, C, 1, M, 0, D, 1, M, 0, E, 1, N, 0, F, 1, M, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dtgsyl.ndarray: notrans 2x2 IJOB=3 (zeros C/F, computes DIF only)', function t() {
	...
	var WORK = new Float64Array( 400 );
	var IWORK = new Int32Array( M + N + 6 );
	var info = dtgsyl( 'no-transpose', 3, M, N, A, 1, M, 0, B, 1, N, 0, C, 1, M, 0, D, 1, M, 0, E, 1, N, 0, F, 1, M, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, 0, 'info' );
...
test( 'dtgsyl.ndarray: notrans 2x2 IJOB=4 (zeros C/F, 1-norm DIF only)', function t() {
	...
	var WORK = new Float64Array( 400 );
	var IWORK = new Int32Array( M + N + 6 );
	var info = dtgsyl( 'no-transpose', 4, M, N, A, 1, M, 0, B, 1, N, 0, C, 1, M, 0, D, 1, M, 0, E, 1, N, 0, F, 1, M, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assert.ok( dif[ 0 ] > 0, 'dif > 0' );
});
...
test( 'dtgsyl.ndarray: M=0 N=0 quick return notrans IJOB=0', function t() {
	...
	var info = dtgsyl( 'no-transpose', 0, 0, 0, A, 1, 1, 0, B, 1, 1, 0, C, 1, 1, 0, D, 1, 1, 0, E, 1, 1, 0, F, 1, 1, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, 0, 'info' );
...
test( 'dtgsyl.ndarray: M=0 N=0 quick return notrans IJOB=1 (zeros dif)', function t() {
	...
	var WORK = new Float64Array( 1 );
	var IWORK = new Int32Array( 10 );
	var info = dtgsyl( 'no-transpose', 1, 0, 0, A, 1, 1, 0, B, 1, 1, 0, C, 1, 1, 0, D, 1, 1, 0, E, 1, 1, 0, F, 1, 1, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assert.equal( scale[ 0 ], 1.0, 'scale=1' );
...
test( 'dtgsyl.ndarray: M=0 quick return transpose', function t() {
	...
	var WORK = new Float64Array( 1 );
	var IWORK = new Int32Array( 10 );
	var info = dtgsyl( 'transpose', 0, 0, 2, A, 1, 1, 0, B, 1, 2, 0, C, 1, 1, 0, D, 1, 1, 0, E, 1, 2, 0, F, 1, 1, 0, scale, dif, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assert.equal( scale[ 0 ], 1.0, 'scale=1' );
});
