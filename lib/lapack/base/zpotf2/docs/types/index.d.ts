...
interface Routine {
	...
	*/
	...
	/**
	* Computes the Cholesky factorization of a Hermitian positive definite matrix `A` (unblocked algorithm, complex double-precision) using alternative indexing semantics.
	*
	* @param uplo - specifies whether the upper or lower triangular part is referenced
	* @param N - number of columns
	* @param A - `A`
