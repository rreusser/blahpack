...
import zlanhs from './../lib/ndarray.js';


// FIXTURES //

const fixtureFile = path.join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures', 'zlanhs.jsonl' );
...
function runCase( name, norm, N, A, lda ) {
	...
	const got = zlanhs( norm, N, A, 1, lda, 0, WORK, 1, 0 );
