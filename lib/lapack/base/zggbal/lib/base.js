...
function zggbal( job, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, LSCALE, strideLSCALE, offsetLSCALE, RSCALE, strideRSCALE, offsetRSCALE, WORK, strideWork, offsetWork ) {
	let lsfmax, lsfmin, pgamma, sfmax, sfmin, kount, gamma, alpha, coef2, coef5;
	let found, irab, icab, lcab, lrab, basl, beta, cmax, coef, nrp2, cab, cor;
	let rab, sum, lm1, sA1, sA2, sB1, sB2, ewc, ip1, jp1, idx, nr, oA, oB, sL;
	let sR, oL, oR, sW, oW, ew, it, ir, jc, tc, ta, tb, Av, Bv, t, k, l, m, i;
	let j;
	...
	*/
	function findAndPermute( kk, ll ) {
		let allZeroCol, foundRow, foundCol, allZero, ii, jj;
		k = kk;
		l = ll;
