...
function zlabrd( order, M, N, nb, A, LDA, d, strideD, e, strideE, TAUQ, strideTAUQ, TAUP, strideTAUP, X, LDX, Y, LDY ) {
	...
	return base( M, N, nb, A, sa1, sa2, 0, d, strideD, od, e, strideE, oe, TAUQ, strideTAUQ, otq, TAUP, strideTAUP, otp, X, sx1, sx2, 0, Y, sy1, sy2, 0 );
}


// EXPORTS //

export default zlabrd;
