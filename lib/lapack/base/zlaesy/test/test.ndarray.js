...
import zlaesy from './../lib/index.js';
...
test( 'zlaesy: mathematical property - trace and determinant preserved', function t() {
	...
	const traceR = result.rt1r + result.rt2r;
	const traceI = result.rt1i + result.rt2i;
	...
	const detR = result.rt1r * result.rt2r - result.rt1i * result.rt2i;
	const detI = result.rt1r * result.rt2i + result.rt1i * result.rt2r;
