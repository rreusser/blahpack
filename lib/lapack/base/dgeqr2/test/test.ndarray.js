...
test( 'dgeqr2: 3x2', function t() {
	...
	const info = dgeqr2( 3, 2, A, 1, 3, 0, TAU, 1, 0, WORK, 1, 0 );
...
test( 'dgeqr2: 2x2', function t() {
	...
	const TAU = new Float64Array( 2 );
	const WORK = new Float64Array( 2 );
	const info = dgeqr2( 2, 2, A, 1, 2, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.strictEqual( info, tc.INFO );
...
test( 'dgeqr2: N=0', function t() {
	...
	const TAU = new Float64Array( 2 );
	const WORK = new Float64Array( 2 );
	const info = dgeqr2( 2, 0, A, 1, 2, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.strictEqual( info, tc.INFO );
});
...
test( 'dgeqr2: M=0', function t() {
	...
	const TAU = new Float64Array( 2 );
	const WORK = new Float64Array( 2 );
	const info = dgeqr2( 0, 2, A, 1, 1, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.strictEqual( info, tc.INFO );
});
...
test( 'dgeqr2: 4x3', function t() {
	...
	const info = dgeqr2( 4, 3, A, 1, 4, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.strictEqual( info, tc.INFO );
