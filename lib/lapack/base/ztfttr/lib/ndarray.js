...
*/
function ztfttr( transr, uplo, N, ARF, strideARF, offsetARF, A, strideA1, strideA2, offsetA ) { // eslint-disable-line max-len, max-params
	...
	return base( transr, uplo, N, ARF, strideARF, offsetARF, A, strideA1, strideA2, offsetA ); // eslint-disable-line max-len
}
