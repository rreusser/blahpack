...
import zunmql from '../../zunmql/lib/base.js';
...
*/
function zunmtr( side, uplo, trans, M, N, A, strideA1, strideA2, offsetA, TAU, strideTAU, offsetTAU, C, strideC1, strideC2, offsetC, WORK, strideWork, offsetWork ) {
	var upper;
	var left;
	var nq;
	var mi;
