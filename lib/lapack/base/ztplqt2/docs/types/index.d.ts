...
interface Routine {
	...
	*/
	...
	/**
	* Computes an LQ factorization of a complex triangular-pentagonal matrix `C = [A, B]` using the compact WY representation for `Q` using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param N - number of columns
	* @param l - `l`
