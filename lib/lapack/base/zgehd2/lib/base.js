...
const SCRATCH_TAU = new Complex128Array( 1 );
const SCRATCH_TAUv = reinterpret( SCRATCH_TAU, 0 );
const SCRATCH_ALPHA = new Complex128Array( 1 );
const SCRATCH_ALPHAv = reinterpret( SCRATCH_ALPHA, 0 );
/**
