...
import ztbsv from '../../../../blas/base/ztbsv/lib/base.js';
...
function zlatbs( uplo, trans, diag, normin, N, kd, AB, strideAB1, strideAB2, offsetAB, x, strideX, offsetX, scale, CNORM, strideCNORM, offsetCNORM ) {
	let jfirst, tscal, jlast, maind, xbnd, xmax, grow, jinc, jlen, csumj_re;
	let csumj_im, tjjs_re, tjjs_im, uscal_re, uscal_im, dotResult, rec, tjj, xj;
	let jr, ji, ar, ai, xr, xi, ur, ui, j, i;

	const upper = ( uplo === 'upper' );
	const notran = ( trans === 'no-transpose' );
	const nounit = ( diag === 'non-unit' );

	const sa1 = strideAB1 * 2; // Float64 strides
