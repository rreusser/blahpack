...
interface Routine {
	...
	*/
	...
	/**
	* Computes a QR factorization of a complex M-by-N matrix `A = Q * R` with non-negative real diagonal elements of `R`, using Householder reflections (unblocked algorithm) using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param N - number of columns
	* @param A - `A`
