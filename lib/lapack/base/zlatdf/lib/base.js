...
import zgecon from '../../zgecon/lib/base.js';
...
function zlatdf( ijob, N, Z, strideZ1, strideZ2, offsetZ, RHS, strideRHS, offsetRHS, rdsum, rdscal, IPIV, strideIPIV, offsetIPIV, JPIV, strideJPIV, offsetJPIV ) {
	let rtemp, splus, sminu, temp, dotR, res, bpR, bpI, bmR, bmI, pmR, pmI, wv;
	let tR, dR, dI, rR, rI, ix, i, j, k;

	const CONE = new Complex128( ONE, ZERO );
	const MCONE = new Complex128( -ONE, ZERO );

	const xp = new Complex128Array( N );
	const xm = new Complex128Array( N );
