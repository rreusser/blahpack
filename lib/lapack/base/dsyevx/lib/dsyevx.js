...
*/
function dsyevx( jobz, range, uplo, N, A, LDA, vl, vu, il, iu, abstol, out, w, strideW, Z, LDZ, WORK, strideWork, IWORK, strideIWork, IFAIL, strideIFAIL ) { // eslint-disable-line max-len, max-params
	...
	return base( jobz, range, uplo, N, A, sa1, sa2, 0, vl, vu, il, iu, abstol, out, w, strideW, ow, Z, sz1, sz2, 0, WORK, strideWork, owork, IWORK, strideIWork, oiwork, IFAIL, strideIFAIL, oifail ); // eslint-disable-line max-len
}
