...
import dla_gbrfsx_extended from './../lib/index.js';

// 4x4 tridiagonal pre-factored system with a known exact solution.
const N = 4;
const kl = 1;
const ku = 1;
const AB = new Float64Array( [ 0.0, 4.0, -1.0, 0.5, 4.0, -1.0, 0.5, 4.0, -1.0, 0.5, 4.0, 0.0 ] );
const AFB = new Float64Array( [ 0.0, 0.0, 4.0, -1.0, 0.0, 0.5, 4.0, -1.125, 0.0, 0.5, 3.875, -1.1290322580645162, 0.0, 0.5, 3.8709677419354835, 0.0 ] );
const IPIV = new Int32Array( [ 0, 1, 2, 3 ] );
const b = new Float64Array( [ 1.0, 2.0, 3.0, 4.0 ] );
const y = new Float64Array( [ 0.19268510258697591, 0.45851917930419267, 0.7172167707404103, 1.17930419268510267 ] );
const C = new Float64Array( [ 1.0, 1.0, 1.0, 1.0 ] );
const BERR_OUT = new Float64Array( 1 );
const EBN = new Float64Array( [ 1.0, 1.0, 1.0 ] );
const EBC = new Float64Array( [ 1.0, 1.0, 1.0 ] );
