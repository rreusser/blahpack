...
import dorbdb3 from './../lib/index.js';
...
const sq3 = 1.0 / Math.sqrt( 3.0 );
const sq6 = 1.0 / Math.sqrt( 6.0 );

// X11 is 3x2 (column-major); X21 is 1x2 (column-major). Columns of [X11; X21] are orthonormal.
const X11 = new Float64Array( [ sq3, sq3, sq3, sq6, sq6, -2.0 * sq6 ] );
const X21 = new Float64Array( [ 0.0, 0.0 ] );

// Output / scalar arrays
const THETA = new Float64Array( 2 );
const PHI = new Float64Array( 1 );
const TAUP1 = new Float64Array( 3 );
