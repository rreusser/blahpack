...
import dgebd2 from '../../dgebd2/lib/base.js';
import dgemm from '../../../../blas/base/dgemm/lib/base.js';
import dlabrd from '../../dlabrd/lib/base.js';
...
*/
function dgebrd( M, N, A, strideA1, strideA2, offsetA, d, strideD, offsetD, e, strideE, offsetE, TAUQ, strideTAUQ, offsetTAUQ, TAUP, strideTAUP, offsetTAUP, WORK, strideWork, offsetWork ) {
	var ldwrkx;
	var ldwrky;
	var lwork;
	var minmn;
	...
	// Caller owns the workspace; derive the effective LWORK from the provided
	// WORK array so the block-size decision matches the space actually available.
