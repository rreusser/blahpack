...
*/
function dgees( jobvs, sort, select, N, A, strideA1, strideA2, offsetA, sdim, WR, strideWR, offsetWR, WI, strideWI, offsetWI, VS, strideVS1, strideVS2, offsetVS, WORK, strideWork, offsetWork, BWORK, strideBWork, offsetBWork ) { // eslint-disable-line max-len, max-params
	...
	const minWork = ( N === 0 ) ? 0 : Math.max( 1, 3 * N );
	...
	return base( jobvs, sort, select, N, A, strideA1, strideA2, offsetA, sdim, WR, strideWR, offsetWR, WI, strideWI, offsetWI, VS, strideVS1, strideVS2, offsetVS, WORK, strideWork, offsetWork, BWORK, strideBWork, offsetBWork ); // eslint-disable-line max-len
}
