...
*       [ (3,-1)  (2,1)   (4,2)  ]
*/
const AP = new Complex128Array( [ 2.0, 1.0, 1.0, 2.0, 5.0, -1.0, 3.0, -1.0, 2.0, 1.0, 4.0, 2.0 ] ); // eslint-disable-line max-len
let WORK = new Float64Array( 3 );

let result = zlansp( 'max', 'upper', 3, AP, WORK );
