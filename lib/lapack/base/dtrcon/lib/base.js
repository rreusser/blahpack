...
function dtrcon( norm, uplo, diag, N, A, strideA1, strideA2, offsetA, RCOND, WORK, strideWork, offsetWork, IWORK, strideIWork, offsetIWork ) {
	let ainvnm, normin, xnorm, scale, kase1, ISAVE, KASE, EST, ix, sw, ow;
	...
	const anorm = dlantr( norm, uplo, diag, N, N, A, strideA1, strideA2, offsetA, WORK, strideWork, offsetWork );
