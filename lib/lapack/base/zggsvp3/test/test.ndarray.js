...
function runCase( name, M, P, N, aEntries, bEntries, jobs ) {
	...
	info = zggsvp3( jobs[ 0 ], jobs[ 1 ], jobs[ 2 ], M, P, N, A, 1, MAXN, 0, B, 1, MAXN, 0, 1e-8, 1e-8, K, l, U, 1, ldU, 0, V, 1, ldV, 0, Q, 1, ldQ, 0, IWORK, 1, 0, RWORK, 1, 0, TAU, 1, 0, WORK, 1, 0 );
...
test( 'zggsvp3: jobu=U only', function t() {
	...
	var K = [ 0 ];
	var l = [ 0 ];
	info = zggsvp3( 'compute-U', 'none', 'none', 3, 3, 3, A, 1, MAXN, 0, B, 1, MAXN, 0, 1e-8, 1e-8, K, l, U, 1, ldU, 0, V, 1, 1, 0, Q, 1, 1, 0, IWORK, 1, 0, RWORK, 1, 0, TAU, 1, 0, WORK, 1, 0 );
...
test( 'zggsvp3: jobv=V only', function t() {
	...
	var K = [ 0 ];
	var l = [ 0 ];
	info = zggsvp3( 'none', 'compute-V', 'none', 3, 3, 3, A, 1, MAXN, 0, B, 1, MAXN, 0, 1e-8, 1e-8, K, l, U, 1, 1, 0, V, 1, ldV, 0, Q, 1, 1, 0, IWORK, 1, 0, RWORK, 1, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
});
...
test( 'zggsvp3: jobq=Q only', function t() {
	...
	var K = [ 0 ];
	var l = [ 0 ];
	info = zggsvp3( 'none', 'none', 'compute-Q', 3, 3, 3, A, 1, MAXN, 0, B, 1, MAXN, 0, 1e-8, 1e-8, K, l, U, 1, 1, 0, V, 1, 1, 0, Q, 1, ldQ, 0, IWORK, 1, 0, RWORK, 1, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
});
