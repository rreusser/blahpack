...
*/
function dgelqf( order, M, N, A, LDA, TAU, strideTAU, WORK ) {
	let sa1, sa2;
	...
	if ( WORK === null || WORK === void 0 ) {
		...
		const NB = 32;
		const minWork = ( K > NB ) ? ( M * NB ) : Math.max( 1, M );
		WORK = new Float64Array( minWork );
	}
	return base(M, N, A, sa1, sa2, 0, TAU, strideTAU, ot, WORK, 1, 0 );
}


// EXPORTS //

export default dgelqf;
