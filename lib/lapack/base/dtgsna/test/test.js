...
test( 'dtgsna: n1_both_all', function t() {
	...
	M = new Int32Array( 1 );
	info = dtgsna( 'both', 'all', SELECT, 1, 0, N, A, 1, ld, 0, B, 1, ld, 0, VL, 1, ld, 0, VR, 1, ld, 0, s, 1, 0, DIF, 1, 0, 6, M, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'dtgsna: n3_eig_all', function t() {
	...
	SELECT = new Uint8Array( 6 );
	M = new Int32Array( 1 );
	info = dtgsna( 'eigenvalues', 'all', SELECT, 1, 0, ctx.N, ctx.A, 1, ctx.ld, 0, ctx.B, 1, ctx.ld, 0, ctx.VL, 1, ctx.ld, 0, ctx.VR, 1, ctx.ld, 0, s, 1, 0, DIF, 1, 0, 6, M, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( info, tc.info, 'info' );
	assert.strictEqual( M[ 0 ], tc.M, 'M' );
	assertArrayClose( s, tc.S, 1e-13, 'S' );
});
...
test( 'dtgsna: n3_vec_all', function t() {
	...
	SELECT = new Uint8Array( 6 );
	M = new Int32Array( 1 );
	info = dtgsna( 'eigenvectors', 'all', SELECT, 1, 0, ctx.N, ctx.A, 1, ctx.ld, 0, ctx.B, 1, ctx.ld, 0, ctx.VL, 1, ctx.ld, 0, ctx.VR, 1, ctx.ld, 0, s, 1, 0, DIF, 1, 0, 6, M, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( info, tc.info, 'info' );
	assert.strictEqual( M[ 0 ], tc.M, 'M' );
	assertArrayClose( DIF, tc.DIF, 1e-13, 'DIF' );
});
...
test( 'dtgsna: n3_both_all', function t() {
	...
	SELECT = new Uint8Array( 6 );
	M = new Int32Array( 1 );
	info = dtgsna( 'both', 'all', SELECT, 1, 0, ctx.N, ctx.A, 1, ctx.ld, 0, ctx.B, 1, ctx.ld, 0, ctx.VL, 1, ctx.ld, 0, ctx.VR, 1, ctx.ld, 0, s, 1, 0, DIF, 1, 0, 6, M, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( info, tc.info, 'info' );
	assert.strictEqual( M[ 0 ], tc.M, 'M' );
	assertArrayClose( s, tc.S, 1e-13, 'S' );
	assertArrayClose( DIF, tc.DIF, 1e-13, 'DIF' );
...
test( 'dtgsna: n3_both_selected', function t() {
	...
	SELECT[ 2 ] = 1;
	M = new Int32Array( 1 );
	info = dtgsna( 'both', 'selected', SELECT, 1, 0, ctx.N, ctx.A, 1, ctx.ld, 0, ctx.B, 1, ctx.ld, 0, ctx.VL, 1, ctx.ld, 0, ctx.VR, 1, ctx.ld, 0, s, 1, 0, DIF, 1, 0, 6, M, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( info, tc.info, 'info' );
	assert.strictEqual( M[ 0 ], tc.M, 'M' );
	assertArrayClose( s, tc.S, 1e-13, 'S' );
	assertArrayClose( DIF, tc.DIF, 1e-13, 'DIF' );
...
test( 'dtgsna: n0', function t() {
	...
	M = new Int32Array( 1 );
	M[ 0 ] = 99;
	info = dtgsna( 'both', 'all', SELECT, 1, 0, 0, A, 1, ld, 0, B, 1, ld, 0, VL, 1, ld, 0, VR, 1, ld, 0, s, 1, 0, DIF, 1, 0, 6, M, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( info, tc.info, 'info' );
	assert.strictEqual( M[ 0 ], tc.M, 'M' );
});
