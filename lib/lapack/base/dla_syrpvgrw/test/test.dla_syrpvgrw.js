...
import dla_syrpvgrw from './../lib/dla_syrpvgrw.js';
...
test( 'dla_syrpvgrw computes for valid 2x2 lower', function t() {
	const A = new Float64Array( [ 1, 0.5, 0, 1 ] );
	const AF = new Float64Array( [ 1, 0.5, 0, 0.75 ] );
	const IPIV = new Int32Array( [ 0, 1 ] );
	const WORK = new Float64Array( 4 );
	const r = dla_syrpvgrw( 'lower', 2, 0, A, 2, AF, 2, IPIV, WORK );
