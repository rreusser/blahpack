...
const rot = new Float64Array( 3 ); // scratch for dlartg output: [c, s, r]
...
function dsbtrd( vect, uplo, N, kd, AB, strideAB1, strideAB2, offsetAB, d, strideD, offsetD, e, strideE, offsetE, Q, strideQ1, strideQ2, offsetQ, WORK, strideWork, offsetWork ) {
	let iqaend, j1end, iqend, jend, jinc, last, lend, temp, ibl, iqb, nrt, nr;
	let nq, i2, j1, j2, i, j, k, l;
	...
	const kd1 = kd + 1;
	const kdm1 = kd - 1;
	const incx = strideAB2 - strideAB1; // Fortran: LDAB - 1
