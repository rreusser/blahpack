...
test( 'dgesvx: FACT=N, TRANS=N, 3x3 well-conditioned, 1 RHS', function t() {
	...
	result = dgesvx( 'not-factored', 'no-transpose', 3, 1, A, 1, 3, 0, AF, 1, 3, 0, IPIV, 1, 0, 'none', r, 1, 0, c, 1, 0, B, 1, 3, 0, X, 1, 3, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dgesvx: FACT=N, TRANS=T, 3x3 well-conditioned', function t() {
	...
	result = dgesvx( 'not-factored', 'transpose', 3, 1, A, 1, 3, 0, AF, 1, 3, 0, IPIV, 1, 0, 'none', r, 1, 0, c, 1, 0, B, 1, 3, 0, X, 1, 3, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dgesvx: FACT=E, equilibrate poorly-scaled matrix', function t() {
	...
	result = dgesvx( 'equilibrate', 'no-transpose', 3, 1, A, 1, 3, 0, AF, 1, 3, 0, IPIV, 1, 0, 'none', r, 1, 0, c, 1, 0, B, 1, 3, 0, X, 1, 3, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dgesvx: FACT=F, pre-factored matrix', function t() {
	...
	result = dgesvx( 'factored', 'no-transpose', 3, 1, A, 1, 3, 0, AF, 1, 3, 0, IPIV, 1, 0, 'none', r, 1, 0, c, 1, 0, B, 1, 3, 0, X, 1, 3, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dgesvx: N=0 quick return', function t() {
	...
	var result = dgesvx( 'not-factored', 'no-transpose', 0, 1, new Float64Array( 0 ), 1, 1, 0, new Float64Array( 0 ), 1, 1, 0, new Int32Array( 0 ), 1, 0, 'none', new Float64Array( 0 ), 1, 0, new Float64Array( 0 ), 1, 0, new Float64Array( 0 ), 1, 1, 0, new Float64Array( 0 ), 1, 1, 0, new Float64Array( 0 ), 1, 0, new Float64Array( 0 ), 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dgesvx: multiple RHS (nrhs=2)', function t() {
	...
	result = dgesvx( 'not-factored', 'no-transpose', 3, 2, A, 1, 3, 0, AF, 1, 3, 0, IPIV, 1, 0, 'none', r, 1, 0, c, 1, 0, B, 1, 3, 0, X, 1, 3, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dgesvx: FACT=E, TRANS=T', function t() {
	...
	result = dgesvx( 'equilibrate', 'transpose', 3, 1, A, 1, 3, 0, AF, 1, 3, 0, IPIV, 1, 0, 'none', r, 1, 0, c, 1, 0, B, 1, 3, 0, X, 1, 3, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
