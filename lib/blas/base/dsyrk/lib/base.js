...
function dsyrk( uplo, trans, N, K, alpha, A, strideA1, strideA2, offsetA, beta, C, strideC1, strideC2, offsetC ) {
	...
	let c32, c33, pa0, pa1, pa2, pa3, pb0, pb1, pb2, pb3, pcc, pak, a0, a1, a2;
	let a3, b0, b1, b2, b3, pc, ic, jj, ii, pa, pb, tt, i, j, l;

	const up = ( uplo === 'upper' );
	const nt = ( trans === 'no-transpose' );
	...
	const ar = ( nt ) ? strideA1 : strideA2;
	const ak = ( nt ) ? strideA2 : strideA1;
