...
function dgemm( transa, transb, M, N, K, alpha, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, beta, C, strideC1, strideC2, offsetC ) {
	...
	let c00, c01, c02, c03, c10, c11, c12, c13, c20, c21, c22, c23, c30, c31;
	let c32, c33, a0, a1, a2, a3, b0, b1, b2, b3, pa0, pa1, pa2, pa3, pb0, pb1;
	let pb2, pb3, pc, pcc, pak, jc, kc, ic, j, i, l, jcEnd, kcEnd, icEnd, kcLen;
	let nb, mb, bz, jj, ii, pa, pb, temp;
	...
	const ar = ( nota ) ? strideA1 : strideA2; // stride along A's row dimension (within a column of op(A))
	const ak = ( nota ) ? strideA2 : strideA1; // stride along A's column dimension (the K loop)
	const bk = ( notb ) ? strideB1 : strideB2; // stride along B's row dimension (the K loop)
	const bn = ( notb ) ? strideB2 : strideB1; // stride along B's column dimension (output columns)
