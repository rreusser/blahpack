...
const SMLNUM = UNFL * ( 1.0 / ULP );  // N/ULP at N=1, close enough
...
*/
function dtrevc3( side, howmny, SELECT, strideSELECT, offsetSELECT, N, T, strideT1, strideT2, offsetT, VL, strideVL1, strideVL2, offsetVL, VR, strideVR1, strideVR2, offsetVR, mm, M, WORK, strideWork, offsetWork ) {
	let remax, scale, xnorm, vcrit, smin, emax, vmax, beta, pair, jnxt, rec;
	let res, wr, wi, ip, is, ki, ii, j1, j2, j, k, m;
