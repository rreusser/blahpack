...
*/
function dgsvj0( order, jobv, M, N, A, LDA, d, strideD, sva, strideSVA, mv, V, LDV, eps, sfmin, tol, nsweep, work, strideWork ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	var sv1;
	var sv2;
	...
	return base( jobv, M, N, A, sa1, sa2, 0, d, strideD, 0, sva, strideSVA, 0, mv, V, sv1, sv2, 0, eps, sfmin, tol, nsweep, work, strideWork, 0 ); // eslint-disable-line max-len
}
