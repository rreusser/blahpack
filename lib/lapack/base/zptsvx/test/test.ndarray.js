...
test( 'zptsvx: fact_n_4x4 - factor and solve N=4, NRHS=1', function t() {
	...
	const b = new Complex128Array( [ 6.5, 4.0, 12.15, -4.55, 7.1, 3.25, -3.25, 7.0 ] );
	...
	const info = zptsvx( 'not-factored', 4, 1, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 4, 0, x, 1, 4, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	const xv = toArray( reinterpret( x, 0 ) );
...
test( 'zptsvx: fact_n_3x3 - factor and solve N=3, NRHS=1', function t() {
	...
	const e = new Complex128Array( [ 1.0, 1.0, 1.0, -1.0 ] );
	const df = new Float64Array( 3 );
	const ef = new Complex128Array( 2 );
	const b = new Complex128Array( [ 12.0, 12.0, 24.0, -4.0, 32.0, -8.0 ] );
	...
	const info = zptsvx( 'not-factored', 3, 1, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 3, 0, x, 1, 3, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	const xv = toArray( reinterpret( x, 0 ) );
	assert.strictEqual( info, tc.info );
	assertArrayClose( xv, tc.x, 1e-14, 'x' );
	assertClose( rcond[ 0 ], tc.rcond, 1e-14, 'rcond' );
...
test( 'zptsvx: fact_f_4x4 - pre-factored, N=4, NRHS=1', function t() {
	...
	const ef = new Complex128Array( [ 1.0, 0.5, 0.5, -0.3, 0.2, 0.1 ] );
	...
	const work = new Complex128Array( 4 );
	const rwork = new Float64Array( 4 );
	const info = zptsvx( 'factored', 4, 1, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 4, 0, x, 1, 4, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	const xv = toArray( reinterpret( x, 0 ) );
	assert.strictEqual( info, tc.info );
	assertArrayClose( xv, tc.x, 1e-14, 'x' );
	assertClose( rcond[ 0 ], tc.rcond, 1e-14, 'rcond' );
...
test( 'zptsvx: n_zero - quick return for N=0', function t() {
	...
	const info = zptsvx( 'not-factored', 0, 1, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 1, 0, x, 1, 1, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( info, tc.info );
});
...
test( 'zptsvx: n_one - N=1 scalar case', function t() {
	...
	const work = new Complex128Array( 1 );
	const rwork = new Float64Array( 1 );
	const info = zptsvx( 'not-factored', 1, 1, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 1, 0, x, 1, 1, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	const xv = toArray( reinterpret( x, 0 ) );
	assert.strictEqual( info, tc.info );
	assertArrayClose( xv, tc.x, 1e-14, 'x' );
	assertClose( rcond[ 0 ], tc.rcond, 1e-14, 'rcond' );
...
test( 'zptsvx: not_posdef - not positive definite returns info > 0', function t() { // eslint-disable-line max-len
	...
	const e = new Complex128Array( [ 1.0, 0.0, 2.0, 0.0 ] );
	const df = new Float64Array( 3 );
	const ef = new Complex128Array( 2 );
...
test( 'zptsvx: multi_rhs - N=3, NRHS=2', function t() {
	...
	const work = new Complex128Array( 3 );
	const rwork = new Float64Array( 3 );
	const info = zptsvx( 'not-factored', 3, 2, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 3, 0, x, 1, 3, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	const xv = toArray( reinterpret( x, 0 ) );
	assert.strictEqual( info, tc.info );
	assertArrayClose( xv, tc.x, 1e-14, 'x' );
	assertClose( rcond[ 0 ], tc.rcond, 1e-14, 'rcond' );
...
test( 'zptsvx: n5_nrhs1 - larger system N=5, NRHS=1', function t() {
	...
	const e = new Complex128Array( [ 1.0, 0.5, 2.0, -1.0, 1.5, 0.5, 0.5, -0.5 ] );
	const df = new Float64Array( 5 );
	const ef = new Complex128Array( 4 );
	const b = new Complex128Array( [ 10.5, 1.5, 25.0, 17.5, 63.0, 2.0, 23.5, -21.5, 11.0, 0.0 ] ); // eslint-disable-line max-len
	...
	const info = zptsvx( 'not-factored', 5, 1, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 5, 0, x, 1, 5, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	const xv = toArray( reinterpret( x, 0 ) );
	assert.strictEqual( info, tc.info );
	assertArrayClose( xv, tc.x, 1e-14, 'x' );
	assertClose( rcond[ 0 ], tc.rcond, 1e-14, 'rcond' );
...
test( 'zptsvx: n2_nrhs1 - N=2 system', function t() {
	...
	const e = new Complex128Array( [ 1.0, 1.0 ] );
	const df = new Float64Array( 2 );
	const ef = new Complex128Array( 1 );
	const b = new Complex128Array( [ 7.0, 5.0, 12.0, -5.0 ] );
	...
	const info = zptsvx( 'not-factored', 2, 1, d, 1, 0, e, 1, 0, df, 1, 0, ef, 1, 0, b, 1, 2, 0, x, 1, 2, 0, rcond, ferr, 1, 0, berr, 1, 0, work, 1, 0, rwork, 1, 0 ); // eslint-disable-line max-len
	const xv = toArray( reinterpret( x, 0 ) );
	assert.strictEqual( info, tc.info );
	assertArrayClose( xv, tc.x, 1e-14, 'x' );
	assertClose( rcond[ 0 ], tc.rcond, 1e-14, 'rcond' );
