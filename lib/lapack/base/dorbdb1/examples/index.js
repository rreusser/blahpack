...
import dorbdb1 from './../lib/index.js';
...
const X11 = new Float64Array( [ sq2, 0.0, 0.0, sq2 ] ); // 2x2 column-major
const X21 = new Float64Array( [ sq2, 0.0, 0.0, sq2 ] ); // 2x2 column-major

// Output / scalar arrays
const THETA = new Float64Array( 2 );
const PHI = new Float64Array( 1 );
const TAUP1 = new Float64Array( 2 );
const TAUP2 = new Float64Array( 2 );
