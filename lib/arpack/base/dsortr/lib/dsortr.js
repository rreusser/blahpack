...
*/
function dsortr( which, apply, N, x1, strideX1, x2, strideX2 ) {
	...
	return base( which, apply, N, x1, strideX1, stride2offset( N, strideX1 ), x2, strideX2, stride2offset( N, strideX2 ) );
}
