...
*/
function zgeqlf( order, M, N, A, LDA, TAU, strideTAU, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	let sa1, sa2;
	...
	return base( M, N, A, sa1, sa2, 0, TAU, strideTAU, 0, WORK, strideWork, 0 );
}
