...
import zlatsqr from './../lib/zlatsqr.js';
...
test( 'the function returns 0 for a quick-return case (M=0)', function t() {
	const info = zlatsqr( 'column-major', 0, 0, 1, 1, new Complex128Array( 1 ), 1, new Complex128Array( 1 ), 1, new Complex128Array( 1 ) );
...
test( 'the function works in column-major layout for a small TSQR case', function t() {
	...
	const A = new Complex128Array( [ 1.0, 0.1, 2.0, -0.1, 3.0, 0.2, 4.0, -0.2, 0.5, 0.05, 1.5, -0.15, 2.5, 0.25, 3.5, -0.25 ] ); // eslint-disable-line max-len
	const T = new Complex128Array( 4 );
	const WORK = new Complex128Array( 4 );
	const info = zlatsqr( 'column-major', 4, 2, 8, 2, A, 4, T, 2, WORK );
	assert.strictEqual( info, 0, 'returns 0' );
});
...
test( 'the function works in row-major layout for a small TSQR case', function t() {
	...
	const T = new Complex128Array( 4 );
	const WORK = new Complex128Array( 4 );
	const info = zlatsqr( 'row-major', 4, 2, 8, 2, A, 2, T, 2, WORK );
	assert.strictEqual( info, 0, 'returns 0' );
});
