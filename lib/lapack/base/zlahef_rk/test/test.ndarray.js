...
const rawLines = readFileSync( path.join( fixtureDir, 'zlahef_rk.jsonl' ), 'utf8' ).trim().split( '\n' ); // eslint-disable-line node/no-sync, max-len
...
test( 'zlahef_rk: lower_6x6_nb3', function t() {
	...
	const result = zlahefRk( 'lower', 6, 3, A, 1, 6, 0, e, 1, 0, IPIV, 1, 0, W, 1, 6, 0 );
...
test( 'zlahef_rk: upper_6x6_nb3', function t() {
	...
	const W = new Complex128Array( 6 * 3 );
	const e = new Complex128Array( 6 );
	const result = zlahefRk( 'upper', 6, 3, A, 1, 6, 0, e, 1, 0, IPIV, 1, 0, W, 1, 6, 0 );
	const Av = reinterpret( A, 0 );
	const Ev = reinterpret( e, 0 );
	assertArrayClose( Av, tc.A, 1e-12, 'A' );
	assertArrayClose( Ev, tc.e, 1e-12, 'e' );
...
test( 'zlahef_rk: lower_4x4_full_nb8', function t() {
	...
	const result = zlahefRk( 'lower', 4, 8, A, 1, 4, 0, e, 1, 0, IPIV, 1, 0, W, 1, 4, 0 );
	const Av = reinterpret( A, 0 );
	const Ev = reinterpret( e, 0 );
	assertArrayClose( Av, tc.A, 1e-12, 'A' );
	assertArrayClose( Ev, tc.e, 1e-12, 'e' );
...
test( 'zlahef_rk: upper_4x4_full_nb8', function t() {
	...
	const W = new Complex128Array( 4 * 8 );
	const e = new Complex128Array( 4 );
	const result = zlahefRk( 'upper', 4, 8, A, 1, 4, 0, e, 1, 0, IPIV, 1, 0, W, 1, 4, 0 );
	const Av = reinterpret( A, 0 );
	const Ev = reinterpret( e, 0 );
	assertArrayClose( Av, tc.A, 1e-12, 'A' );
	assertArrayClose( Ev, tc.e, 1e-12, 'e' );
