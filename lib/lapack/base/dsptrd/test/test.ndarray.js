...
test( 'dsptrd: upper_4x4', function t() {
	...
	const tc = upper_4x4;
	const AP = new Float64Array( [ 4, 1, 5, 2, 1, 6, 1, 2, 1, 7 ] );
	const d = new Float64Array( 4 );
	const e = new Float64Array( 3 );
	const tau = new Float64Array( 3 );
	const info = dsptrd( 'upper', 4, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
...
test( 'dsptrd: lower_4x4', function t() {
	...
	const tc = lower_4x4;
	const AP = new Float64Array( [ 4, 1, 2, 1, 5, 1, 2, 6, 1, 7 ] );
	const d = new Float64Array( 4 );
	const e = new Float64Array( 3 );
	const tau = new Float64Array( 3 );
	const info = dsptrd( 'lower', 4, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( AP, tc.AP, 1e-14, 'AP' );
	assertArrayClose( d, tc.d, 1e-14, 'd' );
	assertArrayClose( e, tc.e, 1e-14, 'e' );
...
test( 'dsptrd: upper_3x3', function t() {
	...
	const tc = upper_3x3;
	const AP = new Float64Array( [ 2, 3, 5, 1, 4, 8 ] );
	const d = new Float64Array( 3 );
	const e = new Float64Array( 2 );
	const tau = new Float64Array( 2 );
	const info = dsptrd( 'upper', 3, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( AP, tc.AP, 1e-14, 'AP' );
	assertArrayClose( d, tc.d, 1e-14, 'd' );
	assertArrayClose( e, tc.e, 1e-14, 'e' );
...
test( 'dsptrd: lower_3x3', function t() {
	...
	const tc = lower_3x3;
	const AP = new Float64Array( [ 2, 3, 1, 5, 4, 8 ] );
	const d = new Float64Array( 3 );
	const e = new Float64Array( 2 );
	const tau = new Float64Array( 2 );
	const info = dsptrd( 'lower', 3, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( AP, tc.AP, 1e-14, 'AP' );
	assertArrayClose( d, tc.d, 1e-14, 'd' );
	assertArrayClose( e, tc.e, 1e-14, 'e' );
...
test( 'dsptrd: n_one_upper', function t() {
	...
	const info = dsptrd( 'upper', 1, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
	assert.equal( info, tc.info, 'info' );
...
test( 'dsptrd: n_one_lower', function t() {
	...
	const e = new Float64Array( 0 );
	const tau = new Float64Array( 0 );
	const info = dsptrd( 'lower', 1, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
	assert.equal( info, tc.info, 'info' );
	assertClose( AP[ 0 ], tc.AP1, 1e-14, 'AP1' );
	assertClose( d[ 0 ], tc.d1, 1e-14, 'd1' );
});
...
test( 'dsptrd: n_zero', function t() {
	...
	const e = new Float64Array( 0 );
	const tau = new Float64Array( 0 );
	const info = dsptrd( 'upper', 0, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
...
test( 'dsptrd: upper_diagonal', function t() {
	...
	const AP = new Float64Array( [ 2, 0, 5, 0, 0, 8 ] );
	const d = new Float64Array( 3 );
	const e = new Float64Array( 2 );
	const tau = new Float64Array( 2 );
	const info = dsptrd( 'upper', 3, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
...
test( 'dsptrd: lower_diagonal', function t() {
	...
	const AP = new Float64Array( [ 2, 0, 0, 5, 0, 8 ] );
	const d = new Float64Array( 3 );
	const e = new Float64Array( 2 );
	const tau = new Float64Array( 2 );
	const info = dsptrd( 'lower', 3, AP, 1, 0, d, 1, 0, e, 1, 0, tau, 1, 0 );
