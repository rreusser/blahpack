...
test( 'dlarrb: zero-size quick return via layout wrapper', function t() {
	const info = dlarrb( 0, new Float64Array( 1 ), 1, new Float64Array( 1 ), 1, 1, 0, 1e-8, 1e-14, 0, new Float64Array( 1 ), 1, new Float64Array( 1 ), 1, new Float64Array( 1 ), 1, new Float64Array( 2 ), 1, new Int32Array( 2 ), 1, 0, 1e-30, 1.0, -1 ); // eslint-disable-line max-len
