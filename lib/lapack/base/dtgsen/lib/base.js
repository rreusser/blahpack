...
import dtgexc from '../../dtgexc/lib/base.js';
import dtgsyl from '../../dtgsyl/lib/base.js';
import dlacpy from '../../dlacpy/lib/base.js';
import dlassq from '../../dlassq/lib/base.js';
import dlag2 from '../../dlag2/lib/base.js';
...
function dtgsen( ijob, wantq, wantz, SELECT, strideSELECT, offsetSELECT, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, ALPHAR, strideALPHAR, offsetALPHAR, ALPHAI, strideALPHAI, offsetALPHAI, BETA, strideBETA, offsetBETA, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, M, pl, pr, DIF, strideDIF, offsetDIF, WORK, strideWork, offsetWork, IWORK, strideIWork, offsetIWork ) { // eslint-disable-line max-len, max-params
	let rdscal, dscale, liwmin, result, lwmin, isave, dsum, swap, pair, ierr;
	let info, kase, est, mn2, ijb, n1, n2, ks, kk, sa, sb, k, i;

	info = 0;

	// Caller owns the workspace; derive the available lengths from the provided arrays.
	const lwork = Math.floor( ( WORK.length - offsetWork ) / Math.abs( strideWork ) );
	const liwork = Math.floor( ( IWORK.length - offsetIWork ) / Math.abs( strideIWork ) );

	const lquery = ( lwork === -1 || liwork === -1 );
	...
	const wantp = ( ijob === 1 || ijob >= 4 );
	const wantd1 = ( ijob === 2 || ijob === 4 );
	const wantd2 = ( ijob === 3 || ijob === 5 );
	const wantd = wantd1 || wantd2;
		...
		if ( pair ) {
			...
			if ( swap ) {
				...
				if ( k !== ks - 1 ) {
					...
					result = dtgexc( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, kk, ks - 1, WORK, strideWork, offsetWork );
					ierr = result.info;
				}
	...
	if ( wantp ) {
		...
		dtgsyl( 'no-transpose', ijb, n1, n2, A, strideA1, strideA2, offsetA, A, strideA1, strideA2, offsetA + i * strideA1 + i * strideA2, WORK, 1, n1, offsetWork, B, strideB1, strideB2, offsetB, B, strideB1, strideB2, offsetB + i * strideB1 + i * strideB2, WORK, 1, n1, offsetWork + n1 * n2, sa, sb, WORK, 1, offsetWork + 2 * n1 * n2, IWORK, strideIWork, offsetIWork );
	...
	if ( wantd ) {
		...
		if ( wantd1 ) {
			...
			dtgsyl( 'no-transpose', ijb, n2, n1, A, strideA1, strideA2, offsetA + i * strideA1 + i * strideA2, A, strideA1, strideA2, offsetA, WORK, 1, n2, offsetWork, B, strideB1, strideB2, offsetB + i * strideB1 + i * strideB2, B, strideB1, strideB2, offsetB, WORK, 1, n2, offsetWork + n1 * n2, sa, sb, WORK, 1, offsetWork + 2 * n1 * n2, IWORK, strideIWork, offsetIWork );
			...
			while ( true ) { // eslint-disable-line no-constant-condition
				...
				if ( kase[ 0 ] === 1 ) {
					...
					dtgsyl( 'transpose', ijb, n1, n2, A, strideA1, strideA2, offsetA, A, strideA1, strideA2, offsetA + i * strideA1 + i * strideA2, WORK, 1, n1, offsetWork, B, strideB1, strideB2, offsetB, B, strideB1, strideB2, offsetB + i * strideB1 + i * strideB2, WORK, 1, n1, offsetWork + n1 * n2, sa, sb, WORK, 1, offsetWork + 2 * n1 * n2, IWORK, strideIWork, offsetIWork );
				}
			}
			...
			while ( true ) { // eslint-disable-line no-constant-condition
				...
				if ( kase[ 0 ] === 1 ) {
					...
					dtgsyl( 'transpose', ijb, n2, n1, A, strideA1, strideA2, offsetA + i * strideA1 + i * strideA2, A, strideA1, strideA2, offsetA, WORK, 1, n2, offsetWork, B, strideB1, strideB2, offsetB + i * strideB1 + i * strideB2, B, strideB1, strideB2, offsetB, WORK, 1, n2, offsetWork + n1 * n2, sa, sb, WORK, 1, offsetWork + 2 * n1 * n2, IWORK, strideIWork, offsetIWork );
				}
			}
