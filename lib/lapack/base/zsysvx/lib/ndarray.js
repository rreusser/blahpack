...
* @param {Complex128Array} WORK - caller-owned complex workspace of at least `max(1,2*N)` complex elements from `offsetWork` (never allocated here)
* @param {integer} strideWork - stride for WORK (in complex elements)
* @param {NonNegativeInteger} offsetWork - offset for WORK (in complex elements)
* @param {Float64Array} RWORK - caller-owned real workspace of at least `max(1,N)` elements from `offsetRWork` (never allocated here)
