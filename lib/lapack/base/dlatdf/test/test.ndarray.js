...
test( 'dlatdf: IJOB=1, 2x2 system', function t() {
	...
	const tc = ijob1_2x2;
	const Z = new Float64Array( [ 4.0, 2.0, 3.0, 1.0 ] );
	const IPIV = new Int32Array( 2 );
	const JPIV = new Int32Array( 2 );
	dgetc2( 2, Z, 1, 2, 0, IPIV, 1, 0, JPIV, 1, 0 );
	const RHS = new Float64Array( [ 1.0, 1.0 ] );
	const out = dlatdf( 1, 2, Z, 1, 2, 0, RHS, 1, 0, 0.0, 1.0, IPIV, 1, 0, JPIV, 1, 0 );
...
test( 'dlatdf: IJOB=2, 2x2 system', function t() {
	...
	dgetc2( 2, Z, 1, 2, 0, IPIV, 1, 0, JPIV, 1, 0 );
	const RHS = new Float64Array( [ 1.0, 1.0 ] );
	const out = dlatdf( 2, 2, Z, 1, 2, 0, RHS, 1, 0, 0.0, 1.0, IPIV, 1, 0, JPIV, 1, 0 );
	assertArrayClose( RHS, 0, 1, tc.rhs, 2, 1e-12, 'rhs' );
	assertClose( out.rdsum, tc.rdsum, 1e-12, 'rdsum' );
	assertClose( out.rdscal, tc.rdscal, 1e-12, 'rdscal' );
});
...
test( 'dlatdf: IJOB=1, 3x3 system', function t() {
	...
	const RHS = new Float64Array( [ 1.0, -1.0, 0.5 ] );
	const out = dlatdf( 1, 3, Z, 1, 3, 0, RHS, 1, 0, 1.0, 1.0, IPIV, 1, 0, JPIV, 1, 0 );
...
test( 'dlatdf: IJOB=2, 3x3 system', function t() {
	...
	dgetc2( 3, Z, 1, 3, 0, IPIV, 1, 0, JPIV, 1, 0 );
	const RHS = new Float64Array( [ 1.0, -1.0, 0.5 ] );
	const out = dlatdf( 2, 3, Z, 1, 3, 0, RHS, 1, 0, 1.0, 1.0, IPIV, 1, 0, JPIV, 1, 0 );
	assertArrayClose( RHS, 0, 1, tc.rhs, 3, 1e-12, 'rhs' );
	assertClose( out.rdsum, tc.rdsum, 1e-12, 'rdsum' );
	assertClose( out.rdscal, tc.rdscal, 1e-12, 'rdscal' );
});
...
test( 'dlatdf: IJOB=1, 4x4 system', function t() {
	...
	const RHS = new Float64Array( [ 1.0, -1.0, 2.0, -0.5 ] );
	const out = dlatdf( 1, 4, Z, 1, 4, 0, RHS, 1, 0, 0.0, 1.0, IPIV, 1, 0, JPIV, 1, 0 );
...
test( 'dlatdf: IJOB=2, 4x4 system', function t() {
	...
	dgetc2( 4, Z, 1, 4, 0, IPIV, 1, 0, JPIV, 1, 0 );
	const RHS = new Float64Array( [ 1.0, -1.0, 2.0, -0.5 ] );
	const out = dlatdf( 2, 4, Z, 1, 4, 0, RHS, 1, 0, 0.0, 1.0, IPIV, 1, 0, JPIV, 1, 0 );
	assertArrayClose( RHS, 0, 1, tc.rhs, 4, 1e-12, 'rhs' );
	assertClose( out.rdsum, tc.rdsum, 1e-12, 'rdsum' );
	assertClose( out.rdscal, tc.rdscal, 1e-12, 'rdscal' );
});
