...
test( 'dsygs2: itype1_upper', function t() {
	...
	const A = makeAUpper();
	const B = makeBUpper();
	const info = dsygs2( 1, 'upper', 3, A, 1, 3, 0, B, 1, 3, 0 );
...
test( 'dsygs2: itype1_lower', function t() {
	...
	const A = makeALower();
	const B = makeBLower();
	const info = dsygs2( 1, 'lower', 3, A, 1, 3, 0, B, 1, 3, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( toArray( A ), tc.A, 1e-14, 'A' );
});
...
test( 'dsygs2: itype2_upper', function t() {
	...
	const A = makeAUpper();
	const B = makeBUpper();
	const info = dsygs2( 2, 'upper', 3, A, 1, 3, 0, B, 1, 3, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( toArray( A ), tc.A, 1e-14, 'A' );
});
...
test( 'dsygs2: itype2_lower', function t() {
	...
	const A = makeALower();
	const B = makeBLower();
	const info = dsygs2( 2, 'lower', 3, A, 1, 3, 0, B, 1, 3, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( toArray( A ), tc.A, 1e-14, 'A' );
});
...
test( 'dsygs2: itype3_upper', function t() {
	...
	const A = makeAUpper();
	const B = makeBUpper();
	const info = dsygs2( 3, 'upper', 3, A, 1, 3, 0, B, 1, 3, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( toArray( A ), tc.A, 1e-14, 'A' );
});
...
test( 'dsygs2: n_zero', function t() {
	...
	const info = dsygs2( 1, 'upper', 0, A, 1, 1, 0, B, 1, 1, 0 );
	assert.equal( info, tc.info );
});
...
test( 'dsygs2: n_one', function t() {
	...
	const info = dsygs2( 1, 'upper', 1, A, 1, 1, 0, B, 1, 1, 0 );
	assert.equal( info, tc.info );
