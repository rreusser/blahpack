...
import dspevx from './../lib/ndarray.js';

// FIXTURES //

import dspevx_4x4_v_a_l from './fixtures/dspevx_4x4_v_a_l.json' with { type: 'json' };
import dspevx_4x4_v_a_u from './fixtures/dspevx_4x4_v_a_u.json' with { type: 'json' };
import dspevx_4x4_n_a_l from './fixtures/dspevx_4x4_n_a_l.json' with { type: 'json' };
import dspevx_4x4_v_v_l from './fixtures/dspevx_4x4_v_v_l.json' with { type: 'json' };
import dspevx_4x4_v_i_l from './fixtures/dspevx_4x4_v_i_l.json' with { type: 'json' };
import dspevx_4x4_n_v_u from './fixtures/dspevx_4x4_n_v_u.json' with { type: 'json' };
import dspevx_1x1_v_a from './fixtures/dspevx_1x1_v_a.json' with { type: 'json' };
import dspevx_1x1_v_v_excluded from './fixtures/dspevx_1x1_v_v_excluded.json' with { type: 'json' };
import dspevx_1x1_v_v_included from './fixtures/dspevx_1x1_v_v_included.json' with { type: 'json' };
import dspevx_1x1_n_i from './fixtures/dspevx_1x1_n_i.json' with { type: 'json' };
import dspevx_4x4_n_i_u_fast from './fixtures/dspevx_4x4_n_i_u_fast.json' with { type: 'json' };
import dspevx_4x4_v_i_u_fast from './fixtures/dspevx_4x4_v_i_u_fast.json' with { type: 'json' };
...
function runDspevx( jobz, range, uplo, N, AP, vl, vu, il, iu, abstol ) {
	...
	const info = dspevx( jobz, range, uplo, N, AP, 1, 0, vl, vu, il, iu, abstol, out, w, 1, 0, Z, 1, N, 0, WORK, 1, 0, IWORK, 1, 0, IFAIL, 1, 0 ); // eslint-disable-line max-len
	return {
		'info': info,
		'M': out.M,
		'w': w,
...
test( 'dspevx: V, A, L, 4x4', function t() {
	...
	const tc = dspevx_4x4_v_a_l;
	const AP = packedLower4();
	const Afull = unpackLower( packedLower4(), 4 );
	const r = runDspevx( 'compute-vectors', 'all', 'lower', 4, AP, 0, 0, 0, 0, 0 );
...
test( 'dspevx: V, A, U, 4x4', function t() {
	...
	const tc = dspevx_4x4_v_a_u;
	const AP = packedUpper4();
	const Afull = unpackUpper( packedUpper4(), 4 );
	const r = runDspevx( 'compute-vectors', 'all', 'upper', 4, AP, 0, 0, 0, 0, 0 );
...
test( 'dspevx: N, A, L, 4x4', function t() {
	...
	const tc = dspevx_4x4_n_a_l;
	const AP = packedLower4();
	const r = runDspevx( 'no-vectors', 'all', 'lower', 4, AP, 0, 0, 0, 0, 0 );
...
test( 'dspevx: V, V, L, 4x4 (value range)', function t() {
	...
	const tc = dspevx_4x4_v_v_l;
	const AP = packedLower4();
	const Afull = unpackLower( packedLower4(), 4 );
	const r = runDspevx( 'compute-vectors', 'value', 'lower', 4, AP, 2.5, 5.5, 0, 0, 0 ); // eslint-disable-line max-len
...
test( 'dspevx: V, I, L, 4x4 (index range 2..3)', function t() {
	...
	const tc = dspevx_4x4_v_i_l;
	const AP = packedLower4();
	const Afull = unpackLower( packedLower4(), 4 );
	const r = runDspevx( 'compute-vectors', 'index', 'lower', 4, AP, 0, 0, 2, 3, 0 );
...
test( 'dspevx: N, V, U, 4x4 (value range)', function t() {
	...
	const tc = dspevx_4x4_n_v_u;
	const AP = packedUpper4();
	const r = runDspevx( 'no-vectors', 'value', 'upper', 4, AP, 0, 4, 0, 0, 0 );
...
test( 'dspevx: N=1, V, A', function t() {
	...
	const tc = dspevx_1x1_v_a;
	const AP = new Float64Array( [ 7.5 ] );
	const r = runDspevx( 'compute-vectors', 'all', 'lower', 1, AP, 0, 0, 0, 0, 0 );
...
test( 'dspevx: N=0', function t() {
	...
	const r = runDspevx( 'compute-vectors', 'all', 'lower', 0, AP, 0, 0, 0, 0, 0 );
...
test( 'dspevx: N=1, V, V, excluded', function t() {
	...
	const tc = dspevx_1x1_v_v_excluded;
	const AP = new Float64Array( [ 7.5 ] );
	const r = runDspevx( 'compute-vectors', 'value', 'lower', 1, AP, 0, 5, 0, 0, 0 );
...
test( 'dspevx: N=1, V, V, included', function t() {
	...
	const tc = dspevx_1x1_v_v_included;
	const AP = new Float64Array( [ 7.5 ] );
	const r = runDspevx( 'compute-vectors', 'value', 'lower', 1, AP, 5, 10, 0, 0, 0 );
...
test( 'dspevx: N=1, N, I', function t() {
	...
	const tc = dspevx_1x1_n_i;
	const AP = new Float64Array( [ 3.0 ] );
	const r = runDspevx( 'no-vectors', 'index', 'upper', 1, AP, 0, 0, 1, 1, 0 );
...
test( 'dspevx: N, I, U, fast path (il=1, iu=N)', function t() {
	...
	const tc = dspevx_4x4_n_i_u_fast;
	const AP = packedUpper4();
	const r = runDspevx( 'no-vectors', 'index', 'upper', 4, AP, 0, 0, 1, 4, 0 );
...
test( 'dspevx: V, I, U, fast path (il=1, iu=N)', function t() {
	...
	const tc = dspevx_4x4_v_i_u_fast;
	const AP = packedUpper4();
	const Afull = unpackUpper( packedUpper4(), 4 );
	const r = runDspevx( 'compute-vectors', 'index', 'upper', 4, AP, 0, 0, 1, 4, 0 );
...
test( 'dspevx: V, A, L, scaled (tiny matrix)', function t() {
	...
	const APbase = packedLower4();
	const AP = new Float64Array( APbase.length );
...
test( 'dspevx: V, V, L, scaled (value range)', function t() {
	...
	const r = runDspevx( 'compute-vectors', 'value', 'lower', 4, AP, 2.5*scale, 5.5*scale, 0, 0, 0 ); // eslint-disable-line max-len
