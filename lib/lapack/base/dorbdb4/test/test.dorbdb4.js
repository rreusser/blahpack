...
import dorbdb4 from './../lib/dorbdb4.js';
...
test( 'dorbdb4 (column-major): runs to completion on M=Q quick-return-like case', function t() {
	const a = args();
	const info = dorbdb4( 'column-major', 4, 2, 4, a.X11, 4, a.X21, 4, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.PHANTOM, 1, a.WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
});

test( 'dorbdb4 (row-major): runs to completion on M=Q quick-return-like case', function t() {
	const a = args();
	const info = dorbdb4( 'row-major', 4, 2, 4, a.X11, 4, a.X21, 4, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.PHANTOM, 1, a.WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
});
