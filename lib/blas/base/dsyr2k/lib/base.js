...
function tiled( upper, N, K, alpha, X, strideX1, strideX2, offsetX, Y, strideY1, strideY2, offsetY, C, strideC1, strideC2, offsetC ) {
	...
	let c32, c33, px0, px1, px2, px3, py0, py1, py2, py3, pcc, pxk, pyk, a0, a1;
	let a2, a3, b0, b1, b2, b3, pc, jj, ii, px, py, tt, i, j, l;
	...
	const nb = N - ( N % 4 ); // last full 4-column block boundary
	if ( upper ) {
		for ( j = 0; j < nb; j += 4 ) {
			py0 = offsetY + ( j * yr );
			py1 = py0 + yr;
...
function dsyr2k( uplo, trans, N, K, alpha, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, beta, C, strideC1, strideC2, offsetC ) {
	...
	const ar = ( nota ) ? strideA1 : strideA2;
	const ak = ( nota ) ? strideA2 : strideA1;
	const br = ( nota ) ? strideB1 : strideB2;
	const bk = ( nota ) ? strideB2 : strideB1;
