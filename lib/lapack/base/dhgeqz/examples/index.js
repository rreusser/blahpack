...
const H = new Float64Array( [ 2.0, 3.0, 1.5, 4.0 ] );
const T = new Float64Array( [ 1.0, 0.5, 0.0, 2.0 ] );
...
const info = dhgeqz.ndarray( 'eigenvalues', 'none', 'none', 2, 0, 1, H, 2, 1, 0, T, 2, 1, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 2, 1, 0, Z, 2, 1, 0, WORK, 1, 0, 2);
