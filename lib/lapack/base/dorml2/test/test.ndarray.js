...
import dorml2 from './../lib/ndarray.js';
...
function identity5( LDC ) {
	const C = new Float64Array( LDC * 6 );
	let i;
	for ( i = 0; i < 5; i++ ) {
		C[ i + i * LDC ] = 1.0;
	}
...
test( 'dorml2: left_notrans_5x5', function t() {
	...
	const lq = computeLQ();
	const LDC = 6;
	const C = identity5( LDC );
	const info = dorml2( 'left', 'no-transpose', 5, 5, 3, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'dorml2: left_trans_5x5', function t() {
	...
	const LDC = 6;
	const C = identity5( LDC );
	const info = dorml2( 'left', 'transpose', 5, 5, 3, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assertArrayClose( extractC( C, 5, 5, LDC, tc.c.length ), tc.c, 1e-14, 'c' );
});
...
test( 'dorml2: right_notrans_5x5', function t() {
	...
	const LDC = 6;
	const C = identity5( LDC );
	const info = dorml2( 'right', 'no-transpose', 5, 5, 3, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assertArrayClose( extractC( C, 5, 5, LDC, tc.c.length ), tc.c, 1e-14, 'c' );
});
...
test( 'dorml2: right_trans_5x5', function t() {
	...
	const LDC = 6;
	const C = identity5( LDC );
	const info = dorml2( 'right', 'transpose', 5, 5, 3, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assertArrayClose( extractC( C, 5, 5, LDC, tc.c.length ), tc.c, 1e-14, 'c' );
});
...
test( 'dorml2: m_zero', function t() {
	...
	const info = dorml2( 'left', 'no-transpose', 0, 5, 0, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
});
...
test( 'dorml2: n_zero', function t() {
	...
	const lq = computeLQ();
	const C = new Float64Array( 36 );
	const info = dorml2( 'left', 'no-transpose', 5, 0, 0, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
});
...
test( 'dorml2: k_zero', function t() {
	...
	const lq = computeLQ();
	const C = new Float64Array( 36 );
	const info = dorml2( 'left', 'no-transpose', 5, 5, 0, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
});
...
test( 'dorml2: right_trans_rect', function t() {
	...
	C[ 25 ] = 1.0;
	C[ 26 ] = 2.0;
	const info = dorml2( 'right', 'transpose', 3, 5, 3, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
...
test( 'dorml2: left_notrans_rect', function t() {
	...
	C[ 15 ] = 3.0;
	C[ 16 ] = -1.0;
	const info = dorml2( 'left', 'no-transpose', 5, 3, 3, lq.A, 1, 6, 0, lq.TAU, 1, 0, C, 1, LDC, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
