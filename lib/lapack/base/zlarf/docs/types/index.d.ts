...
interface Routine {
	...
	* @returns result
	*/
	( order: Layout, side: OperationSide, M: number, N: number, v: Float64Array, strideV: number, tau: number, offsetTau: number, C: Float64Array, LDC: number, WORK: Float64Array, strideWork: number ): void;
	...
	* @returns result
	*/
	ndarray( side: OperationSide, M: number, N: number, v: Float64Array, strideV: number, offsetV: number, tau: number, offsetTau: number, C: Float64Array, strideC1: number, strideC2: number, offsetC: number, WORK: Float64Array, strideWork: number, offsetWork: number ): void;
}
