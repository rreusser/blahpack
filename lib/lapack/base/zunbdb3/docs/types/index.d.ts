...
interface Routine {
	...
	*/
	...
	/**
	* Simultaneously bidiagonalizes the blocks of a tall and skinny complex matrix `[X11; X21]` with orthonormal columns (variant 3 — `M-P` is the minimum dimension) using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param P - `P`
	* @param Q - `Q`
