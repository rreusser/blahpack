...
import zgesc2 from '../../zgesc2/lib/base.js';
import zlatdf from '../../zlatdf/lib/base.js';
...
function ztgsy2( trans, ijob, M, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, C, strideC1, strideC2, offsetC, D, strideD1, strideD2, offsetD, E, strideE1, strideE2, offsetE, F, strideF1, strideF2, offsetF, scale, rdsum, rdscal ) {
	let scaloc, alpha, ierr, info, res, ic, jf, i, j, k;
	...
	const Z = new Complex128Array( LDZ * LDZ );
	const RHS = new Complex128Array( LDZ );
	const IPIV = new Int32Array( LDZ );
	const JPIV = new Int32Array( LDZ );
	...
	const sd1 = strideD1 * 2;
	const sd2 = strideD2 * 2;
	const se1 = strideE1 * 2;
	const se2 = strideE2 * 2;
	const sf1 = strideF1 * 2;
	const sf2 = strideF2 * 2;
	const oA = offsetA * 2;
	const oB = offsetB * 2;
	const oC = offsetC * 2;
	const oD = offsetD * 2;
