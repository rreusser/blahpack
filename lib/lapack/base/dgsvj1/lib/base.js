...
*/
function dgsvj1( jobv, M, N, n1, A, strideA1, strideA2, offsetA, d, strideD, offsetD, sva, strideSVA, offsetSVA, mv, V, strideV1, strideV2, offsetV, eps, sfmin, tol, nsweep, work, strideWork, offsetWork ) { // eslint-disable-line max-len
	let convergedSweep, pskipped, bailjbc, notrot, mxaapq, mxsinj, iswrot;
	let thsign, ijblsk, swband, apoaq, aqoap, aapp0, rotok, rsvec, theta, temp1;
	let aapp, aaqq, aapq, info, nblc, nblr, mvl, ibr, jbc, igl, jgl, ap0, aq0;
	let vp0, vq0, dp0, dq0, res, cs, sn, p, q, t, i;
