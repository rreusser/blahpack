...
test( 'dlaqz4 returns 0 for quick return cases (nshifts < 2)', function t() {
	const info = dlaqz4( 'column-major', true, true, true, 4, 0, 3, 0, 4, new Float64Array( 4 ), 1, new Float64Array( 4 ), 1, new Float64Array( 4 ), 1, new Float64Array( 16 ), 4, new Float64Array( 16 ), 4, new Float64Array( 16 ), 4, new Float64Array( 16 ), 4, new Float64Array( 16 ), 4, new Float64Array( 16 ), 4, new Float64Array( 16 ), 1 );
...
test( 'dlaqz4 column-major matches expected sweep on the smallest fixture', function t() {
	...
	const info = dlaqz4( 'column-major', true, true, true, N, 0, N - 1, 2, 4, new Float64Array( [ 1.5, 1.5 ] ), 1, new Float64Array( [ 0.3, -0.3 ] ), 1, new Float64Array( [ 1.0, 1.0 ] ), 1, A, NMAX, B, NMAX, Q, NMAX, Z, NMAX, QC, NMAX, ZC, NMAX, WORK, 1 );
