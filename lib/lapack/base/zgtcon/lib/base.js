...
function zgtcon( norm, N, DL, strideDL, offsetDL, d, strideD, offsetD, DU, strideDU, offsetDU, DU2, strideDU2, offsetDU2, IPIV, strideIPIV, offsetIPIV, anorm, rcond, WORK, strideWork, offsetWork ) {
	...
	while ( true ) {
		...
		if ( KASE[ 0 ] === kase1 ) {
			...
			zgttrs( 'no-transpose', N, 1, DL, strideDL, offsetDL, d, strideD, offsetD, DU, strideDU, offsetDU, DU2, strideDU2, offsetDU2, IPIV, strideIPIV, offsetIPIV, WORK, sw, N * sw, offsetWork );
		} else {
			// Multiply by inv(A^H): solve A^H*x = b (conjugate transpose)
			zgttrs( 'conjugate-transpose', N, 1, DL, strideDL, offsetDL, d, strideD, offsetD, DU, strideDU, offsetDU, DU2, strideDU2, offsetDU2, IPIV, strideIPIV, offsetIPIV, WORK, sw, N * sw, offsetWork );
		}
	}
