...
*/
function dormhr( side, trans, M, N, ilo, ihi, A, LDA, TAU, strideTAU, C, LDC, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	let minWork, nb, nh, nw;
	...
	if ( WORK === null || WORK === void 0 ) {
		// Auto-allocate WORK sized for the BLOCKED dormqr delegate (K = nh =
		...
		minWork = ( nb >= nh ) ? nw : ( ( nw * nb ) + ( ( nb + 1 ) * nb ) );
