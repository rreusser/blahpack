...
*/
function dsyevr( jobz, range, uplo, N, A, LDA, vl, vu, il, iu, abstol, out, w, strideW, Z, LDZ, ISUPPZ, strideISUPPZ, WORK, strideWork, IWORK, strideIWork ) { // eslint-disable-line max-len, max-params
	...
	return base( jobz, range, uplo, N, A, sa1, sa2, 0, vl, vu, il, iu, abstol, out, w, strideW, ow, Z, sz1, sz2, 0, ISUPPZ, strideISUPPZ, oisuppz, WORK, strideWork, owork, IWORK, strideIWork, oiwork ); // eslint-disable-line max-len
}
