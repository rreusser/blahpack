...
import zsyconv from './../../../../lapack/base/zsyconv/lib/base.js';
import zsyswapr from './../../../../lapack/base/zsyswapr/lib/base.js';
import ztrtri from './../../../../lapack/base/ztrtri/lib/base.js';
...
function zsytri2x( uplo, N, A, strideA1, strideA2, offsetA, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, offsetWork, nb ) {
	let u01ip1jR, u01ip1jI, u11ip1jR, u11ip1jI, invd00R, invd00I, invd01R;
	let invd01I, invd10R, invd10I, invd11R, invd11I, akkp1R, akkp1I, u01ijR;
	let u01ijI, u11ijR, u11ijI, icount, akp1R, akp1I, akR, akI, nnb, raw, cut;
	let cr, ci, tR, tI, dR, dI, ip, ia, iw, i, j, k;
	...
	const sa1F = strideA1 * 2;
	const sa2F = strideA2 * 2;
	const sWF = strideWork * 2;

	const ldwork = N + nb + 1;
	const ldwF = ldwork * strideWork * 2;
