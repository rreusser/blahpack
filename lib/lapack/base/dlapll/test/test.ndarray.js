...
test( 'base: orthogonal vectors (ssmin = 1)', function t() {
	const ssmin = new Float64Array( 1 );
	const tc = orthogonal;
	const x = new Float64Array( [ 1.0, 0.0, 0.0 ] );
	const y = new Float64Array( [ 0.0, 1.0, 0.0 ] );
...
test( 'base: nearly parallel vectors', function t() {
	...
	const y = new Float64Array( [ 1.0, 2.0, 3.0, 4.0, 5.001 ] );
...
test( 'base: non-unit stride', function t() {
	...
	const ssmin = new Float64Array( 1 );
	const xRef = new Float64Array( [ 1.0, 2.0, 3.0 ] );
	const yRef = new Float64Array( [ 4.0, 5.0, 6.0 ] );
	const x = new Float64Array( [ 1.0, 99.0, 2.0, 99.0, 3.0 ] );
	const y = new Float64Array( [ 4.0, 99.0, 5.0, 99.0, 6.0 ] );
...
test( 'base: offset', function t() {
	...
	const xRef = new Float64Array( [ 1.0, 2.0, 3.0 ] );
	const yRef = new Float64Array( [ 4.0, 5.0, 6.0 ] );
	const x = new Float64Array( [ 99.0, 1.0, 2.0, 3.0 ] );
	const y = new Float64Array( [ 99.0, 4.0, 5.0, 6.0 ] );
...
test( 'base: identical vectors (ssmin ~ 0)', function t() {
	...
	const y = new Float64Array( [ 1.0, 1.0, 1.0, 1.0 ] );
...
test( 'base: negative values', function t() {
	const ssmin = new Float64Array( 1 );
	const x = new Float64Array( [ -1.0, -2.0, -3.0 ] );
	const y = new Float64Array( [ 3.0, 2.0, 1.0 ] );
