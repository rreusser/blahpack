...
*/
function dtgexc( order, wantq, wantz, N, A, LDA, B, LDB, Q, LDQ, Z, LDZ, ifst, ilst, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	...
	if ( WORK === null || WORK === void 0 ) {
		WORK = new Float64Array( max( 1, ( 4 * N ) + 16 ) );
		strideWork = 1;
	}
	return base( wantq, wantz, N, A, sa1, sa2, 0, B, sb1, sb2, 0, Q, sq1, sq2, 0, Z, sz1, sz2, 0, ifst, ilst, WORK, strideWork, 0 ); // eslint-disable-line max-len
}
