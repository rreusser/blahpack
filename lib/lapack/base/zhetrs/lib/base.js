...
/**
* Solve a system of linear equations A_X = B with a complex Hermitian matrix.
_ using the factorization A = U_D_U__H or A = L_D*L**H computed by zhetrf.
*
...
function zhetrs( uplo, N, nrhs, A, strideA1, strideA2, offsetA, IPIV, strideIPIV, offsetIPIV, B, strideB1, strideB2, offsetB ) {
	...
	let bkR, bkI, kp, tr, ti, p1, p2, s, k, j;
