...
import zgebd2 from '../../zgebd2/lib/base.js';
import zgemm from '../../../../blas/base/zgemm/lib/base.js';
import zlabrd from '../../zlabrd/lib/base.js';
...
*/
function zgebrd( M, N, A, strideA1, strideA2, offsetA, d, strideD, offsetD, e, strideE, offsetE, TAUQ, strideTAUQ, offsetTAUQ, TAUP, strideTAUP, offsetTAUP, WORK, strideWork, offsetWork ) {
	var ldwrkx;
	var ldwrky;
	var lwork;
	var minmn;
	...
	// Caller owns the workspace; derive the effective LWORK (in complex
	// elements) from the provided WORK array so the block-size decision matches
