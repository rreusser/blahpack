...
*/
function zgeev( jobvl, jobvr, N, A, LDA, w, strideW, VL, LDVL, VR, LDVR, WORK, strideWork, RWORK, strideRWork ) { // eslint-disable-line max-len, max-params
	var orwork;
	var owork;
	var svl1;
	var svl2;
	...
	return base( jobvl, jobvr, N, A, sa1, sa2, 0, w, strideW, ow, VL, svl1, svl2, 0, VR, svr1, svr2, 0, WORK, strideWork, owork, RWORK, strideRWork, orwork ); // eslint-disable-line max-len
}
