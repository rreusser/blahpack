...
function dgelss( M, N, nrhs, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, S, strideS, offsetS, rcond, rank, WORK, strideWork, offsetWork ) {
	...
	const minWork = Math.max( 1, 3 * minMN + Math.max( 2 * minMN, Math.max( M, N ), nrhs ), 5 * minMN );
	...
	return base( M, N, nrhs, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, S, strideS, offsetS, rcond, rank, WORK, strideWork, offsetWork );
}
