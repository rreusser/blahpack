...
interface Routine {
	...
	* @returns result
	*/
	ndarray( transr: string, uplo: MatrixTriangle, N: number, ARF: Float64Array, strideARF: number, offsetARF: number, A: Float64Array, strideA1: number, strideA2: number, offsetA: number ): number;
}
