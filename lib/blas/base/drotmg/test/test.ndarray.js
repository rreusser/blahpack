...
test( 'drotmg: basic case |q1| > |q2| (flag=0)', function t() {
	...
	const tc = basic_q1_gt_q2;
	const D = new Float64Array( [ 2.0, 1.0 ] );
	const x = new Float64Array( [ 3.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: dd1 < 0 (error case, zeros everything)', function t() {
	...
	const tc = dd1_negative;
	const D = new Float64Array( [ -1.0, 1.0 ] );
	const x = new Float64Array( [ 1.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: dd2 = 0 (p2 = 0, quick return, flag=-2)', function t() {
	...
	const tc = dd2_zero;
	const D = new Float64Array( [ 1.0, 0.0 ] );
	const x = new Float64Array( [ 1.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: rescaling (very small dd1)', function t() {
	...
	const tc = rescale_small;
	const D = new Float64Array( [ 1.0e-10, 1.0 ] );
	const x = new Float64Array( [ 1.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: rescaling (very large dd1)', function t() {
	...
	const tc = rescale_large;
	const D = new Float64Array( [ 1.0e10, 1.0 ] );
	const x = new Float64Array( [ 1.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: dd1 = 0 (degenerate, q1 = 0)', function t() {
	...
	const tc = dd1_zero;
	const D = new Float64Array( [ 0.0, 3.0 ] );
...
test( 'drotmg: rescaling dd2 very small', function t() {
	...
	const tc = rescale_dd2_small;
	const D = new Float64Array( [ 1.0, 1.0e-10 ] );
	const x = new Float64Array( [ 1.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: rescaling dd2 very large', function t() {
	...
	const tc = rescale_dd2_large;
	const D = new Float64Array( [ 1.0, 1.0e10 ] );
	const x = new Float64Array( [ 1.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: supports non-unit strides for D', function t() {
	...
	const D = new Float64Array( [ 2.0, 99.0, 1.0 ] );
	const x = new Float64Array( [ 3.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: supports offsets for D and x1', function t() {
	...
	const D = new Float64Array( [ 99.0, 2.0, 1.0 ] );
	const x = new Float64Array( [ 99.0, 3.0 ] );
	const dparam = new Float64Array( 5 );
...
test( 'drotmg: supports non-unit stride for param', function t() {
	...
	const D = new Float64Array( [ 2.0, 1.0 ] );
	const x = new Float64Array( [ 3.0 ] );
	const dparam = new Float64Array( 9 ); // 5 elements with stride 2
