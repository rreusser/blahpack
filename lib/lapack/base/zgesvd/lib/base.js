...
function zgesvd( jobu, jobvt, M, N, A, strideA1, strideA2, offsetA, s, strideS, offsetS, U, strideU1, strideU2, offsetU, VT, strideVT1, strideVT2, offsetVT, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork ) {
	...
	if ( M >= N ) {
		...
		if ( wntun && M >= 2 * N ) {
			...
			zgebrd(N, N, A, sa1, sa2, offsetA, s, strideS, offsetS, RWORK, strideRWork, offsetRWork + ie, WORK, 1, itauq, WORK, 1, itaup, WORK, 1, iwork, wsz - iwork);
			...
			zgebrd(M, N, A, sa1, sa2, offsetA, s, strideS, offsetS, RWORK, strideRWork, offsetRWork + ie, WORK, 1, itauq, WORK, 1, itaup, WORK, 1, iwork, wsz - iwork);
