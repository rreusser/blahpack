...
import zungtr from '../../zungtr/lib/base.js';
...
*/
function zheevx( jobz, range, uplo, N, A, strideA1, strideA2, offsetA, vl, vu, il, iu, abstol, out, w, strideW, offsetW, Z, strideZ1, strideZ2, offsetZ, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork, IWORK, strideIWork, offsetIWork, IFAIL, strideIFAIL, offsetIFAIL ) {
	let iscale, abstll, sigma, info, imax, Av, oA;

	// Workspace partitions
	let indee;

	// Dstebz outputs
	let Mout, nsplit, indibl, indisp, indiwk, order;
	...
	const indwrk = offsetWork + ( N * strideWork );

	// Caller owns the workspace; derive the usable complex WORK length from the
