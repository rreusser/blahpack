...
import ztplqt2 from './../lib/ztplqt2.js';
...
test( 'ztplqt2 column-major happy path', function t() {
	const A = new Complex128Array( [ 2.0, 0.1, 0.5, -0.2, 0.0, 0.0, 3.0, 0.3 ] );
	const B = new Complex128Array( [ 1.0, 0.4, 0.3, -0.1, 0.5, 0.2, 1.1, 0.3 ] );
	const T = new Complex128Array( 4 );
	const info = ztplqt2( 'column-major', 2, 2, 0, A, 2, B, 2, T, 2 );
