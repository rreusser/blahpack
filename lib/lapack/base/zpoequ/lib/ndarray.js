...
* of B = S_A_S within a factor N of the smallest possible condition number.
*
...
*/
function zpoequ( N, A, strideA1, strideA2, offsetA, s, strideS, offsetS ) { // eslint-disable-line max-len, max-params
	if ( N < 0 ) {
		throw new RangeError( format( 'invalid argument. First argument must be a nonnegative integer. Value: `%d`.', N ) );
	}
	return base( N, A, strideA1, strideA2, offsetA, s, strideS, offsetS ); // eslint-disable-line max-len
}
