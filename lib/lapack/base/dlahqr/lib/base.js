...
function dlahqr( wantt, wantz, N, ilo, ihi, H, strideH1, strideH2, offsetH, WR, strideWR, offsetWR, WI, strideWI, offsetWI, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ ) {
	let rtdisc, kdefl, lanv2, info, h21s, rt1r, rt1i, rt2r, rt2i, h11, h12, h21;
	let h22, sum, tst, det, its, aa, ab, ba, bb, cs, sn, nr, tr, t1, t2, t3, v2;
	let v3, i1, i2, s, i, j, k, l, m;
	...
	while ( i >= ilo ) {
		...
		let converged = false; // eslint-disable-line no-var
