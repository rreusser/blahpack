...
test( 'zgees has expected arity', function t() {
	assert.strictEqual( zgees.length, 17, 'has expected arity' );
});

test( 'zgees throws RangeError for negative N', function t() {
	assert.throws( function throws() {
		zgees( 2, 2, 2, -1, new Float64Array( 4 ), 2, 2, new Float64Array( 4 ), 1, new Float64Array( 4 ), 2, new Float64Array( 4 ), 1, new Float64Array( 4 ), 1, new Float64Array( 4 ), 1 );
	}, RangeError );
});
