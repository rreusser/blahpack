...
function dposvx( fact, uplo, N, nrhs, A, LDA, AF, LDAF, equed, s, strideS, B, LDB, X, LDX, FERR, strideFERR, BERR, strideBERR, WORK, strideWork, IWORK, strideIWork ) { // eslint-disable-line max-len, max-params
	...
	return base( fact, uplo, N, nrhs, A, sa1, sa2, 0, AF, saf1, saf2, 0, equed, s, strideS, os, B, sb1, sb2, 0, X, sx1, sx2, 0, rcond, FERR, strideFERR, oferr, BERR, strideBERR, oberr, WORK, strideWork, owork, IWORK, strideIWork, oiwork ); // eslint-disable-line max-len
}
