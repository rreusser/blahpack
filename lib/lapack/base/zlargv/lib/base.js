...
const SAFMN2 = 1.4916681462400413e-154;
...
function zlargv( N, x, strideX, offsetX, y, strideY, offsetY, c, strideC, offsetC ) { // eslint-disable-line max-len, max-params
	let f2srt, count, scale, fsr, fsi, gsr, gsi, ffr, ffi, tsr, tsi, tdr, tdi;
	let f2s, g2s, cs, di, dr, f2, g2, ic, ix, iy, fr, fi, gr, gi, rr, ri, sr;
	let si, d, i, j;
