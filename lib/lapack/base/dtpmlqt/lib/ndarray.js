...
function dtpmlqt( side, trans, M, N, K, l, mb, V, strideV1, strideV2, offsetV, T, strideT1, strideT2, offsetT, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, WORK, strideWork, offsetWork ) {
	...
	// from an out-of-bounds read. WORK is a logical mb-by-N block (N*mb doubles)
	// for side='left' or M-by-mb (M*mb doubles) for side='right'. M/N/K === 0 is
	// a quick return that uses no workspace.
	if ( M > 0 && N > 0 && K > 0 ) {
		need = ( side === 'left' ) ? ( N * mb ) : ( M * mb );
