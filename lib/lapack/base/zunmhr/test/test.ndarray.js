...
test( 'zunmhr: left, no-transpose (Q * I)', function t() {
	...
	var info = zunmhr( 'left', 'no-transpose', 5, 5, 1, 5, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
...
test( 'zunmhr: left, conjugate-transpose (Q^H * I)', function t() {
	...
	var Cv = reinterpret( C, 0 );
	var WORK = new Complex128Array( 1000 );
	var info = zunmhr( 'left', 'conjugate-transpose', 5, 5, 1, 5, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assertArrayClose( extractColMajor( Cv, 6, 5, 5 ), extractColMajor( tc.c, 6, 5, 5 ), 1e-10, 'c' );
});
...
test( 'zunmhr: right, no-transpose (I * Q)', function t() {
	...
	var Cv = reinterpret( C, 0 );
	var WORK = new Complex128Array( 1000 );
	var info = zunmhr( 'right', 'no-transpose', 5, 5, 1, 5, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assertArrayClose( extractColMajor( Cv, 6, 5, 5 ), extractColMajor( tc.c, 6, 5, 5 ), 1e-10, 'c' );
});
...
test( 'zunmhr: right, conjugate-transpose (I * Q^H)', function t() {
	...
	var Cv = reinterpret( C, 0 );
	var WORK = new Complex128Array( 1000 );
	var info = zunmhr( 'right', 'conjugate-transpose', 5, 5, 1, 5, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assertArrayClose( extractColMajor( Cv, 6, 5, 5 ), extractColMajor( tc.c, 6, 5, 5 ), 1e-10, 'c' );
});
...
test( 'zunmhr: left, no-transpose, rectangular C (5x3)', function t() {
	...
	var WORK = new Complex128Array( 1000 );
	var info = zunmhr( 'left', 'no-transpose', 5, 3, 1, 5, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
...
test( 'zunmhr: right, conjugate-transpose, rectangular C (3x5)', function t() {
	...
	var WORK = new Complex128Array( 1000 );
	var info = zunmhr( 'right', 'conjugate-transpose', 3, 5, 1, 5, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
...
test( 'zunmhr: M=0 quick return', function t() {
	...
	var info = zunmhr( 'left', 'no-transpose', 0, 5, 1, 0, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
});
...
test( 'zunmhr: N=0 quick return', function t() {
	...
	var C = new Complex128Array( 1 );
	var WORK = new Complex128Array( 10 );
	var info = zunmhr( 'left', 'no-transpose', 5, 0, 1, 5, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
});
...
test( 'zunmhr: NH=0 quick return (ILO=IHI)', function t() {
	...
	var WORK = new Complex128Array( 10 );
	var info = zunmhr( 'left', 'no-transpose', 5, 5, 3, 3, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
...
test( 'zunmhr: left, no-transpose, partial (ILO=2, IHI=4)', function t() {
	...
	var Cv = reinterpret( C, 0 );
	var WORK = new Complex128Array( 1000 );
	var info = zunmhr( 'left', 'no-transpose', 5, 5, 2, 4, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assertArrayClose( extractColMajor( Cv, 6, 5, 5 ), extractColMajor( tc.c, 6, 5, 5 ), 1e-10, 'c' );
});
...
test( 'zunmhr: right, conjugate-transpose, partial (ILO=2, IHI=4)', function t() {
	...
	var Cv = reinterpret( C, 0 );
	var WORK = new Complex128Array( 1000 );
	var info = zunmhr( 'right', 'conjugate-transpose', 5, 5, 2, 4, A, 1, 6, 0, TAU, 1, 0, C, 1, 6, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'info' );
	assertArrayClose( extractColMajor( Cv, 6, 5, 5 ), extractColMajor( tc.c, 6, 5, 5 ), 1e-10, 'c' );
});
