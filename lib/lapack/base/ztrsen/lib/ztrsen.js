...
*/
function ztrsen( job, compq, SELECT, strideSELECT, N, T, LDT, Q, LDQ, W, strideW, M, s, sep, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	var oselect;
	var owork;
	var sq1;
	var sq2;
	...
	return base( job, compq, SELECT, strideSELECT, oselect, N, T, st1, st2, 0, Q, sq1, sq2, 0, W, strideW, ow, M, s, sep, WORK, strideWork, owork ); // eslint-disable-line max-len
}
