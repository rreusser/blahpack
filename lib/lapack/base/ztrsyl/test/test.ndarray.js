...
import ztrsyl from './../lib/ndarray.js';
...
import cn_basic from './fixtures/cn_basic.json' with { type: 'json' };
import nc_basic from './fixtures/nc_basic.json' with { type: 'json' };
import cc_basic from './fixtures/cc_basic.json' with { type: 'json' };
...
import nn_3x3 from './fixtures/nn_3x3.json' with { type: 'json' };
import cn_3x3 from './fixtures/cn_3x3.json' with { type: 'json' };
import cc_isgn__1_3x3 from './fixtures/cc_isgn_-1_3x3.json' with { type: 'json' };
...
test( 'ztrsyl: NN basic 2x2', function t() {
	...
	const info = ztrsyl( 'no-transpose', 'no-transpose', 1, m.N, m.N, m.A, 1, m.N, 0, m.B, 1, m.N, 0, m.C, 1, m.N, 0, scale );
...
test( 'ztrsyl: CN basic (conjugate transpose A)', function t() {
	...
	const info = ztrsyl( 'conjugate-transpose', 'no-transpose', 1, m.N, m.N, m.A, 1, m.N, 0, m.B, 1, m.N, 0, m.C, 1, m.N, 0, scale );
...
test( 'ztrsyl: NC basic (conjugate transpose B)', function t() {
	...
	const info = ztrsyl( 'no-transpose', 'conjugate-transpose', 1, m.N, m.N, m.A, 1, m.N, 0, m.B, 1, m.N, 0, m.C, 1, m.N, 0, scale );
...
test( 'ztrsyl: CC basic (conjugate transpose both)', function t() {
	...
	const info = ztrsyl( 'conjugate-transpose', 'conjugate-transpose', 1, m.N, m.N, m.A, 1, m.N, 0, m.B, 1, m.N, 0, m.C, 1, m.N, 0, scale );
...
test( 'ztrsyl: M=0 quick return', function t() {
	...
	const info = ztrsyl( 'no-transpose', 'no-transpose', 1, 0, 2, A, 1, 2, 0, B, 1, 2, 0, C, 1, 2, 0, scale );
...
test( 'ztrsyl: N=0 quick return', function t() {
	...
	const info = ztrsyl( 'no-transpose', 'no-transpose', 1, 2, 0, A, 1, 2, 0, B, 1, 2, 0, C, 1, 2, 0, scale );
...
test( 'ztrsyl: M=1 N=1', function t() {
	...
	const info = ztrsyl( 'no-transpose', 'no-transpose', 1, 1, 1, A, 1, 1, 0, B, 1, 1, 0, C, 1, 1, 0, scale );
...
test( 'ztrsyl: NN scaloc - overflow protection scaling', function t() {
	...
	const A = new Complex128Array( [ 0, 0, 0, 0, 1, 0, 5, 0 ] );
	const B = new Complex128Array( [ 0, 0, 0, 0, 1, 0, 5, 0 ] );
	const C = new Complex128Array( [ 2e276, 2e276, 1, 0, 0, 0, 1, 0 ] );
	const scale = new Float64Array( 1 );
	const info = ztrsyl( 'no-transpose', 'no-transpose', 1, 2, 2, A, 1, 2, 0, B, 1, 2, 0, C, 1, 2, 0, scale );
	assert.strictEqual( info, 1, 'info should be 1 (perturbed)' );
});
...
test( 'ztrsyl: CN scaloc - overflow protection with conj transpose A', function t() {
	...
	const C = new Complex128Array( [ 2e276, 2e276, 1, 0, 0, 0, 1, 0 ] );
	const scale = new Float64Array( 1 );
	const info = ztrsyl( 'conjugate-transpose', 'no-transpose', 1, 2, 2, A, 1, 2, 0, B, 1, 2, 0, C, 1, 2, 0, scale );
	assert.strictEqual( info, 1, 'info should be 1 (perturbed)' );
});
...
test( 'ztrsyl: CC scaloc - overflow protection with conj transpose both', function t() {
	...
	const C = new Complex128Array( [ 2e276, 2e276, 1, 0, 0, 0, 1, 0 ] );
	const scale = new Float64Array( 1 );
	const info = ztrsyl( 'conjugate-transpose', 'conjugate-transpose', 1, 2, 2, A, 1, 2, 0, B, 1, 2, 0, C, 1, 2, 0, scale );
	assert.strictEqual( info, 1, 'info should be 1 (perturbed)' );
});
...
test( 'ztrsyl: NC scaloc - overflow protection with conj transpose B', function t() {
	...
	const C = new Complex128Array( [ 2e276, 2e276, 1, 0, 0, 0, 1, 0 ] );
	const scale = new Float64Array( 1 );
	const info = ztrsyl( 'no-transpose', 'conjugate-transpose', 1, 2, 2, A, 1, 2, 0, B, 1, 2, 0, C, 1, 2, 0, scale );
	assert.strictEqual( info, 1, 'info should be 1 (perturbed)' );
});
