...
*/
function dlarrf( N, d, strideD, l, strideL, ld, strideLD, clstrt, clend, w, strideW, wgap, strideWGAP, werr, strideWERR, spdiam, clgapl, clgapr, pivmin, sigma, dplus, strideDPLUS, lplus, strideLPLUS, work ) {
	if ( N < 0 ) {
	...
	return base( N, d, strideD, od, l, strideL, ol, ld, strideLD, oLD, clstrt, clend, w, strideW, ow, wgap, strideWGAP, oWGAP, werr, strideWERR, oWERR, spdiam, clgapl, clgapr, pivmin, sigma, dplus, strideDPLUS, oDPLUS, lplus, strideLPLUS, oLPLUS, work, 1, 0 );
}
