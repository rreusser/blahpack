...
function zlarfb_gett( order, ident, M, N, K, T, LDT, A, LDA, B, LDB, WORK, LDWORK ) { // eslint-disable-line max-len, max-params
	let swork1, swork2, st1, st2, sa1, sa2, sb1, sb2;
	...
	if ( WORK === null || WORK === void 0 ) {
		// WORK is a K-by-max(K,N-K) matrix stored with leading dimension
		// LDWORK; allocate LDWORK*max(K,N-K) complex elements (>= what base
		// indexes for either layout).
		WORK = new Complex128Array( LDWORK * max( 1, max( K, N - K ) ) );
	}
