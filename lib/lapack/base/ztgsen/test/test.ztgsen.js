...
test( 'ztgsen: column-major, ijob=0, select=[T,T,T] N=3', function t() {
	...
	const r = ztgsen( 'column-major', 0, true, true, SEL, 1, 3, ab.A, 3, ab.B, 3, ALPHA, 1, BETA, 1, Q, 3, Z, 3, 0, 1.0, 1.0, DIF, 1, WK, 1, -1, IWK, 1, 0, -1 );
...
test( 'ztgsen: row-major, ijob=0, select=[T,T,T] N=3', function t() {
	...
	const WK = new Complex128Array( 64 );
	const IWK = new Int32Array( 64 );
	const r = ztgsen( 'row-major', 0, true, true, SEL, 1, 3, ab.A, 3, ab.B, 3, ALPHA, 1, BETA, 1, Q, 3, Z, 3, 0, 1.0, 1.0, DIF, 1, WK, 1, -1, IWK, 1, 0, -1 );
	assert.equal( r.info, 0, 'info' );
	assert.equal( r.m, 3, 'M' );
});
...
test( 'ztgsen: row-major partial select, ijob=1', function t() {
	...
	const WK = new Complex128Array( 64 );
	const IWK = new Int32Array( 64 );
	const r = ztgsen( 'row-major', 1, true, true, SEL, 1, 3, ab.A, 3, ab.B, 3, ALPHA, 1, BETA, 1, Q, 3, Z, 3, 0, 1.0, 1.0, DIF, 1, WK, 1, -1, IWK, 1, 0, -1 );
	assert.equal( r.info, 0, 'info' );
...
test( 'ztgsen: wantq=false, wantz=false, ijob=0', function t() {
	...
	const WK = new Complex128Array( 64 );
	const IWK = new Int32Array( 64 );
	const r = ztgsen( 'column-major', 0, false, false, SEL, 1, 3, ab.A, 3, ab.B, 3, ALPHA, 1, BETA, 1, Q, 1, Z, 1, 0, 1.0, 1.0, DIF, 1, WK, 1, -1, IWK, 1, 0, -1 );
	assert.equal( r.info, 0, 'info' );
});
