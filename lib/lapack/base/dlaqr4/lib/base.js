...
import dlaqr2 from '../../dlaqr2/lib/base.js';
...
*/
function dlaqr4( wantt, wantz, N, ilo, ihi, H, strideH1, strideH2, offsetH, WR, strideWR, offsetWR, WI, strideWI, offsetWI, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ, WORK, strideWork, offsetWork ) {
	let aedResult, nwupbd, sorted, nibble, kacc22, nsmax, itmax, kwtop, kbot;
	let ktop, ndfl, ndec, info, swap, nmin, zdum, nwr, nsr, nho, nve, kwv, kwh;
	let kdu, lv2, inf, nw, nh, ns, ks, ld, ls, kv, kt, ku, aa, bb, cc, dd, ss;
	let it, k, i;
	...
	if ( N <= NTINY ) {
		...
		for ( it = 1; it <= itmax; it++ ) {
			...
			aedResult = dlaqr2( wantt, wantz, N, ktop, kbot, nw, H, strideH1, strideH2, offsetH, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ, WR, strideWR, offsetWR, WI, strideWI, offsetWI, H, strideH1, strideH2, hij( kv, 1 ), nho, H, strideH1, strideH2, hij( kv, kt ), nve, H, strideH1, strideH2, hij( kwv, 1 ), WORK, strideWork, offsetWork );
			ls = aedResult.ns;
			ld = aedResult.nd;
