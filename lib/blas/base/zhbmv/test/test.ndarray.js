...
test( 'zhbmv: upper_basic (UPLO=U, N=4, K=2, alpha=(1,0), beta=(0,0))', function t() { // eslint-disable-line max-len
	...
	const x = new Complex128Array( [ 1, 0.5, 2, -1, 3, 1, 4, 0 ] );
	const y = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = zhbmv( 'upper', 4, 2, alpha, A, 1, 3, 0, x, 1, 0, beta, y, 1, 0 );
...
test( 'zhbmv: lower_basic (UPLO=L, N=4, K=2, alpha=(1,0), beta=(0,0))', function t() { // eslint-disable-line max-len
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = zhbmv( 'lower', 4, 2, alpha, A, 1, 3, 0, x, 1, 0, beta, y, 1, 0 );
	assert.strictEqual( result, y );
	assertArrayClose( toArray( reinterpret( y, 0 ) ), tc.y, 1e-14, 'y' );
});
...
test( 'zhbmv: n_zero (N=0 quick return)', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = zhbmv( 'upper', 0, 2, alpha, A, 1, 3, 0, x, 1, 0, beta, y, 1, 0 );
	assert.strictEqual( result, y );
	assertArrayClose( toArray( reinterpret( y, 0 ) ), tc.y, 1e-14, 'y' );
});
...
test( 'zhbmv: stride_2 (non-unit strides)', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = zhbmv( 'upper', 4, 2, alpha, A, 1, 3, 0, x, 2, 0, beta, y, 2, 0 );
	assert.strictEqual( result, y );
	assertArrayClose( toArray( reinterpret( y, 0 ) ), tc.y, 1e-14, 'y' );
});
...
test( 'zhbmv: scalar (1x1, K=0, alpha=(2,1))', function t() {
	...
	const alpha = new Complex128( 2, 1 );
	const beta = new Complex128( 0, 0 );
	const result = zhbmv( 'upper', 1, 0, alpha, A, 1, 1, 0, x, 1, 0, beta, y, 1, 0 );
	assert.strictEqual( result, y );
	assertArrayClose( toArray( reinterpret( y, 0 ) ), tc.y, 1e-14, 'y' );
});
...
test( 'zhbmv: lower with non-unit strides', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = zhbmv( 'lower', 4, 2, alpha, A, 1, 3, 0, x, 2, 0, beta, y, 2, 0 );
	assert.strictEqual( result, y );
	const tc = stride_2;
	assertArrayClose( toArray( reinterpret( y, 0 ) ), tc.y, 1e-14, 'y' );
});
...
test( 'zhbmv: beta scaling with non-trivial imaginary part', function t() {
	...
	const y = new Complex128Array( [ 2, 3 ] );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 1 );
