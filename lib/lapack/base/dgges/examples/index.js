...
const VSL = new Float64Array( 9 );
const VSR = new Float64Array( 9 );
...
const result = dgges( 'column-major', 'compute-vectors', 'compute-vectors', 'not-sorted', noop, 3, A, 3, B, 3, ALPHAR, ALPHAI, BETA, VSL, 3, VSR, 3 ); // eslint-disable-line max-len
