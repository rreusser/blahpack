...
*/
function dstevr( jobz, range, N, d, strideD, e, strideE, vl, vu, il, iu, abstol, out, w, strideW, Z, LDZ, ISUPPZ, strideISUPPZ, WORK, strideWork, IWORK, strideIWork ) { // eslint-disable-line max-len, max-params
	...
	const oisuppz = stride2offset( N, strideISUPPZ );
	...
	if ( IWORK === null || IWORK === void 0 ) {
		const minIwork = Math.max( 1, 10 * N);
	...
	return base( jobz, range, N, d, strideD, od, e, strideE, oe, vl, vu, il, iu, abstol, out, w, strideW, ow, Z, sz1, sz2, 0, ISUPPZ, strideISUPPZ, oisuppz, WORK, strideWork, owork, IWORK, strideIWork, oiwork ); // eslint-disable-line max-len
}
