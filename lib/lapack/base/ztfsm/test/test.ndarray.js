...
test( 'ztfsm: M=0 returns immediately', function t() {
	...
	const B = new Complex128Array( [ 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99 ] ); // eslint-disable-line max-len
...
test( 'ztfsm: right, non-trivial alpha', function t() {
	...
	const alpha = new Complex128( 0.5, 1.0 );
	const tc = fixtures.right_alpha;
	const A = new Complex128Array( tc.a );
	const B = new Complex128Array( tc.b_in );
