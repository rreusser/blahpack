...
function zlaein( rightv, noinit, N, H, strideH1, strideH2, offsetH, w, v, strideV, offsetV, B, strideB1, strideB2, offsetB, RWORK, strideRWork, offsetRWork, eps3, smlnum ) {
	let bi1jIdx, bij1Idx, normin, biiIdx, bjjIdx, bijIdx, absBii, absBjj, vnorm;
	let trans, rtemp, eiIdx, ejIdx, absEi, absEj, info, its, eiR, eiI, idx, xR;
	let xI, tR, tI, i, j;
	...
	const growto = TENTH / rootn;
	const nrmsml = Math.max( ONE, eps3 * rootn ) * smlnum;
