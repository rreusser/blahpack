...
function dlaed5( i, D, strideD, offsetD, Z, strideZ, offsetZ, DELTA, strideDELTA, offsetDELTA, rho, dlam ) {
	...
	const id1 = offsetD;
	const id2 = offsetD + strideD;
	const iz1 = offsetZ;
	const iz2 = offsetZ + strideZ;
	const ie1 = offsetDELTA;
	const ie2 = offsetDELTA + strideDELTA;

	const del = D[ id2 ] - D[ id1 ];
	const z1sq = Z[ iz1 ] * Z[ iz1 ];
	const z2sq = Z[ iz2 ] * Z[ iz2 ];
	const zsq = z1sq + z2sq;
