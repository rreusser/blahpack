...
test( 'zppcon: N=0 quick return', function t() {
	...
	rcond[ 0 ] = 0.5;
	const info = zppcon( 'upper', 0, new Complex128Array( 0 ), 1, 0, 0.0, rcond, new Complex128Array( 0 ), 1, 0, new Float64Array( 0 ), 1, 0 );
...
test( 'zppcon: anorm=0 returns rcond=0 (upper)', function t() {
	...
	const rcond = new Float64Array( 1 );
	rcond[ 0 ] = 0.5;
	const info = zppcon( 'upper', N, AP, 1, 0, 0.0, rcond, new Complex128Array( 2 * N ), 1, 0, new Float64Array( N ), 1, 0 );
	assert.strictEqual( info, 0 );
...
test( 'zppcon: identity 3x3 upper (rcond=1)', function t() {
	...
	const rcond = new Float64Array( 1 );
	const info = zppcon( 'upper', N, AP, 1, 0, anorm, rcond, new Complex128Array( 2 * N ), 1, 0, new Float64Array( N ), 1, 0 );
	assert.strictEqual( info, 0 );
...
test( 'zppcon: identity 4x4 lower (rcond=1)', function t() {
	...
	const rcond = new Float64Array( 1 );
	const info = zppcon( 'lower', N, AP, 1, 0, anorm, rcond, new Complex128Array( 2 * N ), 1, 0, new Float64Array( N ), 1, 0 );
	assert.strictEqual( info, 0 );
	assert.ok( close( rcond[ 0 ], 1.0, 1e-9 ) );
});
...
test( 'zppcon: N=1 simple', function t() {
	...
	zpptrf( 'upper', N, AP, 1, 0 );
	const rcond = new Float64Array( 1 );
	const info = zppcon( 'upper', N, AP, 1, 0, anorm, rcond, new Complex128Array( 2 ), 1, 0, new Float64Array( 1 ), 1, 0 );
	assert.strictEqual( info, 0 );
