...
import dlanhs from './../lib/ndarray.js';


// FIXTURES //

const fixtureFile = path.join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures', 'dlanhs.jsonl' );
...
// 1x1: -5.5
const A_1X1 = new Float64Array( [ -5.5 ] );
...
function runCase( name, norm, N, A, lda ) {
	...
	const got = dlanhs( norm, N, A, 1, lda, 0, WORK, 1, 0 );
