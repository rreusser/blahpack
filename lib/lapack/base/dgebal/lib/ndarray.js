...
*/
function dgebal( job, N, A, strideA1, strideA2, offsetA, SCALE, strideSCALE, offsetSCALE ) { // eslint-disable-line max-len, max-params
	...
	return base( job, N, A, strideA1, strideA2, offsetA, SCALE, strideSCALE, offsetSCALE ); // eslint-disable-line max-len
}
