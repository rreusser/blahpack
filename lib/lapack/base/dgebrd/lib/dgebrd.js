...
*/
function dgebrd( order, M, N, A, LDA, d, strideD, e, strideE, TAUQ, strideTAUQ, TAUP, strideTAUP, WORK ) {
	let sa1, sa2;
	...
	const otq = stride2offset( N, strideTAUQ );
	const otp = stride2offset( N, strideTAUP );
	if ( WORK === null || WORK === void 0 ) {
		const minWork = Math.max( 1, M, N );
		WORK = new Float64Array( minWork );
	}
	return base( M, N, A, sa1, sa2, 0, d, strideD, od, e, strideE, oe, TAUQ, strideTAUQ, otq, TAUP, strideTAUP, otp, WORK, 1, 0 );
}
