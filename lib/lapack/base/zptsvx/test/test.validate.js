...
function invNorm1( A0, n ) {
	...
	var info = zptsv( n, n, D.data, D.args[ 0 ], D.args[ 1 ], E.data, E.args[ 0 ], E.args[ 1 ], Br.data, Br.args[ 0 ], Br.args[ 1 ], Br.args[ 2 ] );
	if ( info !== 0 ) {
...
function drive( N, nrhs, A0, B0, layout, impl ) {
	...
	var EF = new Complex128Array( Math.max( N - 1, 1 ) );
	...
	var info = fn( 'not-factored', N, nrhs, D.data, D.args[ 0 ], D.args[ 1 ], E.data, E.args[ 0 ], E.args[ 1 ], DF, 1, 0, EF, 1, 0, Br.data, Br.args[ 0 ], Br.args[ 1 ], Br.args[ 2 ], Xr.data, Xr.args[ 0 ], Xr.args[ 1 ], Xr.args[ 2 ], rcond, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, RWORK, 1, 0 );
	return {
		'Xr': Xr,
		'rcond': rcond,
		'FERR': FERR,
...
function runProperty( N, nrhs ) {
	...
	checked( 'zptsvx', 'property', function run() {
		...
		var db = drive( N, nrhs, A0, B0, TIGHT, zptsvxBase );
