...
test( 'zhesv: N=0 quick return', function t() {
	...
	info = zhesv( 'upper', 0, 1, A, 1, 1, 0, IPIV, 1, 0, B, 1, 1, 0, WORK, 1, 0 );
	assert.equal( info, 0 );
});
...
test( 'zhesv: upper_4x4_1rhs (fixture, lwork >= N uses zhetrs2)', function t() {
	...
	info = zhesv( 'upper', n, 1, A, 1, n, 0, IPIV, 1, 0, B, 1, n, 0, WORK, 1, 0 );
...
test( 'zhesv: lower_4x4_2rhs (fixture)', function t() {
	...
	info = zhesv( 'lower', n, nrhs, A, 1, n, 0, IPIV, 1, 0, B, 1, n, 0, WORK, 1, 0 );
...
test( 'zhesv: n1 (fixture)', function t() {
	...
	info = zhesv( 'upper', 1, 1, A, 1, 1, 0, IPIV, 1, 0, B, 1, 1, 0, WORK, 1, 0 );
...
test( 'zhesv: lower with lwork < N (falls back to zhetrs)', function t() {
	...
	info = zhesv( 'lower', n, 1, A, 1, n, 0, IPIV, 1, 0, B, 1, n, 0, WORK, 1, 0 );
