...
import ztrsyl from '../../ztrsyl/lib/base.js';
...
*/
function ztrsen( job, compq, SELECT, strideSELECT, offsetSELECT, N, T, strideT1, strideT2, offsetT, Q, strideQ1, strideQ2, offsetQ, W, strideW, offsetW, M, s, sep, WORK, strideWork, offsetWork ) {
	let rnorm, scale, kase, isave, est, rwork, tv, wv, n1, ks, st1, st2, oT, k;
