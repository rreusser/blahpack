...
import no_trans_basic from './fixtures/no_trans_basic.json' with { type: 'json' };
import trans_basic from './fixtures/trans_basic.json' with { type: 'json' };
import conj_trans_basic from './fixtures/conj_trans_basic.json' with { type: 'json' };
...
import incx_2 from './fixtures/incx_2.json' with { type: 'json' };
import incy_2 from './fixtures/incy_2.json' with { type: 'json' };
import rect_m_lt_n from './fixtures/rect_m_lt_n.json' with { type: 'json' };
...
test( 'zgbmv: no-transpose basic (M=4, N=4, KL=1, KU=2, alpha=(1,0), beta=(0,0))', function t() { // eslint-disable-line max-len
	...
	const tc = no_trans_basic;
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
...
test( 'zgbmv: transpose basic (M=4, N=4, KL=1, KU=2)', function t() {
	...
	const tc = trans_basic;
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: conjugate-transpose basic (M=4, N=4, KL=1, KU=2)', function t() {
	...
	const tc = conj_trans_basic;
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'conjugate-transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: complex alpha and beta (alpha=(2,1), beta=(0.5,-0.5))', function t() { // eslint-disable-line max-len
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 1, 1, 2, -1, 0.5, 0.5, 3, 0 ] );
...
test( 'zgbmv: alpha=(0,0), beta=(2,0) — only scale y', function t() {
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 1, 2, 3, 4, 5, 6, 7, 8 ] );
...
test( 'zgbmv: M=0 quick return', function t() {
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 99, 0, 77, 66 ] );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 0, 4, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: N=0, beta=(0,0) — zero y since leny=M=4 but no matrix', function t() { // eslint-disable-line max-len
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 99, 0, 77, 66, 55, 44, 33, 22 ] );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 4, 0, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
	const yv = reinterpret( y, 0 );
	assert.strictEqual( yv[ 0 ], 99 );
	assert.strictEqual( yv[ 1 ], 0 );
...
test( 'zgbmv: alpha=(0,0), beta=(0,0) — zero out y', function t() {
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 99, 88, 77, 66, 55, 44, 33, 22 ] );
	const alpha = new Complex128( 0, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: non-unit incx=2 (strideX=2)', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 2, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: non-unit incy=2 (strideY=2)', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: rectangular M<N (3x5 matrix, KL=1, KU=1, LDA=3)', function t() {
	...
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 0.5, 0.5, 1, -0.5 ] );
	const y = new Complex128Array( 3 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 3, 5, 1, 1, alpha, A, 1, 3, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: beta=(1,0) — add to existing y', function t() {
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 10, 5, 20, -10, 30, 15, 40, -20 ] );
	const alpha = new Complex128( 1, 0 );
...
test( 'zgbmv: alpha=(0,0), beta=(1,0) quick return (y unchanged)', function t() { // eslint-disable-line max-len
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 5, 6, 7, 8, 9, 10, 11, 12 ] );
	const alpha = new Complex128( 0, 0 );
	const beta = new Complex128( 1, 0 );
	const result = base( 'no-transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 1, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
...
test( 'zgbmv: conjugate-transpose with non-unit strides', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'conjugate-transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 2, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
	const tc = conj_trans_basic;
...
test( 'zgbmv: transpose with non-unit strides', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'transpose', 4, 4, 1, 2, alpha, A, 1, 4, 0, x, 2, 0, beta, y, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, y );
	const tc = trans_basic;
...
test( 'zgbmv: complex beta scaling (alpha=0, beta=(1,1))', function t() {
	...
	const A = createBandMatrix44();
	const x = new Complex128Array( [ 1, 0, 2, 1, 3, -1, 4, 0.5 ] );
	const y = new Complex128Array( [ 1, 0, 0, 1, 2, 0, 0, 2 ] );
	const alpha = new Complex128( 0, 0 );
