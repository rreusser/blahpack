...
import alpha_2_neg1 from './fixtures/alpha_2_neg1.json' with { type: 'json' };
...
import neg_incy from './fixtures/neg_incy.json' with { type: 'json' };
...
test( 'zgeru: alpha = (2, -1)', function t() {
	...
	const y = new Complex128Array( [ 2, 1, 1, -1 ] );
...
test( 'zgeru: alpha = 0 (no update)', function t() {
	...
	const x = new Complex128Array( [ 1, 1, 2, 2 ] );
	const y = new Complex128Array( [ 3, 3, 4, 4 ] );
...
test( 'zgeru: N=0 quick return', function t() {
	const tc = n_zero;
	const A = new Complex128Array( [ 5, 6 ] );
	const x = new Complex128Array( [ 1, 1, 2, 2 ] );
	const y = new Complex128Array( [ 3, 3 ] );
...
test( 'zgeru: non-unit strides (incx=2, incy=2)', function t() {
	...
	const y = new Complex128Array( [ 2, 0, 88, 88, 0, 2 ] );
...
test( 'zgeru: negative stride incy=-1', function t() {
	...
	const x = new Complex128Array( [ 1, 1, 2, 0 ] );
	const y = new Complex128Array( [ 3, 0, 0, 3 ] );
...
test( 'zgeru: 1x1 matrix', function t() {
	...
	const y = new Complex128Array( [ 4, 5 ] );
...
test( 'zgeru: offset support', function t() {
	...
	const x = new Complex128Array( [ 88, 88, 2, 3 ] );
	const y = new Complex128Array( [ 77, 77, 4, 5, 6, 7 ] );
