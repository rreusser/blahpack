...
const FIXTURE_PATH = resolve( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures', 'zlatrz.jsonl' );
...
test( 'ndarray: returns A unchanged when M=0', function t() {
	...
	const out = ndarray( 0, 3, 0, A, 1, 1, 0, TAU, 1, 0, work, 1, 0 );
...
test( 'ndarray: 3x5 L=2 matches fixture (column-major)', function t() {
	...
	const tc = findCase( '3x5_l2' );
	const A = buildMatrix( 3, 5, [
		[ 1, 1, 4.0, 0.5 ],
		[ 1, 2, 1.0, -0.2 ],
		[ 1, 3, 2.0, 0.3 ],
		[ 1, 4, 3.0, 0.1 ],
...
test( 'ndarray: 4x6 L=2 matches fixture (column-major)', function t() {
	...
	const tc = findCase( '4x6_l2' );
	const A = buildMatrix( 4, 6, [
		[ 1, 1, 5.0, 0.1 ],
		[ 1, 2, 1.0, -0.3 ],
		[ 1, 3, 2.0, 0.5 ],
		[ 1, 4, 3.0, 0.2 ],
...
test( 'ndarray: 1x3 L=2 matches fixture (single row)', function t() {
	const work = new Complex128Array( 1 );
	const TAU = new Complex128Array( 1 );
	const tc = findCase( '1x3_l2' );
	const A = buildMatrix( 1, 3, [
		[ 1, 1, 3.0, 0.7 ],
		[ 1, 2, 1.0, -0.4 ],
		[ 1, 3, 2.0, 0.5 ]
	]);
...
test( 'ndarray: 2x4 L=2 matches fixture', function t() {
	...
	const tc = findCase( '2x4_l2' );
	const A = buildMatrix( 2, 4, [
		[ 1, 1, 2.0, 0.2 ],
		[ 1, 2, 1.0, -0.1 ],
		[ 1, 3, 3.0, 0.4 ],
		[ 1, 4, 1.0, -0.3 ],
...
test( 'ndarray: 3x7 L=4 matches fixture (large L)', function t() {
	const work = new Complex128Array( 3 );
	const TAU = new Complex128Array( 3 );
	const tc = findCase( '3x7_l4' );
	const A = buildMatrix( 3, 7, [
		[ 1, 1, 4.0, 0.2 ],
		[ 1, 2, 1.0, -0.1 ],
		[ 1, 3, 2.0, 0.3 ],
		[ 1, 4, 1.0, -0.4 ],
...
test( 'ndarray: honors non-zero offsets for A, TAU, and work', function t() {
	...
	const A = new Complex128Array( 1 + ( 3 * 5 ) );
