...
function ctrans( upper, N, K, alphaR, alphaI, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, beta, C, strideC1, strideC2, offsetC ) {
	let c00R, c00I, c10R, c10I, c01R, c01I, c11R, c11I, a0R, a0I, a1R, a1I, d0R;
	let d0I, d1R, d1I, t1_0R, t1_0I, t2_0R, t2_0I, t1_1R, t1_1I, t2_1R, t2_1I;
	let bc0R, bc0I, ac0R, ac0I, bc1R, bc1I, ac1R, ac1I, pAi0, pAi1, pBi0, pBi1;
	let pAj0, pAj1, pBj0, pBj1, Av, Bv, Cv, ar, ak, br, bk, oA, oB, oC, sc1;
	let sc2, pak, pbk, pc, i, j, l, ii;
	...
	function offdiag( ii, jj ) {
		let cR, cI, aR, aI, bR, bI, acR, acI, bcR, bcI, t1R, t1I, t2R, t2I, pa;
		let pb, ll;
		const pAi = oA + ( ii * ar );
		const pBi = oB + ( ii * br );
		const pAj = oA + ( jj * ar );
	...
	function diag( jj ) {
		let cR, aR, aI, bR, bI, acR, acI, bcR, bcI, t1R, t1I, t2R, t2I, pa, pb;
		let ll;
		const pAj = oA + ( jj * ar );
		const pBj = oB + ( jj * br );
		cR = 0.0;
...
function zher2k( uplo, trans, N, K, alpha, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, beta, C, strideC1, strideC2, offsetC ) {
	let temp1R, temp1I, temp2R, temp2I, ajR, ajI, bjR, bjI, aiR, aiI, biR, biI;
	let ic, ia, ib, i, j, l;
