...
*/
function dsygv( itype, jobz, uplo, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, w, strideW, offsetW, WORK, strideWork, offsetWork ) { // eslint-disable-line max-len, max-params
	...
	const minWork = Math.max( 1, Math.max( 1, 3 * N - 1 ) );
	...
	return base( itype, jobz, uplo, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, w, strideW, offsetW, WORK, strideWork, offsetWork ); // eslint-disable-line max-len
}
