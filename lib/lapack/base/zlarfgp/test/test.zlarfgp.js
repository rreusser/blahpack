...
import zlarfgpMain from './../lib/index.js';
import zlarfgp from './../lib/zlarfgp.js';
...
test( 'zlarfgp main and ndarray entry points produce the same result', function t() {
	const alpha1 = new Complex128Array( [ 3.0, 0.0 ] );
	const alpha2 = new Complex128Array( [ 3.0, 0.0 ] );
	const tau1 = new Complex128Array( 1 );
	const tau2 = new Complex128Array( 1 );
	const x1 = new Complex128Array( [ 1.0, 0.0, 2.0, 0.0 ] );
	const x2 = new Complex128Array( [ 1.0, 0.0, 2.0, 0.0 ] );
