...
test( 'dtgsen: ijob0_select13 - reorder only, select eigenvalues 1 and 3', function t() { // eslint-disable-line max-len
	...
	result = dtgsen( 0, true, true, SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 1, N, 0, Z, 1, N, 0, M, pl, pr, DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'dtgsen: ijob1_pl_pr - compute PL and PR', function t() {
	...
	WORK = new Float64Array( 500 );
	IWORK = new Int32Array( 500 );
	result = dtgsen( 1, true, true, SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 1, N, 0, Z, 1, N, 0, M, pl, pr, DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( result, tc.info, 'info' );
	assert.equal( M[ 0 ], tc.M, 'M' );
...
test( 'dtgsen: ijob4_dif_frobenius - compute PL, PR, DIF via Frobenius', function t() { // eslint-disable-line max-len
	...
	WORK = new Float64Array( 500 );
	IWORK = new Int32Array( 500 );
	result = dtgsen( 4, true, true, SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 1, N, 0, Z, 1, N, 0, M, pl, pr, DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( result, tc.info, 'info' );
	assert.equal( M[ 0 ], tc.M, 'M' );
	assertClose( pl[ 0 ], tc.PL, 1e-13, 'PL' );
	assertClose( pr[ 0 ], tc.PR, 1e-13, 'PR' );
...
test( 'dtgsen: ijob5_dif_onenorm - compute PL, PR, DIF via one-norm', function t() { // eslint-disable-line max-len
	...
	WORK = new Float64Array( 500 );
	IWORK = new Int32Array( 500 );
	result = dtgsen( 5, true, true, SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 1, N, 0, Z, 1, N, 0, M, pl, pr, DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( result, tc.info, 'info' );
	assert.equal( M[ 0 ], tc.M, 'M' );
	assertClose( pl[ 0 ], tc.PL, 1e-13, 'PL' );
	assertClose( pr[ 0 ], tc.PR, 1e-13, 'PR' );
...
test( 'dtgsen: n1_trivial - N=1', function t() {
	...
	WORK = new Float64Array( 500 );
	IWORK = new Int32Array( 500 );
	result = dtgsen( 0, true, true, SELECT, 1, 0, 1, A, 1, 1, 0, B, 1, 1, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 1, 1, 0, Z, 1, 1, 0, M, pl, pr, DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( result, tc.info, 'info' );
	assert.equal( M[ 0 ], tc.M, 'M' );
...
test( 'dtgsen: ijob2_dif_frobenius - compute DIF via Frobenius (IDIFJB)', function t() { // eslint-disable-line max-len
	...
	WORK = new Float64Array( 500 );
	IWORK = new Int32Array( 500 );
	result = dtgsen( 2, true, true, SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 1, N, 0, Z, 1, N, 0, M, pl, pr, DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( result, tc.info, 'info' );
	assert.equal( M[ 0 ], tc.M, 'M' );
	assertArrayClose( toArray( DIF ), tc.DIF, 1e-13, 'DIF' );
	assertArrayClose( toArray( ALPHAR ).slice( 0, N ), tc.ALPHAR, 1e-13, 'ALPHAR' ); // eslint-disable-line max-len
...
test( 'dtgsen: ijob3_onenorm_plpr - compute DIF via one-norm + PL/PR', function t() { // eslint-disable-line max-len
	...
	WORK = new Float64Array( 500 );
	IWORK = new Int32Array( 500 );
	result = dtgsen( 3, true, true, SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, Q, 1, N, 0, Z, 1, N, 0, M, pl, pr, DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( result, tc.info, 'info' );
	assert.equal( M[ 0 ], tc.M, 'M' );
	assertClose( pl[ 0 ], tc.PL, 1e-13, 'PL' );
	assertClose( pr[ 0 ], tc.PR, 1e-13, 'PR' );
