...
interface Routine {
	...
	*/
	...
	/**
	* Solves a Hermitian positive definite system of linear equations `A*X = B` using the Cholesky factorization computed by zpotrf (complex double-precision) using alternative indexing semantics.
	*
	* @param uplo - specifies whether the upper or lower triangular part is referenced
	* @param N - number of columns
	* @param nrhs - number of right-hand sides
