...
test( 'dgbbrd column-major path executes', function t() {
	...
	AB[ 6 ] = -1.0; AB[ 7 ] = 2.0;
	const info = dgbbrd( 'column-major', 'no-vectors', 3, 3, 0, 1, 1, AB, 3, d, 1, e, 1, Q, 3, PT, 3, C, 3, WORK, 1 );
...
test( 'dgbbrd row-major path executes', function t() {
	...
	AB[ 6 ] = -1; AB[ 7 ] = -1;
	const info = dgbbrd( 'row-major', 'no-vectors', 3, 3, 0, 1, 1, AB, 3, d, 1, e, 1, Q, 3, PT, 3, C, 3, WORK, 1 );
	assert.strictEqual( info, 0 );
});
