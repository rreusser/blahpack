...
interface Routine {
	...
	*/
	...
	/**
	* Computes selected eigenvalues and, optionally, eigenvectors of a complex Hermitian-definite generalized eigenproblem in packed storage using alternative indexing semantics.
	*
	* @param itype - `itype`
	* @param jobz - `jobz`
	* @param range - `range`
