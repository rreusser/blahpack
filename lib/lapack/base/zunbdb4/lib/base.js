...
import zunbdb5 from './../../zunbdb5/lib/base.js';
import dznrm2 from './../../../../blas/base/dznrm2/lib/base.js';
import zdrot from './../../../../blas/base/zdrot/lib/base.js';
...
const scratchTauv = reinterpret( scratchTau, 0 );
...
function zunbdb4( M, P, Q, X11, strideX111, strideX112, offsetX11, X21, strideX211, strideX212, offsetX21, THETA, strideTHETA, offsetTHETA, PHI, stridePHI, offsetPHI, TAUP1, strideTAUP1, offsetTAUP1, TAUP2, strideTAUP2, offsetTAUP2, TAUQ1, strideTAUQ1, offsetTAUQ1, PHANTOM, stridePHANTOM, offsetPHANTOM, WORK, strideWork, offsetWork ) {
	let oPhComplex;
	let oX11Im1C; // complex offset of X11(i, i-1)
	let oX21Im1C; // complex offset of X21(i, i-1)
	
	let oX11Im1;  // Float64-view offset of X11(i, i-1)
	let oX21Im1;  // Float64-view offset of X21(i, i-1)
	let oX11iiC;  // complex offset of X11(i, i)
	let oX21iiC;  // complex offset of X21(i, i)
	let oPhTopC;  // complex offset of PHANTOM(0)
	let oPhBotC;  // complex offset of PHANTOM(P)
	
	
	let oX11ii;   // Float64-view offset of X11(i, i)
	let oX21ii;   // Float64-view offset of X21(i, i)
	let oPhTop;   // Float64-view offset of PHANTOM(0)
	let oPhBot;   // Float64-view offset of PHANTOM(P)
	let oTAUP1, oTAUP2, oTAUQ1, theta, n1, n2, c, i, j, s;

	// Float64 views of the complex arrays for direct real-part reads and for planting the implicit `1.0 + 0.0i`.
	const X11v = reinterpret( X11, 0 );
	const X21v = reinterpret( X21, 0 );
	const TAUP1v = reinterpret( TAUP1, 0 );
	const TAUP2v = reinterpret( TAUP2, 0 );
	const PHANTOMv = reinterpret( PHANTOM, 0 );
