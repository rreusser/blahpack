...
import dpoequ from '../../dpoequ/lib/base.js';
import dlaqsy from '../../dlaqsy/lib/base.js';
import dpotrf from '../../dpotrf/lib/base.js';
import dpotrs from '../../dpotrs/lib/base.js';
import dporfs from '../../dporfs/lib/base.js';
import dpocon from '../../dpocon/lib/base.js';
...
*/
function dposvx( fact, uplo, N, nrhs, A, strideA1, strideA2, offsetA, AF, strideAF1, strideAF2, offsetAF, equed, s, strideS, offsetS, B, strideB1, strideB2, offsetB, X, strideX1, strideX2, offsetX, rcond, FERR, strideFERR, offsetFERR, BERR, strideBERR, offsetBERR, WORK, strideWork, offsetWork, IWORK, strideIWork, offsetIWork ) {
	let rcequ, scond, smax, smin, info, db, dx, eq, i, j;
	...
	const anorm = dlansy( 'one-norm', uplo, N, A, strideA1, strideA2, offsetA, WORK, strideWork, offsetWork );
