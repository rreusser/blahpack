...
*/
function dtrttf( transr, uplo, N, A, strideA1, strideA2, offsetA, ARF, strideARF, offsetARF ) { // eslint-disable-line max-len, max-params
	...
	return base( transr, uplo, N, A, strideA1, strideA2, offsetA, ARF, strideARF, offsetARF ); // eslint-disable-line max-len
}
