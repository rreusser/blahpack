...
test( 'ztrsm: left, upper, no-transpose, non-unit', function t() {
	const tc = left_upper_notrans_nonunit;
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, upper, transpose, non-unit', function t() {
	const tc = left_upper_trans_nonunit;
	const result = base( 'left', 'upper', 'transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, upper, conj-transpose, non-unit', function t() {
	const tc = left_upper_conjtrans_nonunit;
	const result = base( 'left', 'upper', 'conjugate-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, lower, no-transpose, non-unit', function t() {
	const tc = left_lower_notrans_nonunit;
	const result = base( 'left', 'lower', 'no-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), lowerA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, lower, transpose, non-unit', function t() {
	const tc = left_lower_trans_nonunit;
	const result = base( 'left', 'lower', 'transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), lowerA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, lower, conj-transpose, non-unit', function t() {
	const tc = left_lower_conjtrans_nonunit;
	const result = base( 'left', 'lower', 'conjugate-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), lowerA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, upper, no-transpose, non-unit', function t() {
	const tc = right_upper_notrans_nonunit;
	const result = base( 'right', 'upper', 'no-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, upper, transpose, non-unit', function t() {
	const tc = right_upper_trans_nonunit;
	const result = base( 'right', 'upper', 'transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, upper, conj-transpose, non-unit', function t() {
	const tc = right_upper_conjtrans_nonunit;
	const result = base( 'right', 'upper', 'conjugate-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, lower, no-transpose, non-unit', function t() {
	const tc = right_lower_notrans_nonunit;
	const result = base( 'right', 'lower', 'no-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), lowerA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, lower, transpose, non-unit', function t() {
	const tc = right_lower_trans_nonunit;
	const result = base( 'right', 'lower', 'transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), lowerA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, lower, conj-transpose, non-unit', function t() {
	const tc = right_lower_conjtrans_nonunit;
	const result = base( 'right', 'lower', 'conjugate-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), lowerA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});
...
test( 'ztrsm: left, upper, no-transpose, unit', function t() {
	const tc = left_upper_notrans_unit;
	const result = base( 'left', 'upper', 'no-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), upperUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, upper, transpose, unit', function t() {
	const tc = left_upper_trans_unit;
	const result = base( 'left', 'upper', 'transpose', 'unit', 2, 2, new Complex128( 1, 0 ), upperUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, upper, conj-transpose, unit', function t() {
	const tc = left_upper_conjtrans_unit;
	const result = base( 'left', 'upper', 'conjugate-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), upperUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, lower, no-transpose, unit', function t() {
	const tc = left_lower_notrans_unit;
	const result = base( 'left', 'lower', 'no-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), lowerUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, lower, transpose, unit', function t() {
	const tc = left_lower_trans_unit;
	const result = base( 'left', 'lower', 'transpose', 'unit', 2, 2, new Complex128( 1, 0 ), lowerUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: left, lower, conj-transpose, unit', function t() {
	const tc = left_lower_conjtrans_unit;
	const result = base( 'left', 'lower', 'conjugate-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), lowerUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, upper, no-transpose, unit', function t() {
	const tc = right_upper_notrans_unit;
	const result = base( 'right', 'upper', 'no-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), upperUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, upper, transpose, unit', function t() {
	const tc = right_upper_trans_unit;
	const result = base( 'right', 'upper', 'transpose', 'unit', 2, 2, new Complex128( 1, 0 ), upperUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, upper, conj-transpose, unit', function t() {
	const tc = right_upper_conjtrans_unit;
	const result = base( 'right', 'upper', 'conjugate-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), upperUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, lower, no-transpose, unit', function t() {
	const tc = right_lower_notrans_unit;
	const result = base( 'right', 'lower', 'no-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), lowerUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, lower, transpose, unit', function t() {
	const tc = right_lower_trans_unit;
	const result = base( 'right', 'lower', 'transpose', 'unit', 2, 2, new Complex128( 1, 0 ), lowerUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, lower, conj-transpose, unit', function t() {
	const tc = right_lower_conjtrans_unit;
	const result = base( 'right', 'lower', 'conjugate-transpose', 'unit', 2, 2, new Complex128( 1, 0 ), lowerUnitA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});
...
test( 'ztrsm: alpha=0 zeros B', function t() {
	const tc = alpha_zero;
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 2, 2, new Complex128( 0, 0 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: complex alpha=(0,1) with identity A', function t() {
	const tc = complex_alpha;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 2, 0, 0, 2 ] );
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 2, 2, new Complex128( 0, 1 ), A, 1, 2, 0, B, 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: complex alpha=(2,-1) with non-identity A', function t() {
	const tc = complex_alpha_nonidentity;
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 2, 2, new Complex128( 2, -1 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: M=0 quick return (B unchanged)', function t() {
	const B = new Complex128Array( [ 99, 99 ] );
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 0, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, B, 1, 1, 0 );
	assert.strictEqual( result, B );
	const v = reinterpret( B, 0 );
...
test( 'ztrsm: N=0 quick return (B unchanged)', function t() {
	const B = new Complex128Array( [ 99, 99 ] );
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 2, 0, new Complex128( 1, 0 ), upperA(), 1, 2, 0, B, 1, 1, 0 );
	assert.strictEqual( result, B );
	const v = reinterpret( B, 0 );
	assert.strictEqual( v[ 0 ], 99 );
	assert.strictEqual( v[ 1 ], 99 );
...
test( 'ztrsm: 3x2 left, upper, no-transpose', function t() {
	const tc = _3x2_left_upper_notrans;
	...
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 3, 2, new Complex128( 1, 0 ), A, 1, 3, 0, B, 1, 3, 0 );
...
test( 'ztrsm: right, upper, conj-transpose with complex alpha', function t() {
	const tc = right_upper_conjtrans_alpha;
	const result = base( 'right', 'upper', 'conjugate-transpose', 'non-unit', 2, 2, new Complex128( 2, -1 ), upperA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: right, lower, transpose with complex alpha', function t() {
	const tc = right_lower_trans_alpha;
	const result = base( 'right', 'lower', 'transpose', 'non-unit', 2, 2, new Complex128( 2, -1 ), lowerA(), 1, 2, 0, stdB(), 1, 2, 0 );
	assertArrayClose( extractCMatrix( result, 2, 2, 1, 2, 0 ), tc.b, 'b' );
});

test( 'ztrsm: returns the B array', function t() {
	const B = stdB();
	const result = base( 'left', 'upper', 'no-transpose', 'non-unit', 2, 2, new Complex128( 1, 0 ), upperA(), 1, 2, 0, B, 1, 2, 0 );
	assert.strictEqual( result, B );
});
