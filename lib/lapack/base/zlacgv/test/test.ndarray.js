...
test( 'zlacgv: pure imaginary', function t() {
	const tc = zlacgv_pure_imag;
	const x = new Complex128Array( [ 0.0, 5.0, 0.0, -3.0 ] );
	base( 2, x, 1, 0 );
