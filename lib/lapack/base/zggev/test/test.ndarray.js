...
test( 'zggev: N=0 quick return', function t() {
	...
	const info = zggev( 'none', 'none', 0, A, 1, 1, 0, B, 1, 1, 0, ALPHA, 1, 0, BETA, 1, 0, VL, 1, 1, 0, VR, 1, 1, 0);
...
test( 'zggev: N=1 with eigenvectors', function t() {
	...
	Bv[ 0 ] = 2.0;
	Bv[ 1 ] = 0.5;
	const info = zggev( 'compute', 'compute', N, A, 1, LDA, 0, B, 1, LDA, 0, ALPHA, 1, 0, BETA, 1, 0, VL, 1, N, 0, VR, 1, N, 0);
...
test( 'zggev: 3x3 right eigenvectors only', function t() {
	...
	Bv[ 16 ] = 1.0;
	Bv[ 17 ] = 0.5;
	const info = zggev( 'none', 'compute', N, A, 1, LDA, 0, B, 1, LDA, 0, ALPHA, 1, 0, BETA, 1, 0, VL, 1, N, 0, VR, 1, N, 0);
	assert.strictEqual( info, tc.info );
	assertComplexArrayClose( ALPHAv, 0, tc.alpha, tol, 'alpha' );
	assertComplexArrayClose( BETAv, 0, tc.beta, tol, 'beta' );
...
test( 'zggev: 3x3 eigenvalues only', function t() {
	...
	Bv[ 16 ] = 1.0;
	Bv[ 17 ] = 0.5;
	const info = zggev( 'none', 'none', N, A, 1, LDA, 0, B, 1, LDA, 0, ALPHA, 1, 0, BETA, 1, 0, VL, 1, N, 0, VR, 1, N, 0);
	assert.strictEqual( info, tc.info );
	assertComplexArrayClose( ALPHAv, 0, tc.alpha, tol, 'alpha' );
	assertComplexArrayClose( BETAv, 0, tc.beta, tol, 'beta' );
});
...
test( 'zggev: 2x2 left eigenvectors only', function t() {
	...
	Bv[ 6 ] = 3.0;
	Bv[ 7 ] = -0.5;
	const info = zggev( 'compute', 'none', N, A, 1, LDA, 0, B, 1, LDA, 0, ALPHA, 1, 0, BETA, 1, 0, VL, 1, N, 0, VR, 1, N, 0);
	assert.strictEqual( info, tc.info );
	assertComplexArrayClose( ALPHAv, 0, tc.alpha, tol, 'alpha' );
	assertComplexArrayClose( BETAv, 0, tc.beta, tol, 'beta' );
	assertComplexArrayClose( VLv, 0, tc.VL_col1, tol, 'VL_col1' );
