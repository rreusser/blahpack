...
test( 'dsyr2: upper_basic', function t() {
	...
	const A = new Float64Array( [ 1, 2, 3, 2, 5, 6, 3, 6, 9 ] );
...
test( 'dsyr2: upper_alpha', function t() {
	...
	const A = new Float64Array( [ 1, 0, 0, 2, 5, 0, 3, 6, 9 ] );
	const x = new Float64Array( [ 1, 2, 3 ] );
...
test( 'dsyr2: lower_alpha', function t() {
	...
	const A = new Float64Array( [ 1, 2, 3, 0, 5, 6, 0, 0, 9 ] );
...
test( 'dsyr2: alpha_zero', function t() {
	const tc = alpha_zero;
	const A = new Float64Array( [ 99, 0, 0, 0, 0, 0, 0, 0, 0 ] );
	const x = new Float64Array( [ 1, 2, 3 ] );
	const y = new Float64Array( [ 4, 5, 6 ] );
...
test( 'dsyr2: upper_stride', function t() {
	...
	const A = new Float64Array( [ 1, 0, 0, 2, 5, 0, 3, 6, 9 ] );
	const x = new Float64Array( [ 1, 0, 2, 0, 3 ] );
	const y = new Float64Array( [ 4, 0, 5, 0, 6 ] );
...
test( 'dsyr2: lower_stride', function t() {
	...
	const A = new Float64Array( [ 1, 2, 3, 0, 5, 6, 0, 0, 9 ] );
	const x = new Float64Array( [ 1, 0, 2, 0, 3 ] );
	const y = new Float64Array( [ 4, 0, 0, 5, 0, 0, 6 ] );
...
test( 'dsyr2: returns A', function t() {
	...
	const result = dsyr2( 'upper', 2, 1.0, x, 1, 0, y, 1, 0, A, 1, 2, 0 );
...
test( 'dsyr2: offset support', function t() {
	...
	const A = new Float64Array( [ 5 ] );
	const x = new Float64Array( [ 999, 3 ] );
	const y = new Float64Array( [ 999, 999, 2 ] );
...
test( 'dsyr2: offsetA support', function t() {
	...
	const A = new Float64Array( [ 999, 999, 1, 0, 0, 1 ] );
	const x = new Float64Array( [ 1, 2 ] );
	const y = new Float64Array( [ 3, 4 ] );
...
test( 'dsyr2: blocked paths, both uplo x layout, corner + remainder', function t() {
	let expected, layout, uplo, msg, sa1, sa2, A, x, y, i, u, w;
	const N = 9;
...
test( 'dsyr2: zero-guard patterns exercise fast and guarded block paths', function t() {
	let expected, layout, zerosX, zerosY, uplo, msg, sa1, sa2, A, x, y, i, k, u;
	let w, p;
	const N = 9;
	const uplos = [ 'upper', 'lower' ];
	const layouts = [ 'col', 'row' ];
