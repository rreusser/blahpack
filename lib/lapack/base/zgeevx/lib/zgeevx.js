...
*/
function zgeevx( order, balanc, jobvl, jobvr, sense, N, A, LDA, w, strideW, VL, LDVL, VR, LDVR, ilo, ihi, SCALE, strideSCALE, abnrm, RCONDE, strideRCONDE, RCONDV, strideRCONDV, WORK, strideWork, RWORK, strideRWork ) { // eslint-disable-line max-len, max-params
	let svl1, svl2, svr1, svr2, sa1, sa2;
	...
	if ( WORK === null || WORK === void 0 ) {
		if ( sense === 'right-vectors' || sense === 'both' ) {
			WORK = new Complex128Array( max( 1, ( N*N ) + ( 2*N ) ) );
		} else {
	...
	return base( balanc, jobvl, jobvr, sense, N, A, sa1, sa2, 0, w, strideW, 0, VL, svl1, svl2, 0, VR, svr1, svr2, 0, ilo, ihi, SCALE, strideSCALE, 0, abnrm, RCONDE, strideRCONDE, 0, RCONDV, strideRCONDV, 0, WORK, strideWork, 0, RWORK, strideRWork, 0 ); // eslint-disable-line max-len
}
