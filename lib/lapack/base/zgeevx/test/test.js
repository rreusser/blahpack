...
test( 'main export validates N', function t() {
	assert.throws( function throws() {
		zgeevx( 'column-major', 'none', 'no-vectors', 'no-vectors', 'none', -1, null, 1, null, 1, null, 1, null, 1, 0, 0, null, 1, 0, null, 1, null, 1, null, 1, null, 1 ); // eslint-disable-line max-len
	}, RangeError );
});
