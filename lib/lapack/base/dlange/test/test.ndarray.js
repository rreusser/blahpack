...
import dlange from './../lib/ndarray.js';


// FIXTURES //

const fixtureFile = path.join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures', 'dlange.jsonl' );
...
// 1x1 matrix
const A_1X1 = buildA( LDA, 1, [ 1, 1, -5.5 ] );

// 4x5 matrix (LDA=4)
const A_4X5 = buildA( LDA, 5, [
...
function runCase( name, norm, M, N, A ) {
	...
	const got = dlange( norm, M, N, A, 1, LDA, 0, WORK, 1, 0 );
