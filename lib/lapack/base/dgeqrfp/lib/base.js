...
import dgeqr2p from './../../dgeqr2p/lib/base.js';
...
function dgeqrfp( M, N, A, strideA1, strideA2, offsetA, TAU, strideTAU, offsetTAU, WORK, strideWORK, offsetWORK ) {
	...
	// If WORK is null or too small to hold T at offset iws, use an internal buffer.
	if ( !WORK || ( WORK.length - offsetWORK ) < iws + ( nb * nb ) ) {
