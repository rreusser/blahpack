...
*/
function dgemlqt( order, side, trans, M, N, K, mb, V, LDV, T, LDT, C, LDC, WORK ) {
	let ldwork, work, sv1, sv2, st1, st2, sc1, sc2;
	...
	return base( side, trans, M, N, K, mb, V, sv1, sv2, 0, T, st1, st2, 0, C, sc1, sc2, 0, work, 1, 0 );
}
