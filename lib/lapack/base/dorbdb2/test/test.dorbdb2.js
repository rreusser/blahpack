...
test( 'dorbdb2 column-major end-to-end against the m10_p3_q5 fixture', function t() {
	...
	const info = dorbdb2( 'column-major', 10, 3, 5, X11, LDX_PAD, X21, LDX_PAD, THETA, 1, PHI, 1, TAUP1, 1, TAUP2, 1, TAUQ1, 1, WORK, 1 );
...
test( 'dorbdb2 row-major end-to-end against the m10_p3_q5 fixture', function t() {
	...
	const info = dorbdb2( 'row-major', 10, 3, 5, X11, LDX_PAD, X21, LDX_PAD, THETA, 1, PHI, 1, TAUP1, 1, TAUP2, 1, TAUQ1, 1, WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
