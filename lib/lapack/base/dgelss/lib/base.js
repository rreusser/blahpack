...
import dormbr from '../../dormbr/lib/base.js';
...
const MNTHR_RATIO = 1.6;  // ILAENV(6, 'DGELSS') threshold ratio M/N
...
*/
function dgelss( M, N, nrhs, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, S, strideS, offsetS, rcond, rank, WORK, strideWork, offsetWork ) {
	let ldwork, iascl, ibscl, itauq, itaup, iwork, chunk, info, itau, thr, mm;
	let ie, il, bl, i;
	...
	// available from `offsetWork`. It drives the internal `lwork - iwork`
	// arguments and the block-vs-unblocked path selection (all paths compute the
	// same result; larger workspaces merely enable faster ones).
	...
	const anrm = dlange( 'max', M, N, A, strideA1, strideA2, offsetA, WORK, strideWork, offsetWork );
	iascl = 0;
	...
	// Scale B
	const bnrm = dlange( 'max', M, nrhs, B, strideB1, strideB2, offsetB, WORK, strideWork, offsetWork );
	ibscl = 0;
	...
	if ( M >= N ) {
		...
		dgebrd( mm, N, A, strideA1, strideA2, offsetA, S, strideS, offsetS, WORK, 1, ie, WORK, 1, itauq, WORK, 1, itaup, WORK, 1, iwork );
		...
		dgebrd( M, M, WORK, 1, ldwork, il, S, strideS, offsetS, WORK, 1, ie, WORK, 1, itauq, WORK, 1, itaup, WORK, 1, iwork );
		...
		dgebrd( M, N, A, strideA1, strideA2, offsetA, S, strideS, offsetS, WORK, 1, ie, WORK, 1, itauq, WORK, 1, itaup, WORK, 1, iwork );
