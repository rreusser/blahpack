...
interface Routine {
	...
	*/
	...
	/**
	* Solves a real symmetric positive definite banded system A*X = B, with optional equilibration, condition estimation, and error bounds using alternative indexing semantics.
	*
	* @param fact - `fact`
	* @param uplo - specifies whether the upper or lower triangular part is referenced
	* @param N - number of columns
