...
test( 'drotg: b=0 (identity rotation)', function t() {
	...
	const ab = new Float64Array( [ 3.0, 0.0 ] );
...
test( 'drotg: a=0 (swap rotation)', function t() {
	...
	const ab = new Float64Array( [ 0.0, 4.0 ] );
	const cs = new Float64Array( 2 );
	drotg( ab, 1, 0, cs, 1, 0 );
...
test( 'drotg: |b| > |a| (a=3, b=4)', function t() {
	...
	const ab = new Float64Array( [ 3.0, 4.0 ] );
	const cs = new Float64Array( 2 );
	drotg( ab, 1, 0, cs, 1, 0 );
	approx( ab[ 0 ], 5.0, 'r' );
...
test( 'drotg: |b| > |a|', function t() {
	...
	const ab = new Float64Array( [ 1.0, 3.0 ] );
	const cs = new Float64Array( 2 );
	const r = Math.sqrt( 10.0 );
	drotg( ab, 1, 0, cs, 1, 0 );
	approx( ab[ 0 ], r, 'r' );
	approx( cs[ 0 ], 1.0 / r, 'c' );
	approx( cs[ 1 ], 3.0 / r, 's' );
...
test( 'drotg: negative a, |a| > |b|', function t() {
	...
	const ab = new Float64Array( [ -5.0, 3.0 ] );
	const cs = new Float64Array( 2 );
	const r = -Math.sqrt( 34.0 );
	drotg( ab, 1, 0, cs, 1, 0 );
	approx( ab[ 0 ], r, 'r' );
	approx( cs[ 0 ], -5.0 / r, 'c' );
	approx( cs[ 1 ], 3.0 / r, 's' );
...
test( 'drotg: negative b, |b| >= |a|', function t() {
	...
	const ab = new Float64Array( [ 2.0, -6.0 ] );
	const cs = new Float64Array( 2 );
	const r = -Math.sqrt( 40.0 );
	drotg( ab, 1, 0, cs, 1, 0 );
	approx( ab[ 0 ], r, 'r' );
	approx( cs[ 0 ], 2.0 / r, 'c' );
	approx( cs[ 1 ], -6.0 / r, 's' );
...
test( 'drotg: both zero', function t() {
	const ab = new Float64Array( [ 0.0, 0.0 ] );
	const cs = new Float64Array( 2 );
	drotg( ab, 1, 0, cs, 1, 0 );
...
test( 'drotg: equal a and b', function t() {
	...
	const ab = new Float64Array( [ 5.0, 5.0 ] );
	const cs = new Float64Array( 2 );
	const r = 5.0 * Math.sqrt( 2.0 );
	drotg( ab, 1, 0, cs, 1, 0 );
	approx( ab[ 0 ], r, 'r' );
	approx( cs[ 0 ], 5.0 / r, 'c' );
	approx( cs[ 1 ], 5.0 / r, 's' );
...
test( 'drotg: stride and offset', function t() {
	...
	const ab = new Float64Array( [ 99.0, 3.0, 99.0, 4.0 ] );
	const cs = new Float64Array( [ 99.0, 0.0, 99.0, 0.0 ] );
	drotg( ab, 2, 1, cs, 2, 1 );
