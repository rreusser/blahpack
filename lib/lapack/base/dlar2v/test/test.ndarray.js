...
import dlar2v from './../lib/ndarray.js';
...
test( 'dlar2v: basic (N=4, unit strides)', function t() {
	...
	const y = new Float64Array( [ 5.0, 6.0, 7.0, 8.0 ] );
	const z = new Float64Array( [ 0.5, 1.0, 1.5, 2.0 ] );
	const c = new Float64Array( [ 0.8660254037844387, 0.7071067811865476, 0.5, 0.0 ] ); // eslint-disable-line max-len
	const s = new Float64Array( [ 0.5, 0.7071067811865476, 0.8660254037844387, 1.0 ] ); // eslint-disable-line max-len
...
test( 'dlar2v: n_zero (quick return)', function t() {
	...
	const z = new Float64Array( [ 0.5 ] );
	const c = new Float64Array( [ 0.5 ] );
	const s = new Float64Array( [ 0.8660254037844387 ] );
...
test( 'dlar2v: non-unit strides (INCX=2, INCC=2)', function t() {
	...
	const z = new Float64Array( [ 0.5, 0.0, 1.0, 0.0, 1.5 ] );
	const c = new Float64Array( [ 0.8, 0.0, 0.6, 0.0, 0.5 ] );
	const s = new Float64Array( [ 0.6, 0.0, 0.8, 0.0, 0.8660254037844387 ] );
...
test( 'dlar2v: identity rotation (c=1, s=0)', function t() {
	...
	const y = new Float64Array( [ 40.0, 50.0, 60.0 ] );
	const z = new Float64Array( [ 5.0, 10.0, 15.0 ] );
	const c = new Float64Array( [ 1.0, 1.0, 1.0 ] );
	const s = new Float64Array( [ 0.0, 0.0, 0.0 ] );
...
test( 'dlar2v: swap rotation (c=0, s=1)', function t() {
	...
	const z = new Float64Array( [ 0.5, 1.0 ] );
	const c = new Float64Array( [ 0.0, 0.0 ] );
	const s = new Float64Array( [ 1.0, 1.0 ] );
...
test( 'dlar2v: mixed strides (INCX=3, INCC=2)', function t() {
	...
	const x = new Float64Array( [ 2.0, 0.0, 0.0, 4.0 ] );
	const y = new Float64Array( [ 6.0, 0.0, 0.0, 8.0 ] );
	const z = new Float64Array( [ 1.0, 0.0, 0.0, 2.0 ] );
	const c = new Float64Array( [ 0.8, 0.0, 0.6 ] );
	const s = new Float64Array( [ 0.6, 0.0, 0.8 ] );
...
test( 'dlar2v: offset support', function t() {
	const x = new Float64Array( [ 999.0, 3.0, 4.0 ] );
	const y = new Float64Array( [ 999.0, 4.0, 5.0 ] );
	const z = new Float64Array( [ 999.0, 1.0, 2.0 ] );
	const c = new Float64Array( [ 999.0, 0.6, 0.8 ] );
	const s = new Float64Array( [ 999.0, 0.8, 0.6 ] );
