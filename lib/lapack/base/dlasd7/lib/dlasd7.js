...
function dlasd7( icompq, nl, nr, sqre, d, z, ZW, VF, VFW, VL, VLW, alpha, beta, DSIGMA, IDX, IDXP, IDXQ, PERM, GIVCOL, LDGCOL, GIVNUM, LDGNUM ) { // eslint-disable-line max-len, max-params
	const N = nl + nr + 1; // eslint-disable-line no-unused-vars
	return base( icompq, nl, nr, sqre, d, 1, 0, z, 1, 0, ZW, 1, 0, VF, 1, 0, VFW, 1, 0, VL, 1, 0, VLW, 1, 0, alpha, beta, DSIGMA, 1, 0, IDX, 1, 0, IDXP, 1, 0, IDXQ, 1, 0, PERM, 1, 0, GIVCOL, 1, LDGCOL, 0, GIVNUM, 1, LDGNUM, 0 ); // eslint-disable-line max-len
}
