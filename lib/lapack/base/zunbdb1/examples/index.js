...
import zunbdb1 from './../lib/index.js';
...
const X11 = new Complex128Array( 4 ); // 2x2 column-major
const X21 = new Complex128Array( 4 ); // 2x2 column-major
const v11 = reinterpret( X11, 0 );
const v21 = reinterpret( X21, 0 );

// Output / scalar arrays
const THETA = new Float64Array( 2 );
const PHI = new Float64Array( 1 );
const TAUP1 = new Complex128Array( 2 );
const TAUP2 = new Complex128Array( 2 );
const TAUQ1 = new Complex128Array( 2 );
