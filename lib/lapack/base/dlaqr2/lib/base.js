...
import dlanv2 from '../../dlanv2/lib/base.js';
import dlarfg from '../../dlarfg/lib/base.js';
import dlarf from '../../dlarf/lib/base.js';
import dgehrd from '../../dgehrd/lib/base.js';
import dormhr from '../../dormhr/lib/base.js';
import dtrexc from '../../dtrexc/lib/base.js';
...
*/
function dlaqr2( wantt, wantz, N, ktop, kbot, nw, H, strideH1, strideH2, offsetH, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ, SR, strideSR, offsetSR, SI, strideSI, offsetSI, V, strideV1, strideV2, offsetV, nh, T, strideT1, strideT2, offsetT, nv, WV, strideWV1, strideWV2, offsetWV, WORK, strideWork, offsetWork ) { // eslint-disable-line max-len
	return dlaqr23impl( null, wantt, wantz, N, ktop, kbot, nw, H, strideH1, strideH2, offsetH, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ, SR, strideSR, offsetSR, SI, strideSI, offsetSI, V, strideV1, strideV2, offsetV, nh, T, strideT1, strideT2, offsetT, nv, WV, strideWV1, strideWV2, offsetWV, WORK, strideWork, offsetWork );
}
...
* @returns {Object} { ns, nd }
*/
function dlaqr23impl( dlaqr4fn, wantt, wantz, N, ktop, kbot, nw, H, strideH1, strideH2, offsetH, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ, SR, strideSR, offsetSR, SI, strideSI, offsetSI, V, strideV1, strideV2, offsetV, nh, T, strideT1, strideT2, offsetT, nv, WV, strideWV1, strideWV2, offsetWV, WORK, strideWork, offsetWork ) { // eslint-disable-line max-len
	let trxResult, sorted, tauArr, infqr, bulge, nmin, ilst, ifst, kend, krow;
	let kcol, ltop, tau, foo, evi, evk, lv2, kln, ns, nd, aa, bb, cc, dd, s, i;
	let j, k;
	...
	const jw = Math.min( nw, kbot - ktop + 1 );
	...
	if ( dlaqr4fn ) {
		...
		nmin = 12;
		if ( jw > nmin ) {
			infqr = dlaqr4fn( true, true, jw, 1, jw, T, strideT1, strideT2, offsetT, SR, strideSR, offsetSR + ( kwtop - 1 ) * strideSR, SI, strideSI, offsetSI + ( kwtop - 1 ) * strideSI, 1, jw, V, strideV1, strideV2, offsetV, WORK, strideWork, offsetWork );
		} else {
	...
	if ( ns < jw || s === ZERO ) {
		if ( ns > 1 && s !== ZERO ) {
			...
			dgehrd( jw, 1, ns, T, strideT1, strideT2, offsetT, WORK, strideWork, offsetWork, WORK, strideWork, offsetWork + jw * strideWork );
		}
		...
		if ( ns > 1 && s !== ZERO ) {
			dormhr( 'right', 'no-transpose', jw, ns, 1, ns, T, strideT1, strideT2, offsetT, WORK, strideWork, offsetWork, V, strideV1, strideV2, offsetV, WORK, strideWork, offsetWork + jw * strideWork );
		}
