...
test( 'zlarnv: IDIST=1, larger N with different seed', function t() {
	...
	const iseed = new Int32Array( [ 42, 7, 13, 99 ] );
	const tc = idist1_large_seed;
