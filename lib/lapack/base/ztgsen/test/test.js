...
test( 'ztgsen: ijob=1 select=[T,F,T,F] wantq=T wantz=T N=4 (condition numbers)', function t() { // eslint-disable-line max-len
	...
	r = ztgsen( 1, true, true, SEL, 1, 0, 4, ab.A, 1, 4, 0, ab.B, 1, 4, 0, ALPHA, 1, 0, BETA, 1, 0, Q, 1, 4, 0, Z, 1, 4, 0, 0, 1.0, 1.0, DIF, 1, 0, WK, 1, 0, IWK, 1, 0 ); // eslint-disable-line max-len
...
test( 'ztgsen: ijob=2 (DIF via direct solve)', function t() {
	...
	var r = ztgsen( 2, true, true, SEL, 1, 0, 4, ab.A, 1, 4, 0, ab.B, 1, 4, 0, ALPHA, 1, 0, BETA, 1, 0, Q, 1, 4, 0, Z, 1, 4, 0, 0, 1.0, 1.0, DIF, 1, 0, WK, 1, 0, IWK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( r.info, 0, 'info' );
...
test( 'ztgsen: ijob=3 (DIF via condition estimation)', function t() {
	...
	var WK = new Complex128Array( 256 );
	var IWK = new Int32Array( 256 );
	var r = ztgsen( 3, true, true, SEL, 1, 0, 4, ab.A, 1, 4, 0, ab.B, 1, 4, 0, ALPHA, 1, 0, BETA, 1, 0, Q, 1, 4, 0, Z, 1, 4, 0, 0, 1.0, 1.0, DIF, 1, 0, WK, 1, 0, IWK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( r.info, 0, 'info' );
	assert.equal( r.m, 2, 'M' );
	assertClose( DIF[ 0 ], tc.DIF[ 0 ], 1e-10, 'DIF[0]' );
	assertClose( DIF[ 1 ], tc.DIF[ 1 ], 1e-10, 'DIF[1]' );
...
test( 'ztgsen: ijob=4 (PL,PR + DIF direct)', function t() {
	...
	var WK = new Complex128Array( 256 );
	var IWK = new Int32Array( 256 );
	var r = ztgsen( 4, true, true, SEL, 1, 0, 4, ab.A, 1, 4, 0, ab.B, 1, 4, 0, ALPHA, 1, 0, BETA, 1, 0, Q, 1, 4, 0, Z, 1, 4, 0, 0, 1.0, 1.0, DIF, 1, 0, WK, 1, 0, IWK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( r.info, 0, 'info' );
	assert.equal( r.m, 2, 'M' );
	assertClose( r.pl, tc.PL, 1e-10, 'PL' );
	assertClose( r.pr, tc.PR, 1e-10, 'PR' );
...
test( 'ztgsen: ijob=5 (PL,PR + DIF estimated)', function t() {
	...
	var WK = new Complex128Array( 256 );
	var IWK = new Int32Array( 256 );
	var r = ztgsen( 5, true, true, SEL, 1, 0, 4, ab.A, 1, 4, 0, ab.B, 1, 4, 0, ALPHA, 1, 0, BETA, 1, 0, Q, 1, 4, 0, Z, 1, 4, 0, 0, 1.0, 1.0, DIF, 1, 0, WK, 1, 0, IWK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( r.info, 0, 'info' );
	assert.equal( r.m, 2, 'M' );
	assertClose( r.pl, tc.PL, 1e-10, 'PL' );
	assertClose( r.pr, tc.PR, 1e-10, 'PR' );
...
test( 'ztgsen: ijob=2 all selected (M=N early return with DIF)', function t() {
	...
	var r = ztgsen( 2, true, true, SEL, 1, 0, 3, A, 1, 3, 0, B, 1, 3, 0, ALPHA, 1, 0, BETA, 1, 0, Q, 1, 3, 0, Z, 1, 3, 0, 0, 1.0, 1.0, DIF, 1, 0, WK, 1, 0, IWK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( r.info, 0, 'info' );
	assert.equal( r.m, 3, 'M' );
	assertClose( DIF[ 0 ], tc.DIF[ 0 ], 1e-10, 'DIF[0]' );
	assertClose( DIF[ 1 ], tc.DIF[ 1 ], 1e-10, 'DIF[1]' );
...
test( 'ztgsen: ijob=1 none selected (M=0 early return with PL PR)', function t() { // eslint-disable-line max-len
	...
	var WK = new Complex128Array( 64 );
	var IWK = new Int32Array( 64 );
	var r = ztgsen( 1, true, true, SEL, 1, 0, 3, A, 1, 3, 0, B, 1, 3, 0, ALPHA, 1, 0, BETA, 1, 0, Q, 1, 3, 0, Z, 1, 3, 0, 0, 1.0, 1.0, DIF, 1, 0, WK, 1, 0, IWK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( r.info, 0, 'info' );
	assert.equal( r.m, 0, 'M' );
	assertClose( r.pl, tc.PL, 1e-10, 'PL' );
	assertClose( r.pr, tc.PR, 1e-10, 'PR' );
