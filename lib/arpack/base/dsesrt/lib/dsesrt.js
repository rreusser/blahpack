...
* @param {Float64Array} A - companion matrix (column-major) whose columns are permuted alongside `x` when `apply` is `true`
...
*/
function dsesrt( which, apply, N, x, strideX, na, A, lda ) {
	...
	return base( which, apply, N, x, strideX, stride2offset( N, strideX ), na, A, 1, lda, 0 );
}
