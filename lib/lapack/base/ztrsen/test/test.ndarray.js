...
test( 'ztrsen: job=N compq=V select 1,3', function t() {
	...
	var info = ztrsen( 'none', 'update', SELECT, 1, 0, N, tm.data, 1, N, 0, qm.data, 1, N, 0, W, 1, 0, M, s, sep, WORK, 1, 0 );
...
test( 'ztrsen: job=E compq=V select 1,3', function t() {
	...
	var info = ztrsen( 'eigenvalues', 'update', SELECT, 1, 0, N, tm.data, 1, N, 0, qm.data, 1, N, 0, W, 1, 0, M, s, sep, WORK, 1, 0 );
...
test( 'ztrsen: job=V compq=V select 1,3', function t() {
	...
	var info = ztrsen( 'subspace', 'update', SELECT, 1, 0, N, tm.data, 1, N, 0, qm.data, 1, N, 0, W, 1, 0, M, s, sep, WORK, 1, 0 );
...
test( 'ztrsen: job=B compq=V select 1,3', function t() {
	...
	var info = ztrsen( 'both', 'update', SELECT, 1, 0, N, tm.data, 1, N, 0, qm.data, 1, N, 0, W, 1, 0, M, s, sep, WORK, 1, 0 );
...
test( 'ztrsen: job=N compq=N select 2', function t() {
	...
	var info = ztrsen( 'none', 'none', SELECT, 1, 0, N, tm.data, 1, N, 0, qm.data, 1, N, 0, W, 1, 0, M, s, sep, WORK, 1, 0 );
...
test( 'ztrsen: N=1 quick return', function t() {
	...
	var info = ztrsen( 'both', 'update', SELECT, 1, 0, N, T, 1, 1, 0, Q, 1, 1, 0, W, 1, 0, M, s, sep, WORK, 1, 0 );
