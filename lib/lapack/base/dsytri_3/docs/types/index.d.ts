...
interface Routine {
	...
	*/
	...
	/**
	* Computes the inverse of a real symmetric indefinite matrix `A` using the factorization from `dsytrf_rk`. Blocked driver that picks a block size and forwards to `dsytri_3x`, using alternative indexing semantics using alternative indexing semantics.
	*
	* @param uplo - specifies whether the upper or lower triangular part is referenced
	* @param N - number of columns
	* @param A - `A`
