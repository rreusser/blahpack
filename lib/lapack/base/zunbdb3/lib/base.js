...
function zunbdb3( M, P, Q, X11, strideX111, strideX112, offsetX11, X21, strideX211, strideX212, offsetX21, THETA, strideTHETA, offsetTHETA, PHI, stridePHI, offsetPHI, TAUP1, strideTAUP1, offsetTAUP1, TAUP2, strideTAUP2, offsetTAUP2, TAUQ1, strideTAUQ1, offsetTAUQ1, WORK, strideWork, offsetWork ) {
	let oX11iiC, oX21iiC, oX11ii, oX21ii, oTAUP1, oTAUP2, oTAUQ1, theta, phi;
	let n1, n2, c, i, s;
	...
	for ( i = 0; i < M - P; i++ ) {
		...
		if ( i > 0 ) {
			...
			// NOTE: This ZDROT uses strideX112 for both X11 and X21, mirroring a likely typo in reference zunbdb3.f (LDX11 vs LDX21). When the two leading dimensions differ, the result will diverge from a "correct" implementation. The wrapper picks matching strides so this never triggers in normal usage.
