...
function dtpmqrt( order, side, trans, M, N, K, l, nb, V, LDV, T, LDT, A, LDA, B, LDB, WORK, strideWork ) {
	let ldvq, ldaq, sv1, sv2, st1, st2, sa1, sa2, sb1, sb2;
	...
	if ( WORK === null || WORK === void 0 ) {
		...
		// logically nb-by-N (`nb*N`) for side='left' or M-by-nb (`M*nb`) for
		// side='right'.
		const need = ( side === 'left' ) ? ( nb * N ) : ( M * nb );
		if ( WORK.length < need ) {
