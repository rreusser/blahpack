...
*/
function dstevr( jobz, range, N, d, strideD, offsetD, e, strideE, offsetE, vl, vu, il, iu, abstol, out, w, strideW, offsetW, Z, strideZ1, strideZ2, offsetZ, ISUPPZ, strideISUPPZ, offsetISUPPZ, WORK, strideWork, offsetWork, IWORK, strideIWork, offsetIWork ) { // eslint-disable-line max-len, max-params
	let iscale, sigma, order, itmp1, info, imax, tmp1, vll, vuu, jj, i, j, M;
	...
	const tnrm = dlanst( 'max', N, d, strideD, offsetD, e, strideE, offsetE );
	...
	const indiwo = indisp + N; // Fortran: INDIWO = INDISP + N (overlaps INDIFL)
