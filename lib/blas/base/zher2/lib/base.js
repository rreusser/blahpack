...
function zher2( uplo, N, alpha, x, strideX, offsetX, y, strideY, offsetY, A, strideA1, strideA2, offsetA ) {
	let upper, alphaR, alphaI, base, sa1, sa2, Av, xv, yv, oA, oX, oY, sx, sy;
	let nz0, nz1, nz2, nz3, x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i, y0r, y0i;
	let y1r, y1i, y2r, y2i, y3r, y3i, t1r0, t1i0, t1r1, t1i1, t1r2, t1i2, t1r3;
	let t1i3, t2r0, t2i0, t2r1, t2i1, t2r2, t2i2, t2r3, t2i3, t1r, t1i, t2r;
	let t2i, xr, xi, yr, yi, a0, a1, a2, a3, ac, jx, jy, ix, iy, d, i, j, c;
	...
	*/
	function colScalar( lo, hi ) {
		let jjx, jjy, cxr, cxi, cyr, cyi, s1r, s1i, s2r, s2i, kk, aii, iix, iiy;
		let rr;
	...
	*/
	function rowScalar( lo, hi ) {
		let iix, iiy, jjx, jjy, pxr, pxi, pyr, pyi, cxr, cxi, cyr, cyi, s1r;
		let s1i, s2r, s2i, aii, dd, rr, cc;
