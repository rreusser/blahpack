...
import zlaqp2 from './../lib/ndarray.js';
...
import square_collinear from './fixtures/square_collinear.json' with { type: 'json' };
...
test( 'zlaqp2: basic 3x3 matrix', function t() {
	...
	const VN1 = colNorms( 3, 3, 0, A, LDA, 0 );
...
test( 'zlaqp2: 4x3 matrix', function t() {
	...
	const JPVT = new Int32Array( [ 1, 2, 3 ] );
	const TAU = new Complex128Array( 3 );
	const VN1 = colNorms( 4, 3, 0, A, LDA, 0 );
	const VN2 = new Float64Array( VN1 );
	const WORK = new Complex128Array( 20 );
...
test( 'zlaqp2: with offset=1', function t() {
	...
	const JPVT = new Int32Array( [ 1, 2, 3 ] );
	const TAU = new Complex128Array( 3 );
	const VN1 = colNorms( 4, 3, 1, A, LDA, 0 );
	const VN2 = new Float64Array( VN1 );
	const WORK = new Complex128Array( 20 );
...
test( 'zlaqp2: 1x1 matrix', function t() {
	...
	const VN1 = new Float64Array( [ 5.0 ] );
	const VN2 = new Float64Array( [ 5.0 ] );
	const WORK = new Complex128Array( 20 );
...
test( 'zlaqp2: collinear columns (norm recomputation)', function t() {
	...
	const JPVT = new Int32Array( [ 1, 2, 3 ] );
	const TAU = new Complex128Array( 3 );
	const VN1 = colNorms( 6, 3, 0, A, LDA, 0 );
	const VN2 = new Float64Array( VN1 );
	const WORK = new Complex128Array( 20 );
...
test( 'zlaqp2: offset collinear last row (offpi=M-1 zero norm path)', function t() {
	...
	const JPVT = new Int32Array( [ 1, 2, 3 ] );
	const TAU = new Complex128Array( 3 );
	const VN1 = colNorms( 4, 3, 2, A, LDA, 0 );
	const VN2 = new Float64Array( VN1 );
	const WORK = new Complex128Array( 20 );
	...
	const perm = Array.from( JPVT ).sort( function cmp( a, b ) { return a - b; } );
