...
test( 'dzasum: stride2', function t() {
	...
	const tc = stride2;
	const zx = new Complex128Array( [ 1.0, 1.0, 99.0, 99.0, 2.0, 3.0 ] );
	const result = dzasum( 2, zx, 2, 0 );
	assertClose( result, tc.result, 1e-14, 'result' );
});
