...
function runLeft( name, trans ) {
	...
	info = zlamtsqr( 'left', trans, tc.M, tc.N, tc.K, tc.MB, tc.NB, A, 1, tc.M, 0, T, 1, tc.LDT, 0, C, 1, tc.M, 0, WORK, 1, 0 );
...
function runRight( name, trans ) {
	...
	info = zlamtsqr( 'right', trans, tc.M, tc.N, tc.K, tc.MB, tc.NB, A, 1, tc.N, 0, T, 1, tc.LDT, 0, C, 1, tc.M, 0, WORK, 1, 0 );
...
test( 'zlamtsqr quick-return: M=0', function t() {
	...
	info = zlamtsqr( 'left', 'no-transpose', 0, 4, 0, 4, 2, A, 1, 1, 0, T, 1, 1, 0, C, 1, 1, 0, WORK, 1, 0 );
...
test( 'zlamtsqr quick-return: N=0', function t() {
	...
	T = new Complex128Array( 1 );
	C = new Complex128Array( 1 );
	info = zlamtsqr( 'left', 'no-transpose', 4, 0, 2, 4, 2, A, 1, 4, 0, T, 1, 2, 0, C, 1, 4, 0, WORK, 1, 0 );
...
test( 'zlamtsqr quick-return: K=0', function t() {
	...
	info = zlamtsqr( 'left', 'no-transpose', 4, 4, 0, 4, 2, A, 1, 1, 0, T, 1, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
