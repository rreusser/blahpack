...
import dlaqz1 from './../lib/dlaqz1.js';
...
test( 'dlaqz1 returns v', function t() {
	const A = new Float64Array( [ 4, 2, 0, 1, 5, 3, 0.5, 1, 6 ] );
	const B = new Float64Array( [ 2, 0, 0, 0.5, 3, 0, 0.1, 0.5, 4 ] );
	const v = new Float64Array( 3 );
	const out = dlaqz1( 'column-major', A, 3, B, 3, 1, 2, 0, 1, 1, v, 1 );
