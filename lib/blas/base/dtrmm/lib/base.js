...
function dtrmm( side, uplo, transa, diag, M, N, alpha, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB ) {
	...
	let b00, b01, b02, b03, b10, b11, b12, b13, b20, b21, b22, b23, b30, b31;
	let b32, b33;
	...
	let t01, t02, t03, t12, t13, t23, d0, d1, d2, d3, a0, a1, a2, a3, e0, e1;
	let e2, e3, pa0, pa1, pa2, pa3, pb0, pb1, pb2, pb3, temp, eup, ea1, ea2;
	let eb1, eb2, tmp, pd, pb, pw, pa, nr, nc, i0, i, j, l;
	...
	// Transposing A swaps its strides and flips the stored triangle. Conjugation
	// is a no-op for a real routine, so every transpose form is handled the same
	// way; branch on "not no-transpose" (matching the reference's
	// LSAME(TRANSA,'N')):
