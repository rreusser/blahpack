...
import zhpgst from './../lib/ndarray.js';
...
const B3U = [ 10, 0, 2, 1, 8, 0, 3, -2, 1, 1, 6, 0 ];
const B3L = [ 10, 0, 2, -1, 3, 2, 8, 0, 1, -1, 6, 0 ];
const A3U = [ 12, 0, 3, 2, 9, 0, 1, -1, 2, 3, 7, 0 ];
const A3L = [ 12, 0, 3, -2, 1, 1, 9, 0, 2, -3, 7, 0 ];

// 4x4 Hermitian matrices for tests 7-12:
const B4U = [ 20, 0, 3, 1, 15, 0, 1, -2, 2, 3, 12, 0, 4, 1, 1, -1, 3, 2, 10, 0 ];
const B4L = [ 20, 0, 3, -1, 1, 2, 4, -1, 15, 0, 2, -3, 1, 1, 12, 0, 3, -2, 10, 0 ]; // eslint-disable-line max-len
const A4U = [ 18, 0, 5, 2, 14, 0, 2, -1, 4, 3, 11, 0, 3, 1, 1, -2, 2, 1, 8, 0 ];
const A4L = [ 18, 0, 5, -2, 2, 1, 3, -1, 14, 0, 4, -3, 1, 2, 11, 0, 2, -1, 8, 0 ];
...
test( 'zhpgst: itype1_upper_3', function t() {
	...
	const ap = c128( A3U );
	const info = zhpgst( 1, 'upper', 3, ap, 1, 0, bp, 1, 0 );
...
test( 'zhpgst: itype1_lower_3', function t() {
	...
	const ap = c128( A3L );
	const info = zhpgst( 1, 'lower', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype2_upper_3', function t() {
	...
	zpptrf( 'upper', 3, bp, 1, 0 );
	const ap = c128( A3U );
	const info = zhpgst( 2, 'upper', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype2_lower_3', function t() {
	...
	zpptrf( 'lower', 3, bp, 1, 0 );
	const ap = c128( A3L );
	const info = zhpgst( 2, 'lower', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype3_upper_3', function t() {
	...
	zpptrf( 'upper', 3, bp, 1, 0 );
	const ap = c128( A3U );
	const info = zhpgst( 3, 'upper', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype3_lower_3', function t() {
	...
	zpptrf( 'lower', 3, bp, 1, 0 );
	const ap = c128( A3L );
	const info = zhpgst( 3, 'lower', 3, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype1_upper_4', function t() {
	...
	const ap = c128( A4U );
	const info = zhpgst( 1, 'upper', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype1_lower_4', function t() {
	...
	const ap = c128( A4L );
	const info = zhpgst( 1, 'lower', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype2_upper_4', function t() {
	...
	zpptrf( 'upper', 4, bp, 1, 0 );
	const ap = c128( A4U );
	const info = zhpgst( 2, 'upper', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype2_lower_4', function t() {
	...
	zpptrf( 'lower', 4, bp, 1, 0 );
	const ap = c128( A4L );
	const info = zhpgst( 2, 'lower', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype3_upper_4', function t() {
	...
	zpptrf( 'upper', 4, bp, 1, 0 );
	const ap = c128( A4U );
	const info = zhpgst( 3, 'upper', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: itype3_lower_4', function t() {
	...
	zpptrf( 'lower', 4, bp, 1, 0 );
	const ap = c128( A4L );
	const info = zhpgst( 3, 'lower', 4, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-13, 'AP' );
});
...
test( 'zhpgst: n_zero (quick return)', function t() {
	...
	const ap = c128( [ 0, 0 ] );
	const bp = c128( [ 0, 0 ] );
	const info = zhpgst( 1, 'upper', 0, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
});
...
test( 'zhpgst: n_one_itype1_upper', function t() {
	...
	const ap = c128( [ 12, 0 ] );
	const info = zhpgst( 1, 'upper', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
...
test( 'zhpgst: n_one_itype1_lower', function t() {
	...
	const ap = c128( [ 25, 0 ] );
	const info = zhpgst( 1, 'lower', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-14, 'AP' );
});
...
test( 'zhpgst: n_one_itype2', function t() {
	...
	zpptrf( 'upper', 1, bp, 1, 0 );
	const ap = c128( [ 5, 0 ] );
	const info = zhpgst( 2, 'upper', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-14, 'AP' );
});
...
test( 'zhpgst: n_one_itype3', function t() {
	...
	zpptrf( 'lower', 1, bp, 1, 0 );
	const ap = c128( [ 5, 0 ] );
	const info = zhpgst( 3, 'lower', 1, ap, 1, 0, bp, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( reinterpret( ap, 0 ), tc.AP, 1e-14, 'AP' );
});
