...
*/
function dorm22( order, side, trans, M, N, n1, n2, Q, LDQ, C, LDC, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	var sq1;
	var sq2;
	var sc1;
	var sc2;
	...
	if ( WORK === null || WORK === void 0 ) {
		WORK = new Float64Array( max( 1, M*N ) );
		strideWork = 1;
	}
	return base( side, trans, M, N, n1, n2, Q, sq1, sq2, 0, C, sc1, sc2, 0, WORK, strideWork, 0 ); // eslint-disable-line max-len
}
