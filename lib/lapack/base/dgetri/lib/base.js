...
* @param {Float64Array} WORK - workspace array of length at least max(1, N); N*NB enables the blocked path
* @param {integer} strideWork - stride for WORK
* @param {NonNegativeInteger} offsetWork - starting index for WORK
* @returns {integer} info - 0 if successful, k>0 if U(k,k) is exactly zero (singular)
*/
function dgetri( N, A, strideA1, strideA2, offsetA, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, offsetWork ) {
	var ldwork;
	var nbmin;
	var lwork;
	var info;
