...
/**
* Solves a system of linear equations A * X = B with a complex Hermitian matrix A using the factorization from `zhetrf`.
*
...
*/
function zhetrs( order, uplo, N, nrhs, A, LDA, IPIV, strideIPIV, B, LDB ) {
	let sa1, sa2, sb1, sb2;
