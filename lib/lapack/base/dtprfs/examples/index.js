...
// b = A * [1, 2, 3] = [13, 23, 18]
const B = new Float64Array( [ 13.0, 23.0, 18.0 ] );
...
const info = dtprfs.ndarray( 'upper', 'no-transpose', 'non-unit', 3, 1, AP, 1, 0, B, 1, 3, 0, X, 1, 3, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
