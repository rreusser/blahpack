...
const EPS = 1.1102230246251565e-16; // DLAMCH('Epsilon') = Number.EPSILON / 2

// Scaling constants derived from DLAMCH('SafMin')=2.2250738585072014e-308 and DLAMCH('Base')=2:
const SMALL1 = 4.464794497196387e-103;
const SMINV1 = 2.2397447421778042e+102;
const SMALL2 = 1.9934389902195135e-205;
const SMINV2 = 5.016456510113119e+204;
...
function dlaed6( kniter, orgati, rho, d, strideD, offsetD, z, strideZ, offsetZ, finit, tau ) {
	let erretm, sclfac, sclinv, scale, temp1, temp2, temp3, temp4, niter, temp;
	let info, lbd, ubd, eta, ddf, fc, df, a, b, c, f, i;
	...
	const dscale = new Float64Array( 3 );
	const zscale = new Float64Array( 3 );
