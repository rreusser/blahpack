...
import zhetf2Rook from './../lib/zhetf2_rook.js';
import Complex128Array from '@stdlib/array/complex128/lib/index.js';
import Int32Array2 from '@stdlib/array/int32/lib/index.js';
...
test( 'zhetf2Rook accepts column-major and returns 0 for valid input', function t() {
	const A = new Complex128Array([ 4, 0, 0, 0, 0, 0, 1, 0, 3, 0, 0, 0, 0.5, -0.25, 0.5, 1, 5, 0 ]);
	const IPIV = new Int32Array2( 3 );
	const info = zhetf2Rook( 'column-major', 'upper', 3, A, 3, IPIV, 1, 0 );
...
test( 'zhetf2Rook accepts row-major and returns 0 for valid input', function t() {
	...
	const A = new Complex128Array([ 4, 0, 1, -0.5, 0.5, 0.25, 0, 0, 3, 0, 0.5, -1, 0, 0, 0, 0, 5, 0 ]);
	const IPIV = new Int32Array2( 3 );
	const info = zhetf2Rook( 'row-major', 'lower', 3, A, 3, IPIV, 1, 0 );
	assert.equal( info, 0, 'info' );
});
