...
*/
function zheev( order, jobz, uplo, N, A, LDA, w, strideW, WORK, strideWork, RWORK, strideRWork ) {
	let sa1, sa2;
	...
	const owv = stride2offset( N, strideW );
	...
	const owk = stride2offset( N, strideWork );
	const or = stride2offset( N, strideRWork );
	return base( jobz, uplo, N, A, sa1, sa2, 0, w, strideW, owv, WORK, strideWork, owk, RWORK, strideRWork, or );
}
