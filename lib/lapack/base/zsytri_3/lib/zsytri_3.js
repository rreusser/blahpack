...
*/
function zsytri3( order, uplo, N, A, LDA, e, strideE, IPIV, strideIPIV, offsetIPIV, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	let sa1, sa2;
	...
	return base( uplo, N, A, sa1, sa2, 0, e, strideE, 0, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, 0 );
}
