...
function runCase( tc, jobvsl, jobvsr ) {
	...
	const res = zgges( jobvsl, jobvsr, 'not-sorted', nosel, N, A, 1, N, 0, B, 1, N, 0, ALPHA, 1, 0, BETA, 1, 0, VSL, 1, N, 0, VSR, 1, N, 0 ); // eslint-disable-line max-len
...
test( 'zgges returns info=0 and sdim=0 for N=0', function t() {
	const res = zgges( 'no-vectors', 'no-vectors', 'not-sorted', nosel, 0, new Complex128Array( 0 ), 1, 0, 0, new Complex128Array( 0 ), 1, 0, 0, new Complex128Array( 0 ), 1, 0, new Complex128Array( 0 ), 1, 0, new Complex128Array( 0 ), 1, 0, 0, new Complex128Array( 0 ), 1, 0, 0); // eslint-disable-line max-len
...
test( 'zgges: small matrix triggers A-scaling (ilascl)', function t() {
	...
	const VSL = new Complex128Array( N * N );
	const VSR = new Complex128Array( N * N );
	const res = zgges( 'compute-vectors', 'compute-vectors', 'not-sorted', nosel, N, A, 1, N, 0, B, 1, N, 0, ALPHA, 1, 0, BETA, 1, 0, VSL, 1, N, 0, VSR, 1, N, 0 ); // eslint-disable-line max-len
...
test( 'zgges: sorted eigenvalues with selection function', function t() {
	...
	const res = zgges( 'compute-vectors', 'compute-vectors', 'sorted', selctg, N, A, 1, N, 0, B, 1, N, 0, ALPHA, 1, 0, BETA, 1, 0, VSL, 1, N, 0, VSR, 1, N, 0 ); // eslint-disable-line max-len
	assert.equal( res.info, 0, 'info' );
