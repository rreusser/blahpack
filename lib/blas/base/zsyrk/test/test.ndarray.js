...
test( 'zsyrk: upper_no_trans', function t() {
	...
	const A = new Complex128Array( [ 1, 0.5, 2, -1, 3, 1, 4, 2, 5, 0, 6, -0.5 ] );
	const C = new Complex128Array( 9 ); // 3x3 zeroed
...
test( 'zsyrk: upper_trans', function t() {
	...
	const A = new Complex128Array( [ 1, 0.5, 2, -1, 3, 1, 4, 2, 5, 0, 6, -0.5 ] );
	const C = new Complex128Array( 4 ); // 2x2 zeroed
...
test( 'zsyrk: alpha_zero (scale C by beta only)', function t() {
	...
	const A = new Complex128Array( 6 ); // doesn't matter
...
test( 'zsyrk: n_zero (quick return)', function t() {
	...
	const C = new Complex128Array( [ 99, 0 ] );
...
test( 'zsyrk: alpha_zero_beta_zero (zero out upper)', function t() {
	...
	const C = new Complex128Array( [ 99, 88, 77, 66, 55, 44, 33, 22 ] );
...
test( 'zsyrk: alpha_zero_beta_one (no-op, lower)', function t() {
	...
	const A = new Complex128Array( 4 );
	const C = new Complex128Array( [ 42, 13, 7, 8, 9, 10, 11, 12 ] );
...
test( 'zsyrk: returns C', function t() {
	...
	const A = new Complex128Array( [ 1, 0, 2, 0 ] );
	const C = new Complex128Array( 1 );
	const ret = zsyrk( 'upper', 'no-transpose', 1, 2, new Complex128( 1, 0 ), A, 1, 1, 0, new Complex128( 0, 0 ), C, 1, 1, 0 ); // eslint-disable-line max-len
...
test( 'zsyrk: K=0 with beta!=1 still scales C', function t() {
	...
	const C = new Complex128Array( [ 3, 4 ] );
...
test( 'zsyrk: lower alpha_zero scaling', function t() {
	...
	const A = new Complex128Array( 4 );
	const C = new Complex128Array( [ 2, 0, 4, 0, 6, 0, 8, 0 ] );
...
test( 'zsyrk: upper trans with nonzero beta', function t() {
	...
	const A = new Complex128Array( [ 1, 0.5, 2, -1, 3, 1, 4, 2, 5, 0, 6, -0.5 ] );
	const C = new Complex128Array( [ 1, 1, 0, 0, 0, 0, 2, -1 ] );
...
test( 'zsyrk: K=0 alpha=1 beta=1 quick return', function t() {
	...
	const A = new Complex128Array( 0 );
	const C = new Complex128Array( [ 5, 6 ] );
...
test( 'zsyrk: complex beta scaling with alpha_zero lower', function t() {
	...
	const A = new Complex128Array( 4 );
	const C = new Complex128Array( [ 1, 0, 0, 1, 2, 0, 3, 0 ] );
