...
test( 'ztgsna: job=both howmny=all N=4', function t() {
	...
	const res = ztgsna( 'both', 'all', SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, VL, 1, N, 0, VR, 1, N, 0, s, 1, 0, DIF, 1, 0, N, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'ztgsna: job=eigenvalues howmny=all N=3', function t() {
	...
	const WORK = new Complex128Array( 128 );
	const IWORK = new Int32Array( 32 );
	const res = ztgsna( 'eigenvalues', 'all', SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, VL, 1, N, 0, VR, 1, N, 0, s, 1, 0, DIF, 1, 0, N, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'ztgsna: job=eigenvectors howmny=all N=3', function t() {
	...
	const WORK = new Complex128Array( 128 );
	const IWORK = new Int32Array( 32 );
	const res = ztgsna( 'eigenvectors', 'all', SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, VL, 1, N, 0, VR, 1, N, 0, s, 1, 0, DIF, 1, 0, N, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'ztgsna: job=both howmny=selected select=[1,0,1,0] N=4', function t() {
	...
	const WORK = new Complex128Array( 128 );
	const IWORK = new Int32Array( 32 );
	const res = ztgsna( 'both', 'selected', SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, VL, 1, N, 0, VR, 1, N, 0, s, 1, 0, DIF, 1, 0, 2, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'ztgsna: N=0 quick return', function t() {
	...
	const res = ztgsna( 'both', 'all', SELECT, 1, 0, 0, A, 1, 1, 0, B, 1, 1, 0, VL, 1, 1, 0, VR, 1, 1, 0, s, 1, 0, DIF, 1, 0, 0, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'ztgsna: howmny=selected with all SELECT[i]=0 (m=0)', function t() {
	...
	const WORK = new Complex128Array( 128 );
	const IWORK = new Int32Array( 32 );
	const res = ztgsna( 'both', 'selected', SELECT, 1, 0, N, A, 1, N, 0, B, 1, N, 0, VL, 1, N, 0, VR, 1, N, 0, s, 1, 0, DIF, 1, 0, N, 0, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( res.info, 0, 'info' );
...
test( 'ztgsna: throws TypeError for invalid job', function t() {
	assert.throws( function throws() {
		...
		const WORK = new Complex128Array( 128 );
		const IWORK = new Int32Array( 32 );
		ztgsna( 'invalid', 'all', SELECT, 1, 0, 1, A, 1, 1, 0, B, 1, 1, 0, VL, 1, 1, 0, VR, 1, 1, 0, s, 1, 0, DIF, 1, 0, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
	}, TypeError );
} );
...
test( 'ztgsna: throws TypeError for invalid howmny', function t() {
	assert.throws( function throws() {
		...
		const WORK = new Complex128Array( 128 );
		const IWORK = new Int32Array( 32 );
		ztgsna( 'both', 'invalid', SELECT, 1, 0, 1, A, 1, 1, 0, B, 1, 1, 0, VL, 1, 1, 0, VR, 1, 1, 0, s, 1, 0, DIF, 1, 0, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
	}, TypeError );
} );
...
test( 'ztgsna: throws RangeError for negative N', function t() {
	assert.throws( function throws() {
		...
		const WORK = new Complex128Array( 128 );
		const IWORK = new Int32Array( 32 );
		ztgsna( 'both', 'all', SELECT, 1, 0, -1, A, 1, 1, 0, B, 1, 1, 0, VL, 1, 1, 0, VR, 1, 1, 0, s, 1, 0, DIF, 1, 0, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
	}, RangeError );
} );
