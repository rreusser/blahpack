...
function zggsvp3( jobu, jobv, jobq, M, p, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, tola, tolb, K, l, U, strideU1, strideU2, offsetU, V, strideV1, strideV2, offsetV, Q, strideQ1, strideQ2, offsetQ, IWORK, strideIWork, offsetIWork, RWORK, strideRWork, offsetRWork, TAU, strideTAU, offsetTAU, WORK, strideWork, offsetWork ) { // eslint-disable-line max-len
	...
	// Caller owns the workspace; derive the available length (in complex elements) from the provided array.
	...
	//                                       (  0   0  )
	zgeqp3( p, N, B, strideB1, strideB2, offsetB, IWORK, strideIWork, offsetIWork, TAU, strideTAU, offsetTAU, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork );
	...
	zgeqp3( M, N - lval, A, strideA1, strideA2, offsetA, IWORK, strideIWork, offsetIWork, TAU, strideTAU, offsetTAU, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork );
