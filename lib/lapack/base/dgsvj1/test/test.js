...
test( 'dgsvj1: novec_4x3_n1_1', function t() {
	...
	info = dgsvj1( 'no-v', M, N, 1, a, 1, M, 0, d, 1, 0, sva, 1, 0, 0, V, 1, 1, 0, EPS, SFMIN, TOL, 5, work, 1, 0 ); // eslint-disable-line max-len
...
test( 'dgsvj1: vec_5x4_n1_2', function t() {
	...
	V[ 15 ] = 1;
	work = new Float64Array( M );
	info = dgsvj1( 'compute-v', M, N, 2, a, 1, M, 0, d, 1, 0, sva, 1, 0, 0, V, 1, 4, 0, EPS, SFMIN, TOL, 5, work, 1, 0 ); // eslint-disable-line max-len
...
test( 'dgsvj1: apply_4x3_n1_1', function t() {
	...
	V[ 8 ] = 1;
	work = new Float64Array( M );
	info = dgsvj1( 'apply-v', M, N, 1, a, 1, M, 0, d, 1, 0, sva, 1, 0, 3, V, 1, 3, 0, EPS, SFMIN, TOL, 3, work, 1, 0 ); // eslint-disable-line max-len
	assertArrayClose( a, tc.a, 1e-12, 'a' );
...
test( 'dgsvj1: vec_14x14_block', function t() {
	...
	work = new Float64Array( M );
	info = dgsvj1( 'compute-v', M, N, 5, a, 1, M, 0, d, 1, 0, sva, 1, 0, 0, V, 1, N, 0, EPS, SFMIN, TOL, 4, work, 1, 0 ); // eslint-disable-line max-len
...
test( 'dgsvj1: novec_n1_eq_n', function t() {
	...
	V = new Float64Array( 1 );
	work = new Float64Array( M );
	info = dgsvj1( 'no-v', M, N, N, a, 1, M, 0, d, 1, 0, sva, 1, 0, 0, V, 1, 1, 0, EPS, SFMIN, TOL, 3, work, 1, 0 ); // eslint-disable-line max-len
	assertArrayClose( a, tc.a, 1e-12, 'a' );
	assertArrayClose( d, tc.d, 1e-12, 'd' );
	assertArrayClose( sva, tc.sva, 1e-12, 'sva' );
	assert.equal( info, tc.info, 'info' );
...
test( 'dgsvj1: novec_n1_0', function t() {
	...
	V = new Float64Array( 1 );
	work = new Float64Array( M );
	info = dgsvj1( 'no-v', M, N, 0, a, 1, M, 0, d, 1, 0, sva, 1, 0, 0, V, 1, 1, 0, EPS, SFMIN, TOL, 2, work, 1, 0 ); // eslint-disable-line max-len
	assertArrayClose( a, tc.a, 1e-12, 'a' );
	assertArrayClose( d, tc.d, 1e-12, 'd' );
	assertArrayClose( sva, tc.sva, 1e-12, 'sva' );
	assert.equal( info, tc.info, 'info' );
...
test( 'dgsvj1: invalid jobv returns -1', function t() {
	var info = dgsvj1( 'bogus', 1, 1, 0, new Float64Array( 1 ), 1, 1, 0, new Float64Array( 1 ), 1, 0, new Float64Array( 1 ), 1, 0, 0, new Float64Array( 1 ), 1, 1, 0, EPS, SFMIN, TOL, 1, new Float64Array( 1 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, -1 );
});

test( 'dgsvj1: negative M returns -2', function t() {
	var info = dgsvj1( 'no-v', -1, 1, 0, new Float64Array( 1 ), 1, 1, 0, new Float64Array( 1 ), 1, 0, new Float64Array( 1 ), 1, 0, 0, new Float64Array( 1 ), 1, 1, 0, EPS, SFMIN, TOL, 1, new Float64Array( 1 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, -2 );
});

test( 'dgsvj1: N > M returns -3', function t() {
	var info = dgsvj1( 'no-v', 2, 3, 0, new Float64Array( 6 ), 1, 2, 0, new Float64Array( 3 ), 1, 0, new Float64Array( 3 ), 1, 0, 0, new Float64Array( 1 ), 1, 1, 0, EPS, SFMIN, TOL, 1, new Float64Array( 2 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, -3 );
});

test( 'dgsvj1: negative n1 returns -4', function t() {
	var info = dgsvj1( 'no-v', 2, 2, -1, new Float64Array( 4 ), 1, 2, 0, new Float64Array( 2 ), 1, 0, new Float64Array( 2 ), 1, 0, 0, new Float64Array( 1 ), 1, 1, 0, EPS, SFMIN, TOL, 1, new Float64Array( 2 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, -4 );
});

test( 'dgsvj1: negative mv with rsvec returns -15', function t() {
	var info = dgsvj1( 'apply-v', 2, 2, 1, new Float64Array( 4 ), 1, 2, 0, new Float64Array( 2 ), 1, 0, new Float64Array( 2 ), 1, 0, -1, new Float64Array( 4 ), 1, 2, 0, EPS, SFMIN, TOL, 1, new Float64Array( 2 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, -15 );
});

test( 'dgsvj1: tol <= eps returns -21', function t() {
	var info = dgsvj1( 'no-v', 2, 2, 1, new Float64Array( 4 ), 1, 2, 0, new Float64Array( 2 ), 1, 0, new Float64Array( 2 ), 1, 0, 0, new Float64Array( 1 ), 1, 1, 0, EPS, SFMIN, EPS, 1, new Float64Array( 2 ), 1, 0 ); // eslint-disable-line max-len
...
test( 'dgsvj1: undersized work returns -28', function t() {
	var info = dgsvj1( 'no-v', 2, 2, 1, new Float64Array( 4 ), 1, 2, 0, new Float64Array( 2 ), 1, 0, new Float64Array( 2 ), 1, 0, 0, new Float64Array( 1 ), 1, 1, 0, EPS, SFMIN, TOL, 1, new Float64Array( 1 ), 1, 0 ); // eslint-disable-line max-len
