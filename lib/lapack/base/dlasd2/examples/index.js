...
import dlasd2 from './../lib/index.js';
...
const VT = discreteUniform( N * N, -10, 10, opts );
const U2 = discreteUniform( N * N, -10, 10, opts );
const VT2 = discreteUniform( N * N, -10, 10, opts );
...
const IDXC = discreteUniform( N, -10, 10, opts );
const IDXQ = discreteUniform( N, -10, 10, opts );
const COLTYP = discreteUniform( N, -10, 10, opts );

// Using the standard interface:
let out = dlasd2( 'row-major', 1, 1, 1, N, D, Z, 1.0, 1.0, U, N, VT, N, DSIGMA, U2, 1, VT2, 1, IDXP, IDX, IDXC, IDXQ, COLTYP );
console.log( out );
