...
function zsytri2( uplo, N, A, strideA1, strideA2, offsetA, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, offsetWork ) {
	...
	// NaN from an out-of-bounds read. With NBMAX=32, the blocked path (N>32)
	// treats WORK as a (N+33)-by-35 logical array; the unblocked path needs N.
	// The N===0 case is a quick return that needs no workspace.
	if ( N > 0 ) {
		need = ( N > 32 ) ? ( ( N+33 ) * 35 ) : N;
