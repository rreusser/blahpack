...
function drive( uplo, N, kd, nrhs, A0, B0, abLayout, bLayout ) {
	...
	var AFr = schemes.banded.realize( sc, A0, { 'part': uplo, 'k': kd }, abLayout ); // overwritten by dcopy+dpbtrf
	var Br = schemes.dense.realize( sc, B0, { 'part': 'full' }, bLayout );
	var Xr = schemes.dense.realize( sc, B0, { 'part': 'full' }, bLayout ); // overwritten by dlacpy+dpbtrs
	var equed = [ '' ];
	...
	var info = dpbsvx( 'not-factored', uplo, N, kd, nrhs, Ar.data, Ar.args[ 0 ], Ar.args[ 1 ], Ar.args[ 2 ], AFr.data, AFr.args[ 0 ], AFr.args[ 1 ], AFr.args[ 2 ], equed, s, 1, 0, Br.data, Br.args[ 0 ], Br.args[ 1 ], Br.args[ 2 ], Xr.data, Xr.args[ 0 ], Xr.args[ 1 ], Xr.args[ 2 ], rcond, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
	return {
		'Xr': Xr,
		'rcond': rcond,
		'FERR': FERR,
...
function runProperty( uplo, N, kd, nrhs ) {
	...
	var tag = 'dpbsvx '+uplo+' N='+N+' kd='+kd+' nrhs='+nrhs;
