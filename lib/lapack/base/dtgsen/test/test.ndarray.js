...
test( 'dtgsen: returns -1 for invalid ijob', function t() {
	...
	var WORK = new Float64Array( 500 );
	var IWORK = new Int32Array( 500 );
	var rv = dtgsen( -1, true, true, sel, 1, 0, 1, A, 1, 1, 0, B, 1, 1, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, identity( 1 ), 1, 1, 0, identity( 1 ), 1, 1, 0, M, [ 0 ], [ 0 ], DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dtgsen: returns -5 for negative N', function t() {
	...
	var WORK = new Float64Array( 500 );
	var IWORK = new Int32Array( 500 );
	var rv = dtgsen( 0, true, true, sel, 1, 0, -1, A, 1, 1, 0, B, 1, 1, 0, ALPHAR, 1, 0, ALPHAI, 1, 0, BETA, 1, 0, identity( 1 ), 1, 1, 0, identity( 1 ), 1, 1, 0, M, [ 0 ], [ 0 ], DIF, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
