...
const PACK = new Float64Array( 4 * KC );
...
function packRows( A, sa1, sa2, oa, upper, i, nr, kc, kcEnd ) {
	let split, pLo, pHi, sLo, sHi, q, r, l;
...
function dsymm( side, uplo, M, N, alpha, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, beta, C, strideC1, strideC2, offsetC ) {
	...
	let c32, c33, a0, a1, a2, a3, b0, b1, b2, b3, K, NN, sb1, sb2, sc1, sc2;
	let pb0, pb1, pb2, pb3, pc, pcc, pb, jc, kc, j, i, k, l, jj, ii, jcEnd;
	let kcEnd, kcLen, nb, bz, k1, k2, k3, ic, temp, temp1, temp2;
	...
	const mb = K - ( K % 4 ); // last full 4-row group boundary
