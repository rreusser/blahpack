...
import zlagtm from '../../zlagtm/lib/base.js';
...
function zgtrfs( trans, N, nrhs, DL, strideDL, offsetDL, d, strideD, offsetD, DU, strideDU, offsetDU, DLF, strideDLF, offsetDLF, DF, strideDF, offsetDF, DUF, strideDUF, offsetDUF, DU2, strideDU2, offsetDU2, IPIV, strideIPIV, offsetIPIV, B, strideB1, strideB2, offsetB, X, strideX1, strideX2, offsetX, FERR, strideFERR, offsetFERR, BERR, strideBERR, offsetBERR, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork ) {
	let transn, transt, lstres, count, s, i, j;
	...
	const sdl = strideDL * 2;
	const sdu = strideDU * 2;
	const sd = strideD * 2;
	const oB = offsetB * 2;
	const oX = offsetX * 2;
	const oW = offsetWork * 2;
	const oDL = offsetDL * 2;
	const oDU = offsetDU * 2;
	const oD = offsetD * 2;
	...
	for ( j = 0; j < nrhs; j++ ) {
		...
		while ( true ) {
			...
			if ( s > EPS && ( 2.0 * s ) <= lstres && count <= ITMAX ) {
				...
				zgttrs( trans, N, 1, DLF, strideDLF, offsetDLF, DF, strideDF, offsetDF, DUF, strideDUF, offsetDUF, DU2, strideDU2, offsetDU2, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, N * strideWork, offsetWork );
		...
		while ( true ) {
			...
			if ( KASE[ 0 ] === 1 ) {
				...
				zgttrs( transt, N, 1, DLF, strideDLF, offsetDLF, DF, strideDF, offsetDF, DUF, strideDUF, offsetDUF, DU2, strideDU2, offsetDU2, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, N * strideWork, offsetWork );
				for ( i = 0; i < N; i++ ) {
				...
				zgttrs( transn, N, 1, DLF, strideDLF, offsetDLF, DF, strideDF, offsetDF, DUF, strideDUF, offsetDUF, DU2, strideDU2, offsetDU2, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, N * strideWork, offsetWork );
			}
		}
