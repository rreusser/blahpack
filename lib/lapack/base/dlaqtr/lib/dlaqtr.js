...
*/
function dlaqtr( order, ltran, lreal, N, T, LDT, b, strideB, w, x, strideX, WORK ) { // eslint-disable-line max-len, max-params
	let st1, st2;
	...
	return base( ltran, lreal, N, T, st1, st2, 0, b, strideB, 0, w, x, strideX, 0, WORK, 1, 0 ); // eslint-disable-line max-len
}
