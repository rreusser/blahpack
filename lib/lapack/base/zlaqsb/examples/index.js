...
import zlaqsb from './../lib/index.js';

// 4x4 Hermitian band matrix (upper, KD=1, LDAB=2):
const AB = new Complex128Array( [ 0.0, 0.0, 4.0, 0.0, 1.0, 2.0, 9.0, 0.0, 3.0, 4.0, 16.0, 0.0, 5.0, 6.0, 25.0, 0.0 ] ); // eslint-disable-line max-len
const S = new Float64Array( [ 0.5, 0.25, 0.2, 0.1 ] );

// Poor scond triggers equilibration:
const equed = zlaqsb( 'upper', 4, 1, AB, 2, S, 1, 0.02, 25.0 );
