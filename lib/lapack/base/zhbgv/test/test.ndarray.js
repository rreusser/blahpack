...
import zhbgv from './../lib/ndarray.js';

// FIXTURES //

import upper_n5_ka2_kb1_noev from './fixtures/upper_n5_ka2_kb1_noev.json' with { type: 'json' };
import upper_n5_ka2_kb1_ev from './fixtures/upper_n5_ka2_kb1_ev.json' with { type: 'json' };
import lower_n5_ka2_kb1_noev from './fixtures/lower_n5_ka2_kb1_noev.json' with { type: 'json' };
import lower_n5_ka2_kb1_ev from './fixtures/lower_n5_ka2_kb1_ev.json' with { type: 'json' };
import diag_n3 from './fixtures/diag_n3.json' with { type: 'json' };
import upper_n8_ka3_kb2_ev from './fixtures/upper_n8_ka3_kb2_ev.json' with { type: 'json' };
import lower_n8_ka3_kb2_ev from './fixtures/lower_n8_ka3_kb2_ev.json' with { type: 'json' };
import n1_trivial from './fixtures/n1_trivial.json' with { type: 'json' };
...
function upperBandB_n5_kb1() {
	const BB = new Complex128Array( 2 * 5 );
	const v = reinterpret( BB, 0 );
...
function upperBandA_n8_ka3() {
	const LDAB = 4;
	const AB = new Complex128Array( LDAB * 8 );
	const v = reinterpret( AB, 0 );
	let k, i;
...
function upperBandB_n8_kb2() {
	const LDBB = 3;
	const BB = new Complex128Array( LDBB * 8 );
	const v = reinterpret( BB, 0 );
	let k, i;
...
test( 'zhbgv: upper_n5_ka2_kb1_noev (eigenvalues only, upper)', function t() {
	...
	const tc = upper_n5_ka2_kb1_noev;
	const AB = upperBandA_n5_ka2();
	const BB = upperBandB_n5_kb1();
	const W = new Float64Array( 5 );
	const Z = new Complex128Array( 1 );
	const WORK = new Complex128Array( 5 );
	const RWORK = new Float64Array( 15 );
	const info = zhbgv( 'no-vectors', 'upper', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'zhbgv: upper_n5_ka2_kb1_ev (eigenvectors, upper)', function t() {
	...
	const WORK = new Complex128Array( 5 );
	const RWORK = new Float64Array( 15 );
	const info = zhbgv( 'compute-vectors', 'upper', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 5, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
...
test( 'zhbgv: lower_n5_ka2_kb1_noev (eigenvalues only, lower)', function t() {
	...
	const tc = lower_n5_ka2_kb1_noev;
	const AB = lowerBandA_n5_ka2();
	const BB = lowerBandB_n5_kb1();
	const W = new Float64Array( 5 );
	const Z = new Complex128Array( 1 );
	const WORK = new Complex128Array( 5 );
	const RWORK = new Float64Array( 15 );
	const info = zhbgv( 'no-vectors', 'lower', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
});
...
test( 'zhbgv: lower_n5_ka2_kb1_ev (eigenvectors, lower)', function t() {
	...
	const WORK = new Complex128Array( 5 );
	const RWORK = new Float64Array( 15 );
	const info = zhbgv( 'compute-vectors', 'lower', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 5, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
	const Zv = reinterpret( Z, 0 );
	assertArrayClose( Zv, new Float64Array( tc.Z ), 1e-12, 'Z' );
...
test( 'zhbgv: n_zero (quick return for N=0)', function t() {
	...
	const BB = new Complex128Array( 4 );
	const W = new Float64Array( 1 );
	const Z = new Complex128Array( 1 );
	const WORK = new Complex128Array( 3 );
	const RWORK = new Float64Array( 3 );
	const info = zhbgv( 'no-vectors', 'upper', 0, 1, 0, AB, 1, 2, 0, BB, 1, 1, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'zhbgv: diag_n3 (diagonal matrices, KA=KB=0)', function t() {
	...
	const BB = new Complex128Array( 3 );
	const W = new Float64Array( 3 );
	const Z = new Complex128Array( 1 );
	const WORK = new Complex128Array( 3 );
	const RWORK = new Float64Array( 9 );
	v = reinterpret( AB, 0 );
	v[ 0 ] = 5.0;
	v[ 1 ] = 0.0;
	v[ 2 ] = 6.0;
	...
	v[ 4 ] = 4.0;
	v[ 5 ] = 0.0;
	const info = zhbgv( 'no-vectors', 'upper', 3, 0, 0, AB, 1, 1, 0, BB, 1, 1, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
});
...
test( 'zhbgv: upper_n8_ka3_kb2_ev (larger, eigenvectors, upper)', function t() {
	...
	const tc = upper_n8_ka3_kb2_ev;
	const AB = upperBandA_n8_ka3();
	const BB = upperBandB_n8_kb2();
	const W = new Float64Array( 8 );
	const Z = new Complex128Array( 64 );
	const WORK = new Complex128Array( 8 );
	const RWORK = new Float64Array( 24 );
	const info = zhbgv( 'compute-vectors', 'upper', 8, 3, 2, AB, 1, 4, 0, BB, 1, 3, 0, W, 1, 0, Z, 1, 8, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
...
test( 'zhbgv: lower_n8_ka3_kb2_ev (larger, eigenvectors, lower)', function t() {
	...
	const tc = lower_n8_ka3_kb2_ev;
	const AB = lowerBandA_n8_ka3();
	const BB = lowerBandB_n8_kb2();
	const W = new Float64Array( 8 );
	const Z = new Complex128Array( 64 );
	const WORK = new Complex128Array( 8 );
	const RWORK = new Float64Array( 24 );
	const info = zhbgv( 'compute-vectors', 'lower', 8, 3, 2, AB, 1, 4, 0, BB, 1, 3, 0, W, 1, 0, Z, 1, 8, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-12, 'W' );
	const Zv = reinterpret( Z, 0 );
	assertArrayClose( Zv, new Float64Array( tc.Z ), 1e-10, 'Z' );
...
test( 'zhbgv: n1_trivial (N=1, eigenvectors)', function t() {
	...
	v[ 0 ] = 2.0;
	v[ 1 ] = 0.0;
	const info = zhbgv( 'compute-vectors', 'upper', 1, 0, 0, AB, 1, 1, 0, BB, 1, 1, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
	const Zv = reinterpret( Z, 0 );
	assertArrayClose( Zv, new Float64Array( tc.Z ), 1e-12, 'Z' );
