...
import zlansb from './../lib/ndarray.js';


// FIXTURES //

const fixtureFile = path.join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures', 'zlansb.jsonl' );
...
// 1x1 K=0: (5, -3)
const AB_1X1 = buildAB( LDAB, 1, [ 1, 1, 5.0, -3.0 ] );
...
function runCase( name, norm, uplo, N, K, AB ) {
	...
	const got = zlansb( norm, uplo, N, K, AB, 1, LDAB, 0, WORK, 1, 0 );
