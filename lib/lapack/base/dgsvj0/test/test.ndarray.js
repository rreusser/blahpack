...
test( 'ndarray: honors offsetA into a larger A buffer (apply_4x3)', function t() {
	...
	V[ 8 ] = 1;
	work = new Float64Array( M );
	info = ndarrayFn( 'apply-v', M, N, a, 1, M, padA, d, 1, 0, sva, 1, 0, 3, V, 1, 3, 0, EPS, SFMIN, TOL, 3, work, 1, 0 );
...
test( 'ndarray: offsetV into a larger V buffer (vec_5x4)', function t() {
	...
	V[ padV + 15 ] = 1;
	work = new Float64Array( M );
	info = ndarrayFn( 'compute-v', M, N, a, 1, M, 0, d, 1, 0, sva, 1, 0, 0, V, 1, N, padV, EPS, SFMIN, TOL, 5, work, 1, 0 );
...
test( 'ndarray: matches base identically (vec_5x4)', function t() {
	...
	baseInfo = dgsvj0( 'compute-v', M, N, aB, 1, M, 0, dB, 1, 0, svaB, 1, 0, 0, VB, 1, 4, 0, EPS, SFMIN, TOL, 5, workB, 1, 0 );
	ndInfo = ndarrayFn( 'compute-v', M, N, aN, 1, M, 0, dN, 1, 0, svaN, 1, 0, 0, VN, 1, 4, 0, EPS, SFMIN, TOL, 5, workN, 1, 0 );
