...
*/
function dsygv( itype, jobz, uplo, N, A, LDA, B, LDB, w, strideW, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	...
	if ( WORK === null || WORK === void 0 ) {
		const minWork = Math.max( 1, 3 * N - 1);
	...
	return base( itype, jobz, uplo, N, A, sa1, sa2, 0, B, sb1, sb2, 0, w, strideW, ow, WORK, strideWork, owork ); // eslint-disable-line max-len
}
