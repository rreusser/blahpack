...
test( 'zgels: overdetermined_4x2, TRANS=N', function t() {
	...
	info = zgels( 'no-transpose', 4, 2, 1, A, 1, 4, 0, B, 1, 4, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
...
test( 'zgels: underdetermined_2x4, TRANS=N', function t() {
	...
	info = zgels( 'no-transpose', 2, 4, 1, A, 1, 2, 0, B, 1, 4, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
...
test( 'zgels: square_3x3, TRANS=N', function t() {
	...
	B = c128( [ 5, 2, 5, 3, 5, 2 ] );
	info = zgels( 'no-transpose', 3, 3, 1, A, 1, 3, 0, B, 1, 3, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
...
test( 'zgels: conjtrans_mge_n_minnorm, TRANS=C, M>=N', function t() {
	...
	info = zgels( 'conjugate-transpose', 4, 2, 1, A, 1, 4, 0, B, 1, 4, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assertArrayClose( extractDoubles( B, 0, 8 ), tc.x, 1e-12, 'x' );
});
...
test( 'zgels: conjtrans_mlt_n_ls, TRANS=C, M<N', function t() {
	...
	B = c128( [ 1, 0, 2, 1, 3, 0 ] );
	info = zgels( 'conjugate-transpose', 2, 3, 1, A, 1, 2, 0, B, 1, 3, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
	assertArrayClose( extractDoubles( B, 0, 4 ), tc.x, 1e-12, 'x' );
});
...
test( 'zgels: multi_rhs_overdetermined, TRANS=N', function t() {
	...
	info = zgels( 'no-transpose', 4, 2, 2, A, 1, 4, 0, B, 1, 4, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
...
test( 'zgels: n_zero quick return', function t() {
	...
	A = c128( [ 1, 0 ] );
	B = c128( [ 1, 0, 0, 0, 0, 0 ] );
	info = zgels( 'no-transpose', 3, 0, 1, A, 1, 3, 0, B, 1, 3, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
});
...
test( 'zgels: m_zero quick return', function t() {
	...
	A = c128( [ 0, 0 ] );
	B = c128( [ 0, 0, 0, 0, 0, 0 ] );
	info = zgels( 'no-transpose', 0, 3, 1, A, 1, 1, 0, B, 1, 3, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
});
...
test( 'zgels: nrhs_zero quick return', function t() {
	...
	B = c128( [ 0, 0, 0, 0 ] );
	info = zgels( 'no-transpose', 2, 2, 0, A, 1, 2, 0, B, 1, 2, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
});
...
test( 'zgels: zero matrix A returns zero solution', function t() {
	...
	B = c128( [ 1, 2, 0, 0 ] );
	info = zgels( 'no-transpose', 2, 2, 1, A, 1, 2, 0, B, 1, 2, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
...
test( 'zgels: overdetermined_6x3', function t() {
	...
	info = zgels( 'no-transpose', 6, 3, 1, A, 1, 6, 0, B, 1, 6, 0, new Complex128Array( 200 ), 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info );
