...
*/
function zhegv( itype, jobz, uplo, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, w, strideW, offsetW, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork ) { // eslint-disable-line max-len, max-params
	...
	// requires `LWORK >= max(1, 2*N-1)`) so an undersized buffer is a loud
	// RangeError rather than a silent NaN from an out-of-bounds read.
	const need = Math.max( 1, ( 2 * N ) - 1 );
	...
	return base( itype, jobz, uplo, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, w, strideW, offsetW, WORK, strideWork, offsetWork, RWORK, strideRWork, offsetRWork ); // eslint-disable-line max-len
}
