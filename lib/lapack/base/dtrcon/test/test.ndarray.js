...
test( 'dtrcon: N=0 quick return (rcond=1)', function t() {
	const rcond = new Float64Array( 1 );
	rcond[ 0 ] = 0.5;
	const info = dtrcon( 'one-norm', 'upper', 'non-unit', 0, new Float64Array( 0 ), 1, 1, 0, rcond, new Float64Array( 0 ), 1, 0, new Int32Array( 0 ), 1, 0 );
...
test( 'dtrcon: zero matrix returns rcond=0', function t() {
	...
	const info = dtrcon( 'one-norm', 'upper', 'non-unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
...
test( 'dtrcon: identity 3x3 upper non-unit (inf-norm)', function t() {
	...
	const work = new Float64Array( 3 * N );
	const iwork = new Int32Array( N );
	const info = dtrcon( 'inf-norm', 'upper', 'non-unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
	assert.ok( close( rcond[ 0 ], 1.0, 1e-9 ) );
});
...
test( 'dtrcon: upper unit 4x4 (one-norm)', function t() {
	...
	const work = new Float64Array( 3 * N );
	const iwork = new Int32Array( N );
	const info = dtrcon( 'one-norm', 'upper', 'unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
...
test( 'dtrcon: upper unit 4x4 (inf-norm)', function t() {
	...
	const work = new Float64Array( 3 * N );
	const iwork = new Int32Array( N );
	const info = dtrcon( 'inf-norm', 'upper', 'unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
	assert.ok( rcond[ 0 ] > 0.0 && rcond[ 0 ] <= 1.0 );
});
...
test( 'dtrcon: lower non-unit diagonal 4x4 (one-norm)', function t() {
	...
	const work = new Float64Array( 3 * N );
	const iwork = new Int32Array( N );
	const info = dtrcon( 'one-norm', 'lower', 'non-unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
...
test( 'dtrcon: lower non-unit diagonal 4x4 (inf-norm)', function t() {
	...
	const work = new Float64Array( 3 * N );
	const iwork = new Int32Array( N );
	const info = dtrcon( 'inf-norm', 'lower', 'non-unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
	assert.ok( close( rcond[ 0 ], 0.25, 1e-9 ) );
});
...
test( 'dtrcon: lower unit 4x4 (one-norm)', function t() {
	...
	const work = new Float64Array( 3 * N );
	const iwork = new Int32Array( N );
	const info = dtrcon( 'one-norm', 'lower', 'unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
	assert.ok( rcond[ 0 ] > 0.0 && rcond[ 0 ] <= 1.0 );
});
...
test( 'dtrcon: lower unit 4x4 (inf-norm)', function t() {
	...
	const work = new Float64Array( 3 * N );
	const iwork = new Int32Array( N );
	const info = dtrcon( 'inf-norm', 'lower', 'unit', N, A, 1, N, 0, rcond, work, 1, 0, iwork, 1, 0 );
	assert.strictEqual( info, 0 );
	assert.ok( rcond[ 0 ] > 0.0 && rcond[ 0 ] <= 1.0 );
});
