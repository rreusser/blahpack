...
test( 'ztzrzf returns 0 for M=0 (quick return)', function t() {
	const info = ztzrzf( 'column-major', 0, 5, new Complex128Array( 5 ), 1, new Complex128Array( 1 ), 1, new Complex128Array( 1 ), 1 );
...
test( 'ztzrzf accepts row-major layout', function t() {
	...
	const info = ztzrzf( 'row-major', 2, 4, A, 4, TAU, 1, WORK, 1 );
	assert.strictEqual( info, 0, 'INFO' );
