...
function zgges( jobvsl, jobvsr, sort, selctg, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, ALPHA, strideALPHA, offsetALPHA, BETA, strideBETA, offsetBETA, VSL, strideVSL1, strideVSL2, offsetVSL, VSR, strideVSR1, strideVSR2, offsetVSR ) {
	...
	const WORK = new Complex128Array( Math.max( 8 * N, 1 ) );
	const RWORK = new Float64Array( 8 * N );
	...
	const anrm = zlange( 'max', N, N, A, strideA1, strideA2, offsetA, RWORK, 1, 0 );
	ilascl = false;
	anrmto = 0.0;
	...
	const bnrm = zlange( 'max', N, N, B, strideB1, strideB2, offsetB, RWORK, 1, 0 );
	ilbscl = false;
	bnrmto = 0.0;
	...
	const bal = zggbal( 'permute', N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, LSCALE, 1, 0, RSCALE, 1, 0, RWORK, 1, 0 );
	...
	ierr = zhgeqz( 'schur', ( ilvsl ) ? 'update' : 'none', ( ilvsr ) ? 'update' : 'none', N, ilo, ihi, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, ALPHA, strideALPHA, offsetALPHA, BETA, strideBETA, offsetBETA, VSL, strideVSL1, strideVSL2, offsetVSL, VSR, strideVSR1, strideVSR2, offsetVSR, WORK, 1, 0, RWORK, 1, 0 );
	if ( ierr !== 0 ) {
		if ( ierr > 0 && ierr <= N ) {
			info = ierr;
