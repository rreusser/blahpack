...
import dlasq3 from '../../dlasq3/lib/base.js';
...
function dlasq2( N, z, stride, offset ) {
	let deemin, oldemn, iwhila, iwhilb, desig, dmin1, dmin2, sigma, tempq;
	let tempe, ttype, nfail, emax, emin, info, iter, nbig, ndiv, ipn4, kmin;
	let dmin, qmax, qmin, temp, zmax, splt, dee, tau, dn1, dn2, pp, i0, i1, i4;
	let n0, n1, dn, r, d, e, g, k, s, t;
