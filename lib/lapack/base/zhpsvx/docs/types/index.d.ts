...
interface Routine {
	...
	*/
	...
	/**
	* Solves a complex Hermitian indefinite system of linear equations A_X = B where A is stored in packed format, using the diagonal pivoting factorization A = U_D_U^H or A = L_D_L^H, and provides an estimate of the condition number and error bounds on the solution using alternative indexing semantics.
	*
	* @param fact - `fact`
	* @param uplo - specifies whether the upper or lower triangular part is referenced
	* @param N - number of columns
