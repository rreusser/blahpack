...
test( 'zher2: upper_basic (UPLO=U, N=2, alpha=(1,0))', function t() {
	...
	const result = zher2( 'upper', 2, alpha, x, 1, 0, y, 1, 0, A, 1, 2, 0 );
...
test( 'zher2: lower_basic (UPLO=L, N=2, alpha=(1,0))', function t() {
	...
	const y = new Complex128Array( [ 1, 1, 2, 0 ] );
	const alpha = new Complex128( 1, 0 );
	const result = zher2( 'lower', 2, alpha, x, 1, 0, y, 1, 0, A, 1, 2, 0 );
	assert.strictEqual( result, A );
	assertArrayClose( toArray( reinterpret( A, 0 ) ), tc.A, 1e-14, 'A' );
});
...
test( 'zher2: n_zero (N=0 quick return)', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const result = zher2( 'upper', 0, alpha, x, 1, 0, y, 1, 0, A, 1, 1, 0 );
	assert.strictEqual( result, A );
	assertArrayClose( toArray( reinterpret( A, 0 ) ), tc.A, 1e-14, 'A' );
});
...
test( 'zher2: alpha_zero (alpha=0 quick return)', function t() {
	...
	const tc = alpha_zero;
	const A = new Complex128Array( [ 99, 88, 0, 0, 0, 0, 0, 0 ] );
	const x = new Complex128Array( [ 1, 0, 0, 1 ] );
	const y = new Complex128Array( [ 1, 1, 2, 0 ] );
...
test( 'zher2: n_one (N=1)', function t() {
	...
	const alpha = new Complex128( 1, 0 );
	const result = zher2( 'upper', 1, alpha, x, 1, 0, y, 1, 0, A, 1, 1, 0 );
	assert.strictEqual( result, A );
	assertArrayClose( toArray( reinterpret( A, 0 ) ), tc.A, 1e-14, 'A' );
});
...
test( 'zher2: upper_stride (UPLO=U, incx=2, incy=2)', function t() {
	...
	const y = new Complex128Array( [ 1, 1, 0, 0, 2, 0, 0, 0, 0, -1 ] );
	const alpha = new Complex128( 1, 0 );
	const result = zher2( 'upper', 3, alpha, x, 2, 0, y, 2, 0, A, 1, 3, 0 );
	assert.strictEqual( result, A );
	assertArrayClose( toArray( reinterpret( A, 0 ) ), tc.A, 1e-14, 'A' );
});
...
test( 'zher2: lower_stride (UPLO=L, incx=2, incy=2)', function t() {
	...
	const y = new Complex128Array( [ 1, 1, 0, 0, 2, 0, 0, 0, 0, -1 ] );
	const alpha = new Complex128( 1, 0 );
	const result = zher2( 'lower', 3, alpha, x, 2, 0, y, 2, 0, A, 1, 3, 0 );
	assert.strictEqual( result, A );
	assertArrayClose( toArray( reinterpret( A, 0 ) ), tc.A, 1e-14, 'A' );
});
...
test( 'zher2: upper_3x3 (UPLO=U, N=3, larger matrix)', function t() {
	...
	const y = new Complex128Array( [ 0, 1, 1, -1, 2, 2 ] );
	const alpha = new Complex128( 1, 0 );
	const result = zher2( 'upper', 3, alpha, x, 1, 0, y, 1, 0, A, 1, 3, 0 );
	assert.strictEqual( result, A );
	assertArrayClose( toArray( reinterpret( A, 0 ) ), tc.A, 1e-14, 'A' );
});
...
test( 'zher2: lower_zeros (UPLO=L, x and y with zero elements — tests skip branch)', function t() { // eslint-disable-line max-len
	...
	const y = new Complex128Array( [ 0, 0, 2, 0 ] );
	const alpha = new Complex128( 1, 0 );
	const result = zher2( 'lower', 2, alpha, x, 1, 0, y, 1, 0, A, 1, 2, 0 );
	assert.strictEqual( result, A );
	const Av = toArray( reinterpret( A, 0 ) );
