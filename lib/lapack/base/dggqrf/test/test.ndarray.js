...
function callDggqrf( N, M, P, aFlat, bFlat ) {
	...
	info = dggqrf( N, M, P, A, 1, N, 0, TAUA, 1, 0, B, 1, N, 0, TAUB, 1, 0, WORK, 1, 0 );
	return {
		info: info,
...
test( 'dggqrf: n_zero', function t() {
	...
	var info = dggqrf( 0, 3, 3, new Float64Array( 0 ), 1, 0, 0, TAUA, 1, 0, new Float64Array( 0 ), 1, 0, 0, TAUB, 1, 0, WORK, 1, 0 );
