...
test( 'dgerq2: 3x4 (M < N)', function t() {
	...
	const info = dgerq2( 3, 4, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
...
test( 'dgerq2: 4x3 (M > N)', function t() {
	...
	const info = dgerq2( 4, 3, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, tc.INFO, 'INFO' );
...
test( 'dgerq2: 3x3 (square)', function t() {
	...
	const TAU = new Float64Array( 3 );
	const WORK = new Float64Array( 3 );
	const info = dgerq2( 3, 3, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, tc.INFO, 'INFO' );
...
test( 'dgerq2: 1x4 (single row)', function t() {
	...
	const info = dgerq2( 1, 4, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, tc.INFO, 'INFO' );
...
test( 'dgerq2: 3x1 (single column)', function t() {
	...
	const TAU = new Float64Array( 1 );
	const WORK = new Float64Array( 3 );
	const info = dgerq2( 3, 1, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, tc.INFO, 'INFO' );
...
test( 'dgerq2: M=0 (quick return)', function t() {
	...
	const TAU = new Float64Array( 1 );
	const WORK = new Float64Array( 1 );
	const info = dgerq2( 0, 3, A, 1, 1, 0, TAU, 1, 0, WORK, 1, 0 );
...
test( 'dgerq2: N=0 (quick return)', function t() {
	...
	const TAU = new Float64Array( 1 );
	const WORK = new Float64Array( 1 );
	const info = dgerq2( 3, 0, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'INFO' );
});
...
test( 'dgerq2: 1x1', function t() {
	...
	const TAU = new Float64Array( 1 );
	const WORK = new Float64Array( 1 );
	const info = dgerq2( 1, 1, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, tc.INFO, 'INFO' );
...
test( 'dgerq2: 2x5 (wide)', function t() {
	...
	const info = dgerq2( 2, 5, A, 1, 6, 0, TAU, 1, 0, WORK, 1, 0 );
	assert.equal( info, tc.INFO, 'INFO' );
