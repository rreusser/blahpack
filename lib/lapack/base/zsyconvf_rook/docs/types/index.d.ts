...
interface Routine {
	...
	*/
	...
	/**
	* Converts the factorization output format used in `zsytrf_rook` into the `zsytrf_rk` format for a complex symmetric matrix, or reverts the conversion using alternative indexing semantics.
	*
	* @param uplo - specifies whether the upper or lower triangular part is referenced
	* @param way - `way`
	* @param N - number of columns
