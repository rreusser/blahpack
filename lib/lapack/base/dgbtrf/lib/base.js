...
function dgbtrf( M, N, kl, ku, AB, strideAB1, strideAB2, offsetAB, IPIV, strideIPIV, offsetIPIV ) {
	let info, temp, km, jp, jb, jm, ju, i2, i3, j2, j3, k2, nw, ip, ii, jj, i;
	let j;
	...
	const WORK13 = new Float64Array( LDWORK * NBMAX );
	const WORK31 = new Float64Array( LDWORK * NBMAX );
