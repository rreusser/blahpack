...
test( 'dormr2: left_notrans (Q*I = Q)', function t() {
	...
	const info = dormr2( 'left', 'no-transpose', 4, 4, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
...
test( 'dormr2: left_trans (Q^T*I)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'left', 'transpose', 4, 4, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
...
test( 'dormr2: right_notrans (I*Q)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'right', 'no-transpose', 4, 4, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
...
test( 'dormr2: right_trans (I*Q^T)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'right', 'transpose', 4, 4, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
...
test( 'dormr2: m_zero', function t() {
	...
	const info = dormr2( 'left', 'no-transpose', 0, 4, 0, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0 );
...
test( 'dormr2: n_zero', function t() {
	...
	const C = new Float64Array( 1 );
	const WORK = new Float64Array( 1 );
	const info = dormr2( 'left', 'no-transpose', 4, 0, 0, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'INFO' );
});
...
test( 'dormr2: k_zero', function t() {
	...
	const info = dormr2( 'left', 'no-transpose', 4, 4, 0, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, 0, 'INFO' );
});
...
test( 'dormr2: left_notrans_rect (Q*C, 4x2)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'left', 'no-transpose', 4, 2, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
...
test( 'dormr2: left_trans_rect (Q^T*C, 4x2)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'left', 'transpose', 4, 2, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
...
test( 'dormr2: right_notrans_rect (C*Q, 2x4)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'right', 'no-transpose', 2, 4, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 2, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
...
test( 'dormr2: right_trans_rect (C*Q^T, 2x4)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'right', 'transpose', 2, 4, 3, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 2, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
...
test( 'dormr2: k_one (single reflector)', function t() {
	...
	const WORK = new Float64Array( 100 );
	const info = dormr2( 'left', 'no-transpose', 4, 4, 1, rq.A, 1, 4, 0, rq.TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 );
	assert.equal( info, tc.info, 'INFO' );
	assertArrayClose( Array.from( C ), tc.c, 1e-14, 'C' );
});
