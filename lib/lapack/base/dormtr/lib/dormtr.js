...
*/
function dormtr( side, uplo, trans, M, N, A, LDA, TAU, strideTAU, C, LDC, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	...
	return base( side, uplo, trans, M, N, A, sa1, sa2, 0, TAU, strideTAU, otau, C, sc1, sc2, 0, WORK, strideWork, owork ); // eslint-disable-line max-len
}
