...
import zla_gerpvgrw from './../lib/zla_gerpvgrw.js';
...
test( 'zla_gerpvgrw: N=0 returns 1', function t() {
	const r = zla_gerpvgrw( 0, 0, new Complex128Array( 0 ), 1, new Complex128Array( 0 ), 1 );
	assert.strictEqual( r, 1.0 );
});

test( 'zla_gerpvgrw: 2x2 unit ratio', function t() {
	const A = new Complex128Array( [ 2, 0, 0, 0, 0, 0, 3, 0 ] );
	const AF = new Complex128Array( [ 2, 0, 0, 0, 0, 0, 3, 0 ] );
	const r = zla_gerpvgrw( 2, 2, A, 2, AF, 2 );
	approxEqual( r, 1.0, 1e-12, 'rpvgrw' );
});

test( 'zla_gerpvgrw: 2x2 with growth', function t() {
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const AF = new Complex128Array( [ 5, 0, 0, 0, 0, 0, 1, 0 ] );
	const r = zla_gerpvgrw( 2, 2, A, 2, AF, 2 );
