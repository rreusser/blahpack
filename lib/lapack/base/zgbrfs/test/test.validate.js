...
function trueSolution( A0, B0, N, nrhs, code, kl, ku ) {
	...
	const info = zgbsv( N, okl, oku, nrhs, Ar.data, Ar.args[ 0 ], Ar.args[ 1 ], Ar.args[ 2 ], ipiv, 1, 0, Br.data, Br.args[ 0 ], Br.args[ 1 ], Br.args[ 2 ] );
	if ( info !== 0 ) {
...
function runProperty( trans, N, kl, ku, nrhs ) {
	...
	const tag = 'zgbrfs '+trans+' N='+N+' kl='+kl+' ku='+ku+' nrhs='+nrhs;
