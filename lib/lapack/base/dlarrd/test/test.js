...
var fixtures = readFileSync( resolve( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures', 'dlarrd.jsonl' ), 'utf8' ) // eslint-disable-line max-len
	.trim()
	.split( '\n' )
...
test( "range='all' order='entire', 5x5", function t() {
	...
	var res = dlarrd.ndarray( 'all', 'entire', N, 0.0, 0.0, 0, 0, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 1, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( "range='index', 5x5, il=2, iu=4", function t() {
	...
	var res = dlarrd.ndarray( 'index', 'entire', N, 0.0, 0.0, 2, 4, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 1, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( "range='value', 5x5, vl=-2, vu=3", function t() {
	...
	var res = dlarrd.ndarray( 'value', 'entire', N, -2.0, 3.0, 0, 0, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 1, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( 'two blocks, all, entire order', function t() {
	...
	var res = dlarrd.ndarray( 'all', 'entire', N, 0.0, 0.0, 0, 0, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 2, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( 'two blocks, all, block order', function t() {
	...
	var res = dlarrd.ndarray( 'all', 'block', N, 0.0, 0.0, 0, 0, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 2, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( 'vl>=vu for range=value returns info=-5', function t() {
	...
	var IBLOCK = new Int32Array( N );
	var INDEXW = new Int32Array( N );
	var res = dlarrd.ndarray( 'value', 'entire', N, 3.0, 1.0, 0, 0, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 1, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( 'bad il returns info=-6', function t() {
	...
	var IBLOCK = new Int32Array( N );
	var INDEXW = new Int32Array( N );
	var res = dlarrd.ndarray( 'index', 'entire', N, 0.0, 0.0, 0, 2, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 1, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( 'bad iu returns info=-7', function t() {
	...
	var IBLOCK = new Int32Array( N );
	var INDEXW = new Int32Array( N );
	var res = dlarrd.ndarray( 'index', 'entire', N, 0.0, 0.0, 1, 5, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 1, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( 'N<=0 quick return', function t() {
	...
	var res = dlarrd.ndarray( 'all', 'entire', N, 0.0, 0.0, 0, 0, GERS, 1, 0, RELTOL, d, 1, 0, e, 1, 0, E2, 1, 0, PIVMIN, 0, ISPLIT, 1, 0, w, 1, 0, WERR, 1, 0, IBLOCK, 1, 0, INDEXW, 1, 0 ); // eslint-disable-line max-len
...
test( 'default (main) wrapper returns object', function t() {
	...
	var res = dlarrd( 'all', 'entire', N, 0.0, 0.0, 0, 0, GERS, 1, RELTOL, d, 1, e, 1, E2, 1, PIVMIN, 1, ISPLIT, 1, w, 1, WERR, 1, IBLOCK, 1, INDEXW, 1 ); // eslint-disable-line max-len
