...
import zgemm from './../lib/index.js';
import base from './../lib/ndarray.js';

// FIXTURES //

import zgemm_basic_nn from './fixtures/zgemm_basic_nn.json' with { type: 'json' };
import zgemm_conja from './fixtures/zgemm_conja.json' with { type: 'json' };
import zgemm_alpha_beta from './fixtures/zgemm_alpha_beta.json' with { type: 'json' };
import zgemm_m_zero from './fixtures/zgemm_m_zero.json' with { type: 'json' };
import zgemm_transb from './fixtures/zgemm_transb.json' with { type: 'json' };
import zgemm_conjb from './fixtures/zgemm_conjb.json' with { type: 'json' };
import zgemm_transa_n from './fixtures/zgemm_transa_n.json' with { type: 'json' };
import zgemm_alpha_zero_beta_zero from './fixtures/zgemm_alpha_zero_beta_zero.json' with { type: 'json' };
import zgemm_alpha_zero_beta_scale from './fixtures/zgemm_alpha_zero_beta_scale.json' with { type: 'json' };
import zgemm_conja_conjb from './fixtures/zgemm_conja_conjb.json' with { type: 'json' };
import zgemm_transa_transb from './fixtures/zgemm_transa_transb.json' with { type: 'json' };
import zgemm_transa_conjb from './fixtures/zgemm_transa_conjb.json' with { type: 'json' };
import zgemm_conja_transb from './fixtures/zgemm_conja_transb.json' with { type: 'json' };
import zgemm_k_zero from './fixtures/zgemm_k_zero.json' with { type: 'json' };
import zgemm_nt_beta_scale from './fixtures/zgemm_nt_beta_scale.json' with { type: 'json' };
import zgemm_cc_beta_nonzero from './fixtures/zgemm_cc_beta_nonzero.json' with { type: 'json' };
import zgemm_nc_beta_scale from './fixtures/zgemm_nc_beta_scale.json' with { type: 'json' };
import zgemm_tn_beta_nonzero from './fixtures/zgemm_tn_beta_nonzero.json' with { type: 'json' };
import zgemm_cn_beta_nonzero from './fixtures/zgemm_cn_beta_nonzero.json' with { type: 'json' };
import zgemm_ct_beta_nonzero from './fixtures/zgemm_ct_beta_nonzero.json' with { type: 'json' };
import zgemm_tc_beta_nonzero from './fixtures/zgemm_tc_beta_nonzero.json' with { type: 'json' };
import zgemm_tt_beta_nonzero from './fixtures/zgemm_tt_beta_nonzero.json' with { type: 'json' };
...
test( 'zgemm: basic N,N (M=2, N=2, K=2)', function t() {
	...
	const tc = zgemm_basic_nn;
	const A = new Complex128Array( [ 1, 1, 2, 0, 3, 0, 4, 1 ] );
	const B = new Complex128Array( [ 1, 0, 0, -1, 0, 1, 1, 0 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 'no-transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
...
test( 'zgemm: conjugate transpose A (C=A^H*B)', function t() {
	...
	const tc = zgemm_conja;
	const A = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 1, 1, 2, 0 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'conjugate-transpose', 'no-transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: alpha and beta scaling', function t() {
	...
	const tc = zgemm_alpha_beta;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 2, 1, 0, 0, 0, 0, 3, 2 ] );
	const C = new Complex128Array( [ 1, 1, 0, 0, 0, 0, 1, 1 ] );
...
test( 'zgemm: M=0 quick return', function t() {
	...
	const tc = zgemm_m_zero;
	const A = new Complex128Array( 0 );
	const B = new Complex128Array( 0 );
	const C = new Complex128Array( [ 99, 88 ] );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 1, 0 );
	const result = base( 'no-transpose', 'no-transpose', 0, 2, 2, alpha, A, 1, 1, 0, B, 1, 1, 0, beta, C, 1, 1, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: transpose B (C=A*B^T)', function t() {
	...
	const tc = zgemm_transb;
	const A = new Complex128Array( [ 1, 1, 2, 0, 0, 1, 1, -1 ] );
	const B = new Complex128Array( [ 1, 0, 0, 0, 0, 1, 1, 0 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 'transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: conjugate transpose B (C=A*B^H)', function t() {
	...
	const tc = zgemm_conjb;
	const A = new Complex128Array( [ 1, 0, 0, 1, 2, 0, 0, 2 ] );
	const B = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'no-transpose', 'conjugate-transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: transpose A, no transpose B (C=A^T*B)', function t() {
	...
	const tc = zgemm_transa_n;
	const A = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 1, 1, 2, 0 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'transpose', 'no-transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: alpha=0, beta=0 (C should be zeroed)', function t() {
	...
	const tc = zgemm_alpha_zero_beta_zero;
	const A = new Complex128Array( [ 1, 1, 2, 0, 0, 0, 0, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 0, 0, 0, 0 ] );
	const C = new Complex128Array( [ 5, 3, 7, 2, 1, 1, 9, 4 ] );
...
test( 'zgemm: alpha=0, non-trivial beta (C := beta*C)', function t() {
	...
	const tc = zgemm_alpha_zero_beta_scale;
	const A = new Complex128Array( [ 1, 1, 0, 0, 0, 0, 0, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 0, 0 ] );
	const C = new Complex128Array( [ 2, 1, 3, 2, 4, 3, 5, 4 ] );
	const alpha = new Complex128( 0, 0 );
...
test( 'zgemm: conjugate A, conjugate B (C=A^H*B^H)', function t() {
	...
	const tc = zgemm_conja_conjb;
	const A = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const B = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'conjugate-transpose', 'conjugate-transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: transpose A, transpose B (C=A^T*B^T)', function t() {
	...
	const tc = zgemm_transa_transb;
	const A = new Complex128Array( [ 1, 1, 2, 0, 3, 1, 4, 2 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 2, 1, 1, -1 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'transpose', 'transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: transpose A, conjugate B (C=A^T*B^H)', function t() {
	...
	const tc = zgemm_transa_conjb;
	const A = new Complex128Array( [ 1, 1, 2, 0, 3, 1, 4, 2 ] );
	const B = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'transpose', 'conjugate-transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: conjugate A, transpose B (C=A^H*B^T)', function t() {
	...
	const tc = zgemm_conja_transb;
	const A = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 2, 1, 1, -1 ] );
	const C = new Complex128Array( 4 );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 0, 0 );
	const result = base( 'conjugate-transpose', 'transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: K=0 (C := beta*C)', function t() {
	...
	const tc = zgemm_k_zero;
	const A = new Complex128Array( 0 );
	const B = new Complex128Array( 0 );
	const C = new Complex128Array( [ 1, 2, 3, 4, 5, 6, 7, 8 ] );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 2, 0 );
	const result = base( 'no-transpose', 'no-transpose', 2, 2, 0, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: N,T with non-trivial beta', function t() {
	...
	const tc = zgemm_nt_beta_scale;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const C = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 2, 1 );
	const result = base( 'no-transpose', 'transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: C,C with non-zero beta', function t() {
	...
	const tc = zgemm_cc_beta_nonzero;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const C = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const alpha = new Complex128( 1, 0 );
...
test( 'zgemm: N,C with non-trivial beta', function t() {
	...
	const tc = zgemm_nc_beta_scale;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const C = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const alpha = new Complex128( 1, 0 );
	const beta = new Complex128( 2, 0 );
	const result = base( 'no-transpose', 'conjugate-transpose', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 ); // eslint-disable-line max-len
	assert.strictEqual( result, C );
...
test( 'zgemm: T,N with non-zero beta', function t() {
	...
	const tc = zgemm_tn_beta_nonzero;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 1, 1, 2, 0 ] );
	const C = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const alpha = new Complex128( 1, 0 );
...
test( 'zgemm: C,N with non-zero beta', function t() {
	...
	const tc = zgemm_cn_beta_nonzero;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 1, 1, 2, 0 ] );
	const C = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const alpha = new Complex128( 1, 0 );
...
test( 'zgemm: C,T with non-zero beta', function t() {
	...
	const tc = zgemm_ct_beta_nonzero;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 2, 1, 1, -1 ] );
	const C = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const alpha = new Complex128( 1, 0 );
...
test( 'zgemm: T,C with non-zero beta', function t() {
	...
	const tc = zgemm_tc_beta_nonzero;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const C = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const alpha = new Complex128( 1, 0 );
...
test( 'zgemm: T,T with non-zero beta', function t() {
	...
	const tc = zgemm_tt_beta_nonzero;
	const A = new Complex128Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	const B = new Complex128Array( [ 1, 0, 0, 1, 2, 1, 1, -1 ] );
	const C = new Complex128Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	const alpha = new Complex128( 1, 0 );
