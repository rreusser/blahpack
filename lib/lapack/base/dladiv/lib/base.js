...
const OV = dlamch( 'overflow' );                  // overflow threshold (~1.798e+308)
const UN = dlamch( 'underflow' );                  // underflow threshold (~2.225e-308)
const EPS = dlamch( 'epsilon' );                 // machine epsilon (~1.110e-16)
const BE = BS / ( EPS * EPS );             // rescaling factor
const HALF_OV = HALF * OV;                 // half of overflow threshold
const SCALE_THRESH = UN * BS / EPS;        // underflow rescaling threshold
