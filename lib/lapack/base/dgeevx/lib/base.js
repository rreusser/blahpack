...
function dgeevx( balanc, jobvl, jobvr, sense, N, A, strideA1, strideA2, offsetA, WR, strideWR, offsetWR, WI, strideWI, offsetWI, VL, strideVL1, strideVL2, offsetVL, VR, strideVR1, strideVR2, offsetVR, SCALE, strideSCALE, offsetSCALE, RCONDE, strideRCONDE, offsetRCONDE, RCONDV, strideRCONDV, offsetRCONDV, work, strideWork, offsetWork, iwork, strideIwork, offsetIwork ) {
	let dtrsnaJob, scalea, cscale, abnrm, info, side, ilo, ihi, scl, cs, sn, k;
	let i;
	...
	const bal = dgebal( balanc, N, A, strideA1, strideA2, offsetA, SCALE, strideSCALE, offsetSCALE );
	ilo = bal.ilo;
	ihi = bal.ihi;
	...
	if ( info === 0 ) {
		if ( wantvl || wantvr ) {
			...
			dtrevc3( side, 'backtransform', SELECT, 1, 0, N, A, strideA1, strideA2, offsetA, VL, strideVL1, strideVL2, offsetVL, VR, strideVR1, strideVR2, offsetVR, N, 0, WORK, strideWork, offsetWork );
		}
