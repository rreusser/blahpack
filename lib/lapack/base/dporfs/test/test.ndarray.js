...
test( 'dporfs: basic_upper_3x3', function t() {
	...
	info = dporfs( 'upper', 3, 1, sys.A, 1, 3, 0, sys.AF, 1, 3, 0, sys.B, 1, 3, 0, sys.X, 1, 3, 0, sys.FERR, 1, 0, sys.BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
...
test( 'dporfs: basic_lower_3x3', function t() {
	...
	WORK = new Float64Array( 9 );
	IWORK = new Int32Array( 3 );
	info = dporfs( 'lower', 3, 1, sys.A, 1, 3, 0, sys.AF, 1, 3, 0, sys.B, 1, 3, 0, sys.X, 1, 3, 0, sys.FERR, 1, 0, sys.BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( toArray( sys.X.subarray( 0, 3 ) ), tc.x, 1e-12, 'x' );
	assert.ok( sys.FERR[ 0 ] >= 0.0, 'FERR >= 0' );
	assert.ok( sys.BERR[ 0 ] >= 0.0, 'BERR >= 0' );
...
test( 'dporfs: multi_rhs_3x3', function t() {
	...
	WORK = new Float64Array( 9 );
	IWORK = new Int32Array( 3 );
	info = dporfs( 'upper', 3, 2, sys.A, 1, 3, 0, sys.AF, 1, 3, 0, sys.B, 1, 3, 0, sys.X, 1, 3, 0, sys.FERR, 1, 0, sys.BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, tc.info, 'info' );
...
test( 'dporfs: illcond_5x5', function t() {
	...
	info = dporfs( 'upper', 5, 1, sys.A, 1, 5, 0, sys.AF, 1, 5, 0, sys.B, 1, 5, 0, sys.X, 1, 5, 0, sys.FERR, 1, 0, sys.BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
	assert.equal( info, tc.info, 'info' );
