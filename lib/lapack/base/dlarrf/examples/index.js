...
const dplus = new Float64Array( N );
const lplus = new Float64Array( N );
const work = new Float64Array( 2 * N );

// eslint-disable-next-line max-len
const info = dlarrf( N, d, 1, l, 1, ld, 1, 1, 4, w, 1, wgap, 1, werr, 1, 4.0, 1.0, 1.0, 2.2250738585072014e-308, sigma, dplus, 1, lplus, 1, work, 1 );
