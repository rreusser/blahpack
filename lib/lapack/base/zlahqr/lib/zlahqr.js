...
/**
* Computes the eigenvalues and (optionally) the Schur factorization of a complex upper Hessenberg matrix.
*
...
*/
function zlahqr( wantt, wantz, N, ilo, ihi, H, LDH, W, strideW, iloz, ihiz, Z, LDZ ) {
	const sh1 = 1;
	const sh2 = LDH;
	const sz1 = 1;
	const sz2 = LDZ;
	...
	return base( wantt, wantz, N, ilo, ihi, H, sh1, sh2, 0, W, strideW, ow, iloz, ihiz, Z, sz1, sz2, 0 );
}
