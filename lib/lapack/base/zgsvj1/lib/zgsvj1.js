...
*/
function zgsvj1( order, jobv, M, N, n1, A, LDA, d, strideD, sva, strideSVA, mv, V, LDV, eps, sfmin, tol, nsweep, work, strideWork ) {
	var sa1;
	var sa2;
	var sv1;
	var sv2;
	...
	if ( work === null || work === void 0 ) {
		work = new Complex128Array( max( 1, M ) );
		strideWork = 1;
	}
	return base( jobv, M, N, n1, A, sa1, sa2, 0, d, strideD, 0, sva, strideSVA, 0, mv, V, sv1, sv2, 0, eps, sfmin, tol, nsweep, work, strideWork, 0 );
}
