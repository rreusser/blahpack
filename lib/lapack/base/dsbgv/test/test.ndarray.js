...
import dsbgv from './../lib/ndarray.js';
...
function upperBandA_n8_ka3() { // eslint-disable-line camelcase
	const LDAB = 4;
	const AB = new Float64Array( LDAB * 8 );
	let i;
...
function upperBandB_n8_kb2() { // eslint-disable-line camelcase
	const LDBB = 3;
	const BB = new Float64Array( LDBB * 8 );
	let i;
...
test( 'dsbgv: upper_n5_ka2_kb1_noev (eigenvalues only, upper)', function t() {
	...
	const WORK = new Float64Array( 15 );
	const info = dsbgv( 'no-vectors', 'upper', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'dsbgv: upper_n5_ka2_kb1_ev (eigenvectors, upper)', function t() {
	...
	const WORK = new Float64Array( 15 );
	const info = dsbgv( 'compute-vectors', 'upper', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 5, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
...
test( 'dsbgv: lower_n5_ka2_kb1_noev (eigenvalues only, lower)', function t() {
	...
	const Z = new Float64Array( 1 );
	const WORK = new Float64Array( 15 );
	const info = dsbgv( 'no-vectors', 'lower', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
});
...
test( 'dsbgv: lower_n5_ka2_kb1_ev (eigenvectors, lower)', function t() {
	...
	const Z = new Float64Array( 25 );
	const WORK = new Float64Array( 15 );
	const info = dsbgv( 'compute-vectors', 'lower', 5, 2, 1, AB, 1, 3, 0, BB, 1, 2, 0, W, 1, 0, Z, 1, 5, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
	assertArrayClose( Z, new Float64Array( tc.Z ), 1e-12, 'Z' );
});
...
test( 'dsbgv: n_zero (quick return for N=0)', function t() {
	...
	const info = dsbgv( 'no-vectors', 'upper', 0, 1, 0, AB, 1, 2, 0, BB, 1, 1, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'dsbgv: diag_n3 (diagonal matrices, KA=KB=0)', function t() {
	...
	BB[ 1 ] = 3.0;
	BB[ 2 ] = 4.0;
	const info = dsbgv( 'no-vectors', 'upper', 3, 0, 0, AB, 1, 1, 0, BB, 1, 1, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
});
...
test( 'dsbgv: upper_n8_ka3_kb2_ev (larger, eigenvectors, upper)', function t() {
	...
	const WORK = new Float64Array( 24 );
	const info = dsbgv( 'compute-vectors', 'upper', 8, 3, 2, AB, 1, 4, 0, BB, 1, 3, 0, W, 1, 0, Z, 1, 8, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
...
test( 'dsbgv: lower_n8_ka3_kb2_ev (larger, eigenvectors, lower)', function t() {
	...
	const Z = new Float64Array( 64 );
	const WORK = new Float64Array( 24 );
	const info = dsbgv( 'compute-vectors', 'lower', 8, 3, 2, AB, 1, 4, 0, BB, 1, 3, 0, W, 1, 0, Z, 1, 8, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-12, 'W' );
	assertArrayClose( Z, new Float64Array( tc.Z ), 1e-10, 'Z' );
});
...
test( 'dsbgv: n1_trivial (N=1, eigenvectors)', function t() {
	...
	AB[ 0 ] = 3.0;
	BB[ 0 ] = 2.0;
	const info = dsbgv( 'compute-vectors', 'upper', 1, 0, 0, AB, 1, 1, 0, BB, 1, 1, 0, W, 1, 0, Z, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( W, new Float64Array( tc.W ), 1e-13, 'W' );
	assertArrayClose( Z, new Float64Array( tc.Z ), 1e-12, 'Z' );
});
