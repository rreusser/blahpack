...
*
* This sets A(i,j) = S(i) _ A(i,j) _ S(j) for the stored triangle. The
...
*/
function zlaqhe( uplo, N, A, strideA1, strideA2, offsetA, s, strideS, offsetS, scond, amax ) { // eslint-disable-line max-len, max-params
