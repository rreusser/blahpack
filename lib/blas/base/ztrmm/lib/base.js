...
function ztrmm( side, uplo, transa, diag, M, N, alpha, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB ) {
	...
	let c00r, c00i, c01r, c01i, c10r, c10i, c11r, c11i;
	...
	let t01r, t01i, d0r, d0i, d1r, d1i, a0r, a0i, a1r, a1i, e0r, e0i, e1r, e1i;
	let eup, ea1, ea2, eb1, eb2, nr, nc, pd, pdd, pa, pa0, pa1, pb, pb0, pb1;
	let pw, ar, ai, br, bi, er, ei, tr, ti, i0, i, j, l;
	...
	eup = ( uplo === 'upper' );
	const conjSign = ( transa === 'conjugate-transpose' ) ? -1.0 : 1.0;
