...
import dtbrfs from './../lib/index.js';
...
const B = new Float64Array( [ 13.0, 31.0, 22.0, 12.0 ] );
...
const info = dtbrfs.ndarray( 'upper', 'no-transpose', 'non-unit', 4, 2, 1, AB, 1, 3, 0, B, 1, 4, 0, X, 1, 4, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 ); // eslint-disable-line max-len
