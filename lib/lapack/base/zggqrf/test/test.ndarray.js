...
function callZggqrf( N, M, P, aFlat, bFlat ) {
	...
	info = zggqrf( N, M, P, A, 1, N, 0, TAUA, 1, 0, B, 1, N, 0, TAUB, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	return {
		'info': info,
...
test( 'zggqrf: n_zero (quick return)', function t() {
	...
	info = zggqrf( 0, 3, 3, A, 1, 0, 0, TAUA, 1, 0, B, 1, 0, 0, TAUB, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
