...
import dtgex2 from '../../dtgex2/lib/base.js';
	...
	if ( ifst < ilst ) {
		...
		while ( here < ilst ) {
			if ( nbf === 1 || nbf === 2 ) {
				...
				info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here, nbf, nbnext, WORK, strideWork, offsetWork );
				if ( info !== 0 ) {
					ilst = here;
					return {
						'info': info,
				...
				info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here + 1, 1, nbnext, WORK, strideWork, offsetWork );
				if ( info !== 0 ) {
					ilst = here;
					return {
						'info': info,
				...
				if ( nbnext === 1 ) {
					...
					info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here, 1, 1, WORK, strideWork, offsetWork );
					if ( info !== 0 ) {
						ilst = here;
						return {
							'info': info,
					...
					if ( nbnext === 2 ) {
						...
						info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here, 1, nbnext, WORK, strideWork, offsetWork );
						if ( info !== 0 ) {
							ilst = here;
							return {
								'info': info,
		...
		while ( here > ilst ) {
			if ( nbf === 1 || nbf === 2 ) {
				...
				info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here - nbnext, nbnext, nbf, WORK, strideWork, offsetWork );
				if ( info !== 0 ) {
					ilst = here;
					return {
						'info': info,
				...
				info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here - nbnext, nbnext, 1, WORK, strideWork, offsetWork );
				if ( info !== 0 ) {
					ilst = here;
					return {
						'info': info,
				...
				if ( nbnext === 1 ) {
					// Swap two 1x1 blocks, no problems possible...
					info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here, nbnext, 1, WORK, strideWork, offsetWork );
					if ( info !== 0 ) {
						ilst = here;
						return {
							'info': info,
					...
					if ( nbnext === 2 ) {
						// 2x2 block did not split...
						info = dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, here - 1, 2, 1, WORK, strideWork, offsetWork );
						if ( info !== 0 ) {
							ilst = here;
							return {
								'info': info,
