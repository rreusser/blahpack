...
function createBenchmark( len ) {
	const A = new Complex128Array( uniform( 2 * len * len, -10.0, 10.0, options ) );
	const x = new Complex128Array( uniform( 2 * len, -10.0, 10.0, options ) );
	const y = new Float64Array( uniform( len, -10.0, 10.0, options ) );
	return benchmark;
