...
import dlaqtr from './../lib/ndarray.js';
...
test( 'dlaqtr: n0_quick', function t() {
	...
	const out = dlaqtr( false, true, 0, T, 1, 4, 0, b, 1, 0, 0, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
	assertClose( out.scale, 1.0, TOL, 'scale' );
});

test( 'dlaqtr: real_notran_n1', function t() {
	const T = buildT( [ [ 1, 1, 2.0 ] ] );
	const b = new Float64Array( 4 );
	const x = new Float64Array( 8 );
	const WORK = new Float64Array( 4 );
	x[ 0 ] = 6.0;
	const out = dlaqtr( false, true, 1, T, 1, 4, 0, b, 1, 0, 0, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
...
test( 'dlaqtr: real_notran_n3_triangular', function t() {
	...
	const out = dlaqtr( false, true, 3, T, 1, 4, 0, b, 1, 0, 0, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
...
test( 'dlaqtr: real_trans_n3_triangular', function t() {
	...
	const WORK = new Float64Array( 4 );
	x[ 0 ] = 10.0; x[ 1 ] = 5.0; x[ 2 ] = 8.0;
	const out = dlaqtr( true, true, 3, T, 1, 4, 0, b, 1, 0, 0, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
...
test( 'dlaqtr: complex_notran_n2', function t() {
	const T = buildT( [ [ 1, 1, 3.0 ], [ 1, 2, 1.0 ], [ 2, 2, 2.0 ] ] );
	const b = new Float64Array( 4 );
	const x = new Float64Array( 8 );
	const WORK = new Float64Array( 4 );
	b[ 0 ] = 0.5; b[ 1 ] = 0.25;
	x[ 0 ] = 4.0; x[ 1 ] = 3.0;
	x[ 2 ] = 1.0; x[ 3 ] = 2.0;
	const out = dlaqtr( false, false, 2, T, 1, 4, 0, b, 1, 0, 1.5, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
...
test( 'dlaqtr: complex_trans_n2', function t() {
	...
	x[ 0 ] = 4.0; x[ 1 ] = 3.0;
	x[ 2 ] = 1.0; x[ 3 ] = 2.0;
	const out = dlaqtr( true, false, 2, T, 1, 4, 0, b, 1, 0, 1.5, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
...
test( 'dlaqtr: complex_notran_n3_2x2', function t() {
	...
	const out = dlaqtr( false, false, 3, T, 1, 4, 0, b, 1, 0, 0.8, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
...
test( 'dlaqtr: complex_trans_n3_2x2', function t() {
	...
	x[ 0 ] = 1.0; x[ 1 ] = 2.0; x[ 2 ] = 3.0;
	x[ 3 ] = 0.5; x[ 4 ] = 0.25; x[ 5 ] = 0.125;
	const out = dlaqtr( true, false, 3, T, 1, 4, 0, b, 1, 0, 0.8, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
...
test( 'dlaqtr: real_notran_n4_zero_rhs', function t() {
	...
	const WORK = new Float64Array( 4 );
	x[ 2 ] = 1.0;
	const out = dlaqtr( false, true, 4, T, 1, 4, 0, b, 1, 0, 0, x, 1, 0, WORK, 1, 0 );
	assert.strictEqual( out.info, 0 );
