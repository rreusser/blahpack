...
test( 'dorbdb1 (column-major): runs to completion on Q=0 quick-return', function t() {
	const a = args();
	const info = dorbdb1( 'column-major', 4, 2, 0, a.X11, 4, a.X21, 4, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
});

test( 'dorbdb1 (row-major): runs to completion on Q=0 quick-return', function t() {
	const a = args();
	const info = dorbdb1( 'row-major', 4, 2, 0, a.X11, 1, a.X21, 1, a.THETA, 1, a.PHI, 1, a.TAUP1, 1, a.TAUP2, 1, a.TAUQ1, 1, a.WORK, 1 );
	assert.strictEqual( info, 0, 'info' );
});
