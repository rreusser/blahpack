...
function trueSolution( A0, B0, N, nrhs, code ) {
	...
	var info = dgtsv( N, nrhs, DLr.data, DLr.args[ 0 ], DLr.args[ 1 ], Dr.data, Dr.args[ 0 ], Dr.args[ 1 ], DUr.data, DUr.args[ 0 ], DUr.args[ 1 ], Br.data, Br.args[ 0 ], Br.args[ 1 ], Br.args[ 2 ] );
	if ( info !== 0 ) {
...
function runProperty( trans, N, nrhs ) {
	...
	var tag = 'dgtrfs '+trans+' N='+N+' nrhs='+nrhs;
