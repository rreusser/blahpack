...
import dlangb from './../lib/ndarray.js';


// FIXTURES //

const fixtureFile = path.join( import.meta.dirname, '..', '..', '..', '..', '..', 'test', 'fixtures', 'dlangb.jsonl' );
...
// 1x1: value -5.0
const AB_1X1 = buildAB( 1, 1, [ 1, 1, -5.0 ] );
...
function runCase( name, norm, N, KL, KU, AB, ldab ) {
	...
	const got = dlangb( norm, N, KL, KU, AB, 1, ldab, 0, WORK, 1, 0 );
