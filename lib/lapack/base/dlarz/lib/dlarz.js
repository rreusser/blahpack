...
*/
function dlarz( order, side, M, N, l, v, strideV, tau, C, LDC, WORK ) { // eslint-disable-line max-len, max-params
	let sc1, sc2;
	...
	base( side, M, N, l, v, strideV, 0, tau, C, sc1, sc2, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	return C;
}
