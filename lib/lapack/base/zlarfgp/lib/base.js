...
const scratchCA = new Complex128Array( 1 );
const scratchCAv = reinterpret( scratchCA, 0 );
...
function zlarfgp( N, alpha, offsetAlpha, x, strideX, offsetX, tau, offsetTau ) {
	let savealphaR, savealphaI, bignum, smlnum, alphr, alphi, xnorm, beta, knt;
	let ix, j;
	...
	const av = reinterpret( alpha, 0 );
	const oA = offsetAlpha * 2;
