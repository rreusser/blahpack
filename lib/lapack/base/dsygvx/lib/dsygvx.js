...
*/
function dsygvx( itype, jobz, range, uplo, N, A, LDA, B, LDB, vl, vu, il, iu, abstol, out, w, strideW, Z, LDZ, WORK, strideWork, IWORK, strideIWork, IFAIL, strideIFAIL ) { // eslint-disable-line max-len, max-params
	...
	return base( itype, jobz, range, uplo, N, A, sa1, sa2, 0, B, sb1, sb2, 0, vl, vu, il, iu, abstol, out, w, strideW, ow, Z, sz1, sz2, 0, WORK, strideWork, owork, IWORK, strideIWork, oiwork, IFAIL, strideIFAIL, oifail ); // eslint-disable-line max-len
}
