...
const ALPHA_CONST = ( 1.0 + Math.sqrt( 17.0 ) ) / 8.0;
const SFMIN = FLOAT64_SMALLEST_NORMAL;
...
function zlasyfRook( uplo, N, nb, A, strideA1, strideA2, offsetA, IPIV, strideIPIV, offsetIPIV, W, strideW1, strideW2, offsetW ) {
	let wjkm1Re, wjkm1Im, absakk, colmax, rowmax, kstep, dtemp, itemp, wjkRe;
	let wjkIm, d11Re, d11Im, d12Re, d12Im, d22Re, d22Im, done, info, imax, jmax;
	let r1Re, r1Im, akkR, akkI, jp1, jp2, kkw, aRe, aIm, tRe, tIm, ii, jb, jj;
	let kk, kp, kw, j, k, p;
	...
	const sw1 = strideW1 * 2;
	const sw2 = strideW2 * 2;
	const si = strideIPIV;
	const oA = offsetA * 2;
	const oW = offsetW * 2;
