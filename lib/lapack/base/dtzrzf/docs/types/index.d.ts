...
interface Routine {
	...
	*/
	...
	/**
	* Reduces a real M-by-N (M <= N) upper trapezoidal matrix `A` to upper triangular form via RZ factorization (blocked driver) using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param N - number of columns
	* @param A - `A`
