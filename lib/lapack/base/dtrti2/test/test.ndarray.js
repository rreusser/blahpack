...
test( 'dtrti2: upper, non-unit, 3x3', function t() {
	...
	const info = dtrti2( 'upper', 'non-unit', 3, A, 1, 3, 0 );
...
test( 'dtrti2: lower, non-unit, 3x3', function t() {
	...
	const info = dtrti2( 'lower', 'non-unit', 3, A, 1, 3, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( A, tc.a, 1e-14, 'a' );
});
...
test( 'dtrti2: upper, unit diag, 3x3', function t() {
	...
	const info = dtrti2( 'upper', 'unit', 3, A, 1, 3, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( A, tc.a, 1e-14, 'a' );
});
...
test( 'dtrti2: lower, unit diag, 3x3', function t() {
	...
	const tc = lower_unit;
	const A = new Float64Array( [ 99, 1, 3, 0, 99, 5, 0, 0, 99 ] );
	const info = dtrti2( 'lower', 'unit', 3, A, 1, 3, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( A, tc.a, 1e-14, 'a' );
});

test( 'dtrti2: N=0', function t() {
	const info = dtrti2( 'upper', 'non-unit', 0, new Float64Array( 0 ), 1, 1, 0 );
	assert.equal( info, 0 );
});
...
test( 'dtrti2: N=1', function t() {
	...
	const info = dtrti2( 'upper', 'non-unit', 1, A, 1, 1, 0 );
	assert.equal( info, tc.info );
	assertArrayClose( A, tc.a, 1e-14, 'a' );
});
