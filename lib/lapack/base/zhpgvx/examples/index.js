...
const AP = new Complex128Array( [ 4, 0, 1, -1, 5, 0 ] );

// B = [2 0; 0 3] in upper packed storage:
const BP = new Complex128Array( [ 2, 0, 0, 0, 3, 0 ] );
...
const IFAIL = new Int32Array( 2 );
const out = {
	M: 0
};

const info = zhpgvx( 'column-major', 1, 'compute-vectors', 'all', 'upper', 2, AP, BP, 0, 0, 0, 0, 0, out, W, Z, 2, WORK, RWORK, IWORK, IFAIL ); // eslint-disable-line max-len
