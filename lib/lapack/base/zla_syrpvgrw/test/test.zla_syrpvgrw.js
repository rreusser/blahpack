...
import zla_syrpvgrw from './../lib/zla_syrpvgrw.js';
...
test( 'zla_syrpvgrw computes for valid 2x2 lower', function t() {
	const Aflat = new Float64Array( [ 1, 0, 0.5, 0, 0, 0, 1, 0 ] );
	const AFflat = new Float64Array( [ 1, 0, 0.5, 0, 0, 0, 0.75, 0 ] );
	...
	const r = zla_syrpvgrw( 'lower', 2, 0, A, 2, AF, 2, IPIV, WORK );
