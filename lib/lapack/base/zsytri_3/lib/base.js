...
import zsytri3x from './../../../../lapack/base/zsytri_3x/lib/base.js';
...
*/
function zsytri3( uplo, N, A, strideA1, strideA2, offsetA, e, strideE, offsetE, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, offsetWork ) { // eslint-disable-line max-len, max-params
	...
	const info = zsytri3x( uplo, N, A, strideA1, strideA2, offsetA, e, strideE, offsetE, IPIV, strideIPIV, offsetIPIV, WORK, strideWork, offsetWork, NB ); // eslint-disable-line max-len

	const wview = reinterpret( WORK, 0 );
