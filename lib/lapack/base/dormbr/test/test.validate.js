...
const NAME = 'dormbr';
const TRANS_T = 'transpose'; // op = Fᵀ for a real routine
const TCODE_T = 't'; // ref.matmul transpose code matching TRANS_T
const LogicalMatrix = logical.LogicalMatrix;
const NB = 32; // hardcoded block size in dormqr/dormlq base.js
