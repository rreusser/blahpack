...
test( 'zgbbrd: tri_5x5_N', function t() {
	...
	info = zgbbrd( 'no-vectors', m, n, 0, 1, 1, AB, 1, ldab, 0, D, 1, 0, E, 1, 0, Q, 1, 1, 0, PT, 1, 1, 0, C, 1, 1, 0, W, 1, 0, R, 1, 0 ); // eslint-disable-line max-len
...
test( 'zgbbrd: penta_5x5_B', function t() {
	...
	W = new Complex128Array( Math.max( m, n ) );
	R = new Float64Array( Math.max( m, n ) );
	info = zgbbrd( 'both', m, n, 0, 2, 2, AB, 1, ldab, 0, D, 1, 0, E, 1, 0, Q, 1, m, 0, PT, 1, n, 0, C, 1, 1, 0, W, 1, 0, R, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( D, tc.D, 1e-12, 'D' );
	assertArrayClose( E, tc.E, 1e-12, 'E' );
...
test( 'zgbbrd: tall_6x4_Q', function t() {
	...
	W = new Complex128Array( Math.max( m, n ) );
	R = new Float64Array( Math.max( m, n ) );
	info = zgbbrd( 'q-only', m, n, ncc, 1, 1, AB, 1, ldab, 0, D, 1, 0, E, 1, 0, Q, 1, m, 0, PT, 1, 1, 0, C, 1, m, 0, W, 1, 0, R, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( D, tc.D, 1e-12, 'D' );
	assertArrayClose( E, tc.E, 1e-12, 'E' );
	assertArrayClose( reinterpret( Q, 0 ), tc.Q, 1e-12, 'Q' );
...
test( 'zgbbrd: wide_4x6_P', function t() {
	...
	W = new Complex128Array( Math.max( m, n ) );
	R = new Float64Array( Math.max( m, n ) );
	info = zgbbrd( 'p-only', m, n, 0, 0, 1, AB, 1, ldab, 0, D, 1, 0, E, 1, 0, Q, 1, 1, 0, PT, 1, n, 0, C, 1, 1, 0, W, 1, 0, R, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( D, tc.D, 1e-12, 'D' );
	assertArrayClose( E, tc.E, 1e-12, 'E' );
	assertArrayClose( reinterpret( PT, 0 ), tc.PT, 1e-12, 'PT' );
...
test( 'zgbbrd: lower_4x4_B', function t() {
	...
	W = new Complex128Array( Math.max( m, n ) );
	R = new Float64Array( Math.max( m, n ) );
	info = zgbbrd( 'both', m, n, 0, 1, 0, AB, 1, ldab, 0, D, 1, 0, E, 1, 0, Q, 1, m, 0, PT, 1, n, 0, C, 1, 1, 0, W, 1, 0, R, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( D, tc.D, 1e-12, 'D' );
	assertArrayClose( E, tc.E, 1e-12, 'E' );
	assertArrayClose( reinterpret( Q, 0 ), tc.Q, 1e-12, 'Q' );
...
test( 'zgbbrd: diag_4x4_N', function t() {
	...
	W = new Complex128Array( Math.max( m, n ) );
	R = new Float64Array( Math.max( m, n ) );
	info = zgbbrd( 'no-vectors', m, n, 0, 0, 0, AB, 1, ldab, 0, D, 1, 0, E, 1, 0, Q, 1, 1, 0, PT, 1, 1, 0, C, 1, 1, 0, W, 1, 0, R, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
	assertArrayClose( D, tc.D, 1e-12, 'D' );
});
...
test( 'zgbbrd: m_zero', function t() {
	...
	info = zgbbrd( 'no-vectors', 0, 4, 0, 1, 1, AB, 1, 3, 0, D, 1, 0, E, 1, 0, Q, 1, 1, 0, PT, 1, 1, 0, C, 1, 1, 0, W, 1, 0, R, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, tc.info, 'info' );
});
