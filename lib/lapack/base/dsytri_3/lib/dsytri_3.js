...
*/
function dsytri3( order, uplo, N, A, LDA, e, strideE, IPIV, strideIPIV, offsetIPIV, WORK, strideWork ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	...
	if ( WORK === null || WORK === void 0 ) {
		WORK = new Float64Array( ( N+NB+1 ) * ( NB+3 ) );
		strideWork = 1;
	}
