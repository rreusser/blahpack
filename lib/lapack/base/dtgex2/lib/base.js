...
function dtgex2( wantq, wantz, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, Q, strideQ1, strideQ2, offsetQ, Z, strideZ1, strideZ2, offsetZ, j1, n1, n2, WORK, strideWork, offsetWork ) { // eslint-disable-line max-len
	...
	li = new Float64Array( 16 );
	ir = new Float64Array( 16 );
	s = new Float64Array( 16 );
	t = new Float64Array( 16 );
	scpy = new Float64Array( 16 );
	tcpy = new Float64Array( 16 );
	ircop = new Float64Array( 16 );
	licop = new Float64Array( 16 );
	taul = new Float64Array( 4 );
	taur = new Float64Array( 4 );
	...
	wk = ( offsetWork === 0 ) ? WORK : WORK.subarray( offsetWork );
