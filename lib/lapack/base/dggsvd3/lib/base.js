...
* @param {Float64Array} WORK - caller-owned workspace (see the ndarray wrapper's WORK-size assertion for the required length)
...
*/
function dggsvd3( jobu, jobv, jobq, M, N, p, K, l, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, ALPHA, strideALPHA, offsetALPHA, BETA, strideBETA, offsetBETA, U, strideU1, strideU2, offsetU, V, strideV1, strideV2, offsetV, Q, strideQ1, strideQ2, offsetQ, WORK, strideWork, offsetWork, IWORK, strideIWork, offsetIWork ) {
	let isub, smax, temp, i, j;

	// Compute the Frobenius norm of matrices A and B
	const anorm = dlange( 'one-norm', M, N, A, strideA1, strideA2, offsetA, WORK, strideWork, offsetWork );
	const bnorm = dlange( 'one-norm', p, N, B, strideB1, strideB2, offsetB, WORK, strideWork, offsetWork );
	...
	// Preprocessing
	dggsvp3( jobu, jobv, jobq, M, p, N, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, tola, tolb, K, l, U, strideU1, strideU2, offsetU, V, strideV1, strideV2, offsetV, Q, strideQ1, strideQ2, offsetQ, IWORK, strideIWork, offsetIWork, WORK, strideWork, offsetWork, WORK, strideWork, offsetWork + ( N * strideWork ) );
	...
	const info = dtgsja( jobu, jobv, jobq, M, p, N, kval, lval, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB, tola, tolb, ALPHA, strideALPHA, offsetALPHA, BETA, strideBETA, offsetBETA, U, strideU1, strideU2, offsetU, V, strideV1, strideV2, offsetV, Q, strideQ1, strideQ2, offsetQ, WORK, strideWork, offsetWork, ncycle);
